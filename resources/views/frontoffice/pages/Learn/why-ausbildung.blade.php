...
@section('title', 'Why Choose Ausbildung? Earn €1,300/Month + 98% Job Placement | Azubi')
...
@section('meta')
    ...
    <meta property="og:description"
        content="Ausbildung benefits: earn €850-1,300 monthly while training, no tuition fees, 98% job placement rate, path to German PR. Compare vs university and other options." />
    <meta property="og:url" content="https://azubi.ma/why-ausbildung" />
    <meta property="og:site_name" content="Azubi" />
    <meta property="og:locale" content="en_US" />
    <meta property="og:image" content="https://images.azubi.ma/og-images/why-ausbildung.png" />
    <meta property="og:image:width" content="1200" />
    <meta property="og:image:height" content="630" />
    <meta property="og:image:alt" content="Why Choose Ausbildung? Earn €1,300/Month + 98% Job Placement" />
    <meta property="og:type" content="website" />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:site" content="@Azubi" />
    <meta name="twitter:creator" content="@Azubi" />
    <meta name="twitter:title" content="Why Choose Ausbildung? Earn €1,300/Month + 98% Job Placement" />
...
@section('content')
    <div class="flex flex-col">
        <section
            ...
            <img alt="Heidelberg Castle in autumn - historic German landmark representing education and career"
                ...
                <div class="flex flex-col gap-4 sm:gap-5">
                    <div class="animate-fade-in-up animation-delay-100">
                        <div class="inline-flex items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 border-2 border-white/80 text-white backdrop-blur-sm bg-white/10 hover:bg-white/20 px-3 py-1.5 text-sm font-semibold"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                ...
                                stroke-linejoin="round" class="lucide lucide-award h-4 w-4 mr-2" aria-hidden="true">
                                <path
                    ...
                    <nav class="flex flex-col sm:flex-row gap-3 sm:gap-4 animate-fade-in-up animation-delay-400 mt-2 w-full max-w-md mx-auto justify-center"
                        ...
                        <a class="inline-flex items-center justify-center gap-2 whitespace-nowrap focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 active:translate-y-0 h-14 bg-[#5D5DE9] hover:bg-[#2C3340] text-white shadow-lg hover:shadow-xl transition-all duration-300 rounded-full px-6 sm:px-7 py-5 text-base font-semibold w-full sm:w-auto hover:-translate-y-1 inline-flex items-center justify-center"
                            aria-label="Explore Benefits" href="#key-benefits"><span aria-hidden="true"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round" class="lucide lucide-trending-up w-5 h-5 mr-2">
                                    <polyline points="22 7 13.5 15.5 8.5 10.5 2 17"></polyline>
                                    <polyline points="16 7 22 7 22 13"></polyline>
                                </svg></span><span>Explore Benefits</span></a><a
                            ...
                            aria-label="Find Programs" href="{{ route('front.sectors') }}"><span aria-hidden="true"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round" class="lucide lucide-search w-5 h-5 mr-2">
                                    <circle cx="11" cy="11" r="8"></circle>
                                    <path d="m21 21-4.3-4.3"></path>
                                </svg></span><span>Find Programs</span></a>
                    </nav>
                </div>
            </div>
                ...
                <div class="flex flex-col gap-16">
                    <div class="grid md:grid-cols-2 gap-10 items-center">
                        <div class="relative rounded-xl overflow-hidden h-[350px] shadow-xl">
                            <img alt="Apprentice earning while learning in a workshop" loading="lazy" decoding="async"
                      ...
                      "
                        ...
                        <div>
                            <div
                                ...
                                <span class="text-primary font-medium">Core Advantages</span>
                            </div>
                            ...
                            <div class="grid grid-cols-2 gap-5 mb-6">
                                <div class="p-4 bg-primary/5 border border-primary/10 rounded-lg">
                                    <h4 class="tracking-tight font-semibold text-sm sm:text-base text-primary mb-1">
                                        €1,100-1,500
                                    </h4>
                            ...
                            <p class="text-sm text-muted-foreground p-3 bg-primary/5 rounded-lg">
                                ...
                                <div class="p-6">
                                    ...
                                    <ul class="space-y-2">
                                        <li class="flex items-start gap-2">
                                            ...
                                            </svg><span class="text-sm">Job-specific technical skills</span>
                                        </li>
                                        <li class="flex items-start gap-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                ...
                                                <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                                <path d="m9 11 3 3L22 4"></path>
                                            </svg><span class="text-sm">Professional workplace competencies</span>
                                        </li>
                                        <li class="flex items-start gap-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                ...
                                                <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                                <path d="m9 11 3 3L22 4"></path>
                                            </svg><span class="text-sm">Industry-specific knowledge</span>
                                        </li>
                                        <li class="flex items-start gap-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                ...
                                                <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                                <path d="m9 11 3 3L22 4"></path>
                                            </svg><span class="text-sm">Learning directly from experts</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                    ...
                                    <ul class="space-y-2">
                                        <li class="flex items-start gap-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                ...
                                                <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                                <path d="m9 11 3 3L22 4"></path>
                                            </svg><span class="text-sm">92% job placement rate after completion</span>
                                        </li>
                                        <li class="flex items-start gap-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                ...
                                                <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                                <path d="m9 11 3 3L22 4"></path>
                                            </svg><span class="text-sm">High demand for skilled professionals</span>
                                        </li>
                                        <li class="flex items-start gap-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                ...
                                                <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                                <path d="m9 11 3 3L22 4"></path>
                                            </svg><span class="text-sm">Often hired by training company</span>
                                        </li>
                                        <li class="flex items-start gap-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                ...
                                                <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                                <path d="m9 11 3 3L22 4"></path>
                                            </svg><span class="text-sm">Lower unemployment among vocational
                                                graduates</span>
                                        </li>
                                    </ul>
                                </div>
                                    ...
                                    <ul class="space-y-2">
                                        <li class="flex items-start gap-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                ...
                                                <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                                <path d="m9 11 3 3L22 4"></path>
                                            </svg><span class="text-sm">Early entry into the workforce</span>
                                        </li>
                                        <li class="flex items-start gap-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                ...
                                                <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                                <path d="m9 11 3 3L22 4"></path>
                                            </svg><span class="text-sm">Salary during entire training period</span>
                                        </li>
                                        <li class="flex items-start gap-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                ...
                                                <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                                <path d="m9 11 3 3L22 4"></path>
                                            </svg><span class="text-sm">No tuition fees or student loans</span>
                                        </li>
                                        <li class="flex items-start gap-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                ...
                                                <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                                <path d="m9 11 3 3L22 4"></path>
                                            </svg><span class="text-sm">Additional financial support available</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
            ...
            <div class="container px-4 md:px-6">
                <div class="flex flex-col gap-12">
                    <div class="max-w-[800px] mx-auto text-center">
                        <div
                            class="inline-flex items-center border text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 text-primary-foreground hover:bg-primary/80 px-3 py-1 rounded-md mb-4 bg-primary/10 border-primary/20">
                            <span class="text-primary font-medium">Educational Choices</span>
                        </div>
                        <h2 class="tracking-tight font-bold text-2xl sm:text-3xl text-secondary mb-4">
                    ...
                    <div class="grid md:grid-cols-2 gap-10 items-center">
                        <div class="relative rounded-xl overflow-hidden h-[300px] shadow-xl">
                            <img alt="University students in a lecture hall" loading="lazy" decoding="async"
                                data-nimg="fill" class="object-cover"
                                style="
                        position: absolute;
                        height: 100%;
                      ...
                      "
                        ...
                        <div>
                            <div class="border border-border rounded-xl overflow-hidden">
                                <div class="grid grid-cols-3 bg-muted/50 border-b border-border text-sm font-medium">
                                ...
                                <div class="grid grid-cols-3 border-b border-border">
                                    <div class="p-3 border-r border-border font-medium bg-muted/20">
                                        Duration
                                    </div>
                    ...
                    <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        <div class="rounded-xl text-card-foreground shadow bg-card border border-primary/10">
                            <div class="p-5">
                                <h3 class="tracking-tight font-semibold text-base sm:text-lg text-secondary mb-2">
                                ...
                                <ul class="space-y-2">
                                    <li class="flex items-start gap-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            ...
                                            <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                            <path d="m9 11 3 3L22 4"></path>
                                        </svg><span class="text-sm text-muted-foreground">You prefer hands-on, practical
                                            learning</span>
                                    </li>
                                    <li class="flex items-start gap-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            ...
                                            <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                            <path d="m9 11 3 3L22 4"></path>
                                        </svg><span class="text-sm text-muted-foreground">You want to start earning
                                            immediately</span>
                                    </li>
                                    <li class="flex items-start gap-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            ...
                                            <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                            <path d="m9 11 3 3L22 4"></path>
                                        </svg><span class="text-sm text-muted-foreground">You have a specific trade or
                                            profession in
                                            mind</span>
                                    </li>
                                    <li class="flex items-start gap-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            ...
                                            <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                            <path d="m9 11 3 3L22 4"></path>
                                        </svg><span class="text-sm text-muted-foreground">You want direct entry to the job
                                            market</span>
                                    </li>
                                </ul>
                            </div>
                                ...
                                <ul class="space-y-2">
                                    <li class="flex items-start gap-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            ...
                                            <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                            <path d="m9 11 3 3L22 4"></path>
                                        </svg><span class="text-sm text-muted-foreground">You prefer theoretical,
                                            research-based
                                            learning</span>
                                    </li>
                                    <li class="flex items-start gap-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            ...
                                            <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                            <path d="m9 11 3 3L22 4"></path>
                                        </svg><span class="text-sm text-muted-foreground">You&#x27;re interested in
                                    ...
                                    <li class="flex items-start gap-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            ...
                                            <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                            <path d="m9 11 3 3L22 4"></path>
                                        </svg><span class="text-sm text-muted-foreground">Your career requires specific
                                            higher degree (e.g.,
                                            medicine)</span>
                                    </li>
                                    <li class="flex items-start gap-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            ...
                                            <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                            <path d="m9 11 3 3L22 4"></path>
                                        </svg><span class="text-sm text-muted-foreground">You prioritize broader academic
                                            exploration</span>
                                    </li>
                                </ul>
                            </div>
                                ...
                                <ul class="space-y-2">
                                    <li class="flex items-start gap-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            ...
                                            <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                            <path d="m9 11 3 3L22 4"></path>
                                        </svg><span class="text-sm text-muted-foreground">Financial independence from day
                                            one</span>
                                    </li>
                                    <li class="flex items-start gap-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            ...
                                            <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                            <path d="m9 11 3 3L22 4"></path>
                                        </svg><span class="text-sm text-muted-foreground">Quicker entry to professional
                                            life</span>
                                    </li>
                                    <li class="flex items-start gap-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            ...
                                            <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                            <path d="m9 11 3 3L22 4"></path>
                                        </svg><span class="text-sm text-muted-foreground">Direct application of
                                            learning</span>
                                    </li>
                                    <li class="flex items-start gap-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            ...
                                            <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                            <path d="m9 11 3 3L22 4"></path>
                                        </svg><span class="text-sm text-muted-foreground">Industry connections and
                                            networking</span>
                                    </li>
                                </ul>
                            </div>
                                ...
                                <ul class="space-y-2">
                                    <li class="flex items-start gap-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            ...
                                            <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                            <path d="m9 11 3 3L22 4"></path>
                                        </svg><span class="text-sm text-muted-foreground">Deeper theoretical
                                            foundation</span>
                                    </li>
                                    <li class="flex items-start gap-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            ...
                                            <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                            <path d="m9 11 3 3L22 4"></path>
                                        </svg><span class="text-sm text-muted-foreground">Access to research
                                            opportunities</span>
                                    </li>
                                    <li class="flex items-start gap-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            ...
                                            <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                            <path d="m9 11 3 3L22 4"></path>
                                        </svg><span class="text-sm text-muted-foreground">Traditional academic
                                            prestige</span>
                                    </li>
                                    <li class="flex items-start gap-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            ...
                                            <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                            <path d="m9 11 3 3L22 4"></path>
                                        </svg><span class="text-sm text-muted-foreground">More flexibility to change
                                            fields</span>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div class="p-6 bg-primary/5 border border-primary/10 rounded-xl max-w-3xl mx-auto">
                        <h3 class="tracking-tight font-semibold text-base sm:text-lg text-primary mb-3">
                            Did You Know?
                        </h3>
                        ...
                        <ul class="space-y-1">
                            <li class="flex items-start gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    ...
                                    <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                    <path d="m9 11 3 3L22 4"></path>
                                </svg><span class="text-sm text-muted-foreground">Finishing Ausbildung with excellent
                                    grades and work
                                    experience</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    ...
                                    <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                    <path d="m9 11 3 3L22 4"></path>
                                </svg><span class="text-sm text-muted-foreground">Completing Meister qualification (master
                                    craftsperson)</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    ...
                                    <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                    <path d="m9 11 3 3L22 4"></path>
                                </svg><span class="text-sm text-muted-foreground">Taking additional qualification courses
                                    at
                            ...
                            <div class="relative p-4 sm:p-6 lg:p-8">
                                ...
                                <div class="hidden lg:block">
                                            ...
                                            <div class="bg-white rounded-[24px] border-2 border-[#5D5DE9]/30 p-4">
                                                ...
                                                <form class="space-y-3">
                                                    ...
                                                    <div class="grid grid-cols-3 gap-2">
                                                        <button type="button" role="combobox"
                                                            aria-controls="radix-«R2tqguslb»" aria-expanded="false"
                                    ...
                                    ">
                                                            ...
                                                            aria-controls="radix-«R4tqguslb»" aria-expanded="false"
                                                            aria-required="true" aria-autocomplete="none"
                                                            dir="ltr" data-state="closed" data-placeholder=""
                                                            class="flex w-full items-center justify-between px-4 py-3 font-medium ring-offset-background placeholder:text-muted-foreground transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary disabled:cursor-not-allowed disabled:opacity-50 hover:border-primary/50 [&amp;&gt;span]:line-clamp-1 bg-white/90 border-2 border-[#2C3340]/20 h-9 text-[#2C3340] text-sm rounded-[12px]">
                                    ...
                                    ">
                                                            ...
                                                            aria-controls="radix-«R6tqguslb»" aria-expanded="false"
                                                            aria-required="true" aria-autocomplete="none"
                                                            dir="ltr" data-state="closed" data-placeholder=""
                                                            class="flex w-full items-center justify-between px-4 py-3 font-medium ring-offset-background placeholder:text-muted-foreground transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary disabled:cursor-not-allowed disabled:opacity-50 hover:border-primary/50 [&amp;&gt;span]:line-clamp-1 bg-white/90 border-2 border-[#2C3340]/20 h-9 text-[#2C3340] text-sm rounded-[12px]">
        ...
        <section class="py-16">
            <div class="container px-4 md:px-6">
                        ...
                        <div class="p-6">
                            ...
                            <ul class="space-y-3">
                                <li class="flex items-start gap-2">
                                    ...
                                    <div>
                                        <span class="font-medium block">Meister Qualification</span>
                                        <p class="text-sm text-muted-foreground">
                                ...
                                <li class="flex items-start gap-2">
                                    ...
                                    <div>
                                        <span class="font-medium block">Techniker/Fachwirt</span>
                                        <p class="text-sm text-muted-foreground">
                                ...
                                <li class="flex items-start gap-2">
                                    ...
                                    <div>
                                        <span class="font-medium block">University Access</span>
                                        <p class="text-sm text-muted-foreground">
                        ...
                        <div class="p-6">
                            ...
                            <ul class="space-y-3">
                                ...
                                <li class="flex items-start gap-2">
                                    ...
                                    <div>
                                        <span class="font-medium block">Specialist Positions</span>
                                        <p class="text-sm text-muted-foreground">
                                ...
                                <li class="flex items-start gap-2">
                                    ...
                                    <div>
                                        <span class="font-medium block">Department Management</span>
                                        <p class="text-sm text-muted-foreground">
                        ...
                        <div class="p-6">
                            ...
                            <ul class="space-y-3">
                                <li class="flex items-start gap-2">
                                    ...
                                    <div>
                                        <span class="font-medium block">Starting a Business</span>
                                        <p class="text-sm text-muted-foreground">
                                ...
                                <li class="flex items-start gap-2">
                                    ...
                                    <div>
                                        <span class="font-medium block">Franchise Opportunities</span>
                                        <p class="text-sm text-muted-foreground">
                                ...
                                <li class="flex items-start gap-2">
                                    ...
                                    <div>
                                        <span class="font-medium block">Consulting Services</span>
                                        <p class="text-sm text-muted-foreground">
                ...
                <div class="mt-12 bg-muted/20 border border-border rounded-xl p-6 max-w-3xl mx-auto">
