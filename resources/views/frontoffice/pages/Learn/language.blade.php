...
@section('title', 'German for Ausbildung: A1 to B1 in 6 Months (2026 Guide) | Azubi')
...
@section('content')
    <div class="flex flex-col">
        <section
            ...
            <img alt="Rhine Valley in autumn - scenic German river landscape with vineyards" loading="eager"
                ...
                <div class="flex flex-col gap-4 sm:gap-5">
                    <div class="animate-fade-in-up animation-delay-100">
                        <div class="inline-flex items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 border-2 border-white/80 text-white backdrop-blur-sm bg-white/10 hover:bg-white/20 px-3 py-1.5 text-sm font-semibold"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                ...
                                stroke-linejoin="round" class="lucide lucide-languages h-4 w-4 mr-2" aria-hidden="true">
                    ...
                    <nav class="flex flex-col sm:flex-row gap-3 sm:gap-4 animate-fade-in-up animation-delay-400 mt-2 w-full max-w-md mx-auto justify-center"
                        ...
                        <a class="inline-flex items-center justify-center gap-2 whitespace-nowrap focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 active:translate-y-0 h-14 bg-[#F4991A] hover:bg-[#E5890F] text-white shadow-lg hover:shadow-xl transition-all duration-300 rounded-full px-6 sm:px-7 py-5 text-base font-semibold w-full sm:w-auto hover:-translate-y-1 inline-flex items-center justify-center"
                            aria-label="Start Learning" href="dashboard/german.html"><span aria-hidden="true"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round" class="lucide lucide-graduation-cap w-5 h-5 mr-2">
                                    <path
                                        d="M21.42 10.922a1 1 0 0 0-.019-1.838L12.83 5.18a2 2 0 0 0-1.66 0L2.6 9.08a1 1 0 0 0 0 1.832l8.57 3.908a2 2 0 0 0 1.66 0z">
                                    </path>
                                    <path d="M22 10v6"></path>
                                    <path d="M6 12.5V16a6 3 0 0 0 12 0v-3.5"></path>
                                </svg></span><span>Start Learning</span></a><a
                            ...
                            aria-label="View Requirements" href="#language-levels"><span aria-hidden="true"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                ...
                                </svg></span><span>View Requirements</span></a>
                    </nav>
                </div>
            </div>
                ...
                <div class="grid md:grid-cols-3 gap-8 lg:gap-16 mb-16">
                    <div class="md:col-span-2 space-y-8">
                        <div>
                            ...
                            <p>
                                At Azubi, we&#x27;ve developed specialized German
                        ...
                        <div>
                            ...
                            <div class="space-y-4">
                                <div class="p-4 rounded-lg border relative bg-red-100 text-red-600">
                                    <div class="flex items-start gap-4">
                                        ...
                                        <div>
                                            <h3 class="tracking-tight font-semibold sm:text-lg text-secondary text-lg">
                                                A1<!-- -->
                                                -
                                                <!-- -->Beginner
                                            </h3>
                                ...
                                <div class="p-4 rounded-lg border relative bg-orange-100 text-orange-600">
                                    <div class="flex items-start gap-4">
                                        <div
                                            class="bg-white w-12 h-12 rounded-full flex items-center justify-center text-xl font-bold flex-shrink-0">
                                            A2
                                ...
                                <div class="p-4 rounded-lg border relative bg-green-100 text-green-600">
                                    <div class="flex items-start gap-4">
                                        <div
                                            class="bg-white w-12 h-12 rounded-full flex items-center justify-center text-xl font-bold flex-shrink-0">
                                            B1
                                        ...
                                        <div>
                                            <h3 class="tracking-tight font-semibold sm:text-lg text-secondary text-lg">
                                                ...
                                                <div
                                                    ...
                                                    <span class="text-secondary font-medium text-xs">Ausbildung Ready</span>
                                                </div>
                                            </h3>
                                            <p class="text-sm mb-1">
                                    ...
                                    <div class="flex items-start gap-4">
                                        ...
                                        <div>
                                            <h3 class="tracking-tight font-semibold sm:text-lg text-secondary text-lg">
                                                ...
                                                <div
                                                    class="inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 text-primary-foreground hover:bg-primary/80 ml-2 bg-secondary/10 border-secondary/20">
                                                    <span class="text-secondary font-medium text-xs">Preferred</span>
                                                </div>
                                            </h3>
                                            <p class="text-sm mb-1">
                                ...
                                <div class="flex-1">
                                    ...
                                    <div class="flex items-center gap-4">
                                        <div
                                            ...
                                            Try Interactive German Training<svg xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <span class="text-xs text-muted-foreground">15,000+ learners</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <a href="https://bookgermantest.com/?ref=Azubi" target="_blank" rel="noopener noreferrer"
                            ...
                            <div class="flex items-start gap-4">
                                ...
                                <div class="flex-1">
                                    <div class="flex items-center gap-2 mb-1">
                                        <h3 class="tracking-tight font-semibold sm:text-lg text-base text-white">
                                    ...
                                    <p class="text-sm text-slate-400 mb-3">
                                        ...
                                        slots across Morocco. Get instant alerts when slots
                                        open.
                                    </p>
                                    <span
                                        class="text-sm font-medium text-amber-400 group-hover:underline inline-flex items-center gap-1">Find
                                        Exam Slots<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                            stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <div class="grid sm:grid-cols-2 gap-4">
                                <div class="rounded-xl text-card-foreground shadow bg-card border border-primary/10">
                                    <div class="p-6">
                                        ...
                                        <h3 class="tracking-tight font-semibold sm:text-lg text-secondary text-lg mb-2">
                                            Fast-Track Learning
                                        </h3>
                        ...
                        <div>
                            ...
                            <div class="bg-card border border-primary/10 rounded-lg p-6">
                                <div class="flex gap-4 items-start">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-muted-foreground italic mb-2">
                                            ...
                                            B1 in just 5 months with Azubi&#x27;s
                    ...
                    <div class="space-y-6 sticky top-24">
                        <div class="bg-card rounded-xl border border-primary/10 p-6">
                            <h3 class="tracking-tight font-semibold sm:text-lg text-secondary text-lg mb-4">
                                Language Programs
                            </h3>
                            <div class="space-y-6">
                                <div class="bg-cream border-primary/20 border rounded-lg p-4">
                                    <h4
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            ...
                                            <path d="m22 22-5-10-5 10"></path>
                                            <path d="M14 18h6"></path>
                                        </svg>Zero to B1 Complete Package
                                    </h4>
                                    <ul class="space-y-2 mb-3">
                                        <li class="flex items-start gap-2 text-sm">
                                            ...
                                            </svg><span>5-6 month intensive program</span>
                                        </li>
                                        <li class="flex items-start gap-2 text-sm">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                ...
                                                class="lucide lucide-check h-4 w-4 text-green-600 shrink-0 mt-0.5">
                                                <path d="M20 6 9 17l-5-5"></path>
                                            </svg><span>Online and classroom options</span>
                                        </li>
                                        <li class="flex items-start gap-2 text-sm">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                ...
                                                class="lucide lucide-check h-4 w-4 text-green-600 shrink-0 mt-0.5">
                                                <path d="M20 6 9 17l-5-5"></path>
                                            </svg><span>Exam preparation included</span>
                                        </li>
                                        <li class="flex items-start gap-2 text-sm">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                ...
                                                class="lucide lucide-check h-4 w-4 text-green-600 shrink-0 mt-0.5">
                                                <path d="M20 6 9 17l-5-5"></path>
                                            </svg><span>Job interview preparation</span>
                                        </li>
                                    </ul>
                                    <a href="{{ route('front.contact') }}?program=zero-to-b1"
                                ...
                                <div class="bg-card border border-primary/10 rounded-lg p-4">
                                    <h4
                                        class="tracking-tight font-semibold sm:text-base text-secondary text-base mb-2 flex items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    ...
                                    <ul class="space-y-2 mb-3">
                                        <li class="flex items-start gap-2 text-sm">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                ...
                                                class="lucide lucide-check h-4 w-4 text-green-600 shrink-0 mt-0.5">
                                                <path d="M20 6 9 17l-5-5"></path>
                                            </svg><span>3-4 month specialist course</span>
                                        </li>
                                        <li class="flex items-start gap-2 text-sm">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                ...
                                                class="lucide lucide-check h-4 w-4 text-green-600 shrink-0 mt-0.5">
                                                <path d="M20 6 9 17l-5-5"></path>
                                            </svg><span>For healthcare and specialized sectors</span>
                                        </li>
                                        <li class="flex items-start gap-2 text-sm">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                ...
                                <div class="border-t border-primary/10 pt-4">
                                    <h4 class="tracking-tight font-semibold sm:text-base text-secondary text-base mb-2">
                                ...
                                <div>
                                    ...
                                    <ul class="space-y-1.5 text-sm">
                                        <li class="flex items-start gap-2">
                                            ...
                                            </svg><a href="https://www.goethe.de/en/spr/kup/prf/prf.html" target="_blank"
                                                rel="noopener noreferrer"
                                                class="text-primary hover:underline">Goethe-Institut Exam Samples</a>
                                        </li>
                                        <li class="flex items-start gap-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            ...
                                            </svg><a href="https://www.telc.net/en/candidates.html" target="_blank"
                                                rel="noopener noreferrer" class="text-primary hover:underline">telc
                                                Practice Tests</a>
                                        </li>
                                    </ul>
                                </div>
                ...
                <div class="max-w-3xl mx-auto space-y-4">
                    <div class="rounded-xl border border-border bg-card overflow-hidden transition-all duration-200 hover:border-primary/20 hover:shadow-sm"
                        ...
                        <button
                            ...
                            aria-expanded="true">
                            <span class="font-semibold text-foreground pr-4" itemProp="name">What German level do I need
                                for Ausbildung?</span><svg xmlns="http://www.w3.org/2000/svg" width="24"
                    ...
                    <div class="rounded-xl border border-border bg-card overflow-hidden transition-all duration-200 hover:border-primary/20 hover:shadow-sm"
                        ...
                        <button
                            class="w-full flex items-center justify-between p-5 text-left hover:bg-muted/30 transition-colors"
                            aria-expanded="false">
                            <span class="font-semibold text-foreground pr-4" itemProp="name">How long does it take to
                                reach B1 German from zero?</span><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div class="rounded-xl border border-border bg-card overflow-hidden transition-all duration-200 hover:border-primary/20 hover:shadow-sm"
                        ...
                        <button
                            class="w-full flex items-center justify-between p-5 text-left hover:bg-muted/30 transition-colors"
                            aria-expanded="false">
                            <span class="font-semibold text-foreground pr-4" itemProp="name">Which German certificates are
                                accepted for
                    ...
                    <div class="rounded-xl border border-border bg-card overflow-hidden transition-all duration-200 hover:border-primary/20 hover:shadow-sm"
                        ...
                        <button
                            class="w-full flex items-center justify-between p-5 text-left hover:bg-muted/30 transition-colors"
                            aria-expanded="false">
                            <span class="font-semibold text-foreground pr-4" itemProp="name">How much does German language
                                training cost?</span><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                class="lucide lucide-chevron-down h-5 w-5 text-muted-foreground flex-shrink-0 transition-transform duration-200">
                                <path d="m6 9 6 6 6-6"></path>
                    ...
                    <div class="rounded-xl border border-border bg-card overflow-hidden transition-all duration-200 hover:border-primary/20 hover:shadow-sm"
                        ...
                        <button
                            class="w-full flex items-center justify-between p-5 text-left hover:bg-muted/30 transition-colors"
                            aria-expanded="false">
                            <span class="font-semibold text-foreground pr-4" itemProp="name">Can I learn German while
                                already in Germany?</span><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                class="lucide lucide-chevron-down h-5 w-5 text-muted-foreground flex-shrink-0 transition-transform duration-200">
                                <path d="m6 9 6 6 6-6"></path>
                    ...
                    <div class="rounded-xl border border-border bg-card overflow-hidden transition-all duration-200 hover:border-primary/20 hover:shadow-sm"
                        ...
                        <button
                            class="w-full flex items-center justify-between p-5 text-left hover:bg-muted/30 transition-colors"
                            aria-expanded="false">
                            <span class="font-semibold text-foreground pr-4" itemProp="name">What&#x27;s the difference
                                between B1 and B2
                                German?</span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round"
                                class="lucide lucide-chevron-down h-5 w-5 text-muted-foreground flex-shrink-0 transition-transform duration-200">
                                <path d="m6 9 6 6 6-6"></path>
                    ...
                    <div class="rounded-xl border border-border bg-card overflow-hidden transition-all duration-200 hover:border-primary/20 hover:shadow-sm"
                        ...
                        <button
                            class="w-full flex items-center justify-between p-5 text-left hover:bg-muted/30 transition-colors"
                            aria-expanded="false">
                            <span class="font-semibold text-foreground pr-4" itemProp="name">Are online German courses
                                accepted for visa
                    ...
                    <div class="rounded-xl border border-border bg-card overflow-hidden transition-all duration-200 hover:border-primary/20 hover:shadow-sm"
                        ...
                        <button
                            class="w-full flex items-center justify-between p-5 text-left hover:bg-muted/30 transition-colors"
                            aria-expanded="false">
                            <span class="font-semibold text-foreground pr-4" itemProp="name">Do I need to speak German at
                    ...
                    <a class="group flex flex-col p-5 md:p-6 rounded-xl border border-border bg-card hover:border-primary/30 hover:shadow-md transition-all duration-200"
                        ...
                        <div class="flex items-start gap-4">
                            <div
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-heart h-5 w-5">
                                    <path
                    ...
                    <div class="flex flex-col gap-8 items-center text-center">
                        ...
                        <div class="flex flex-col sm:flex-row items-center gap-3">
                            <a href="{{ route('front.jobs') }}"
                                ...
                                60K+ Jobs</a><a href="dashboard/german.html"
