...
@section('title', 'Ausbildung Timeline 2026-2027: 18-Month Planning Guide | GoAusbildung')

@section('meta')
    <meta name="description" content="Complete Ausbildung timeline: 6 months German prep, 3 months applications, 3 months visa. Plan for August 2026 or February 2027 start. Free timeline planner tool.">
    <meta name="keywords" content="ausbildung timeline,ausbildung planning,when to apply ausbildung,ausbildung start dates,ausbildung preparation timeline">
    <meta property="og:title" content="Ausbildung Timeline 2026-2027: 18-Month Planning Guide">
    <meta property="og:description" content="Complete Ausbildung timeline: 6 months German prep, 3 months applications, 3 months visa. Plan for August 2026 or February 2027 start. Free timeline planner tool.">
@endsection
...
<div class="flex flex-col">
          ...
          >
            <img
              alt="North Sea coast in autumn - representing the journey ahead"
              loading="eager"
              decoding="async"
              data-nimg="fill"
                  ...
                  <a
                    ...
                    ><span aria-hidden="true"
                      ><svg
                        ...
                        stroke-linecap="round"
                        stroke-linejoin="round"
                        class="lucide lucide-clock w-5 h-5 mr-2"
                      >
                        <circle cx="12" cy="12" r="10"></circle>
                        <polyline
                          points="12 6 12 12 16 14"
                        ></polyline></svg></span
                    ><span>View Timeline</span></a
                  ><a
          ...
          <section id="timeline-overview" class="py-16">
            <div class="container px-4 md:px-6">
              ...
              <div class="w-full bg-card border rounded-xl p-6 mb-16 shadow-sm">
                <div class="relative">
                  <div
                    class="hidden md:block absolute top-24 left-0 right-0 h-1 bg-primary/20 z-10"
                  ></div>
                  <div
                    class="md:hidden absolute top-0 bottom-0 left-[42px] w-1 bg-primary/20 z-10"
                  ></div>
                  <div class="hidden md:grid grid-cols-5 gap-4 relative z-20">
                    <div class="flex flex-col items-center">
                      ...
                      <div
                        class="w-4 h-4 rounded-full bg-primary mt-4 mb-4"
                      ></div>
              ...
              <div class="grid md:grid-cols-2 gap-10 items-center">
                ...
                >
                  <img
                    alt="Planning your Ausbildung journey timeline"
                    loading="lazy"
                    decoding="async"
                    data-nimg="fill"
                    class="object-cover"
                    ...
                    "
                    sizes="100vw"
                    src="{{ asset('assets/_next/heroc4bc.jpeg') }}"
                  />
                  <div
          ...
          <section class="py-16 bg-muted/30">
            <div class="container px-4 md:px-6">
              ...
              <div class="grid md:grid-cols-2 gap-10 items-center mb-16">
                  ...
                  <div class="space-y-4">
                    ...
                    >
                      <h4 class="font-medium mb-2 flex items-center gap-2">
                        ...
                        ><span
                          >Key Research Activities (18-15 months before)</span
                        >
                      </h4>
                      <ul class="space-y-2">
                        <li class="flex items-start gap-2">
                          ...
                          <div>
                            <span class="text-sm font-medium"
                              >Explore available vocational fields in
                              Germany</span
                            >
                        ...
                        <li class="flex items-start gap-2">
                          ...
                          <div>
                            <span class="text-sm font-medium"
                              >Understand the dual education system</span
                            >
                            <p class="text-xs text-muted-foreground">
                        ...
                        <li class="flex items-start gap-2">
                          ...
                          <div>
                            <span class="text-sm font-medium"
                              >Research labor market demands</span
                            >
                            <p class="text-xs text-muted-foreground">
                        ...
                        <li class="flex items-start gap-2">
                          ...
                          <div>
                            <span class="text-sm font-medium"
                              >Check salary expectations and career paths</span
                            >
                            <p class="text-xs text-muted-foreground">
                      ...
                      >
                        <p class="flex items-start gap-2">
                          ...
                          ><span
                            ><strong>Pro Tip:</strong> Focus on 2-3 vocational
                ...
                >
                  <img
                    alt="Research and preparation for Ausbildung"
                    loading="lazy"
                    decoding="async"
                    data-nimg="fill"
                    class="object-cover"
                    ...
                    "
                    sizes="100vw"
                    src="{{ asset('assets/_next/preparation1771.jpeg') }}"
                  />
                  <div
                    class="absolute bottom-0 left-0 right-0 bg-secondary/95 p-4"
                  >
                      ...
                      <div>
                        ...
                        <ul class="space-y-2">
                          ...
                          <li class="flex items-start gap-2">
                            ...
                            <div>
                              <span class="text-sm font-medium"
                                >Schedule formal language exams</span
                              >
                              <p class="text-xs text-muted-foreground">
                          ...
                          <li class="flex items-start gap-2">
                            ...
                            <div>
                              <span class="text-sm font-medium"
                                >Learn field-specific vocabulary</span
                              >
                              <p class="text-xs text-muted-foreground">
                          ...
                          <li class="flex items-start gap-2">
                            ...
                            <div>
                              <span class="text-sm font-medium"
                                >Practice with native speakers</span
                              >
                              <p class="text-xs text-muted-foreground">
                      ...
                      <div>
                        ...
                        <ul class="space-y-2">
                          ...
                          <li class="flex items-start gap-2">
                            ...
                            <div>
                              <span class="text-sm font-medium"
                                >Professional translations</span
                              >
                              <p class="text-xs text-muted-foreground">
                          ...
                          <li class="flex items-start gap-2">
                            ...
                            <div>
                              <span class="text-sm font-medium"
                                >Draft CV and motivation letter</span
                              >
                              <p class="text-xs text-muted-foreground">
              ...
              >
                <h3 class="text-lg font-semibold mb-3 flex items-center gap-2">
                  <svg
                    ...
                    stroke-linecap="round"
                    stroke-linejoin="round"
                    class="lucide lucide-credit-card h-5 w-5 text-primary"
                  >
                ...
                <div class="space-y-4">
                  <div class="flex items-start gap-3">
                    <div
                      class="bg-beige/90 w-8 h-8 rounded-full flex items-center justify-center shrink-0 mt-0.5"
                    >
                ...
                >
                  <p class="flex items-start gap-2">
                    ...
                    >
                      ...
                      <path d="M10 22h4"></path></svg
                    ><span
                      ><strong>Financial Tip:</strong> Your total preparation
          ...
          <section class="py-16">
            <div class="container px-4 md:px-6">
              ...
              <div class="grid md:grid-cols-2 gap-10 items-center mb-16">
                ...
                >
                  <img
                    alt="Applying for Ausbildung positions in Germany"
                    loading="lazy"
                    decoding="async"
                    data-nimg="fill"
                    class="object-cover"
                    ...
                    "
                    sizes="100vw"
                    src="{{ asset('assets/_next/application49f8.jpeg') }}"
                  />
                  <div
                    class="absolute bottom-0 left-0 right-0 bg-secondary/95 p-4"
                  >
                  ...
                  <div class="space-y-4">
                    ...
                    >
                      <h4 class="font-medium mb-2 flex items-center gap-2">
                        ...
                        ><span>Typical Application Windows by Sector</span>
                      </h4>
                      <ul class="space-y-2">
                        <li class="flex items-start gap-2">
                          <svg
                          ...
                          <div>
                            <span class="text-sm font-medium"
                              >Large Companies &amp; Public Sector</span
                            >
                            <p class="text-xs text-muted-foreground">
                      ...
                      >
                        <p class="flex items-start gap-2">
                          ...
                          >
                            ...
                            <path d="M10 22h4"></path></svg
                          ><span
                            ><strong>Application Tip:</strong> Create
                      ...
                      <div>
                        ...
                        <ul class="space-y-2">
                          ...
                          <li class="flex items-start gap-2">
                            ...
                            <div>
                              <span class="text-sm font-medium"
                                >Chambers of Industry and Commerce</span
                              >
                              <p class="text-xs text-muted-foreground">
                      ...
                      <div>
                        ...
                        <ul class="space-y-2">
                          <li class="flex items-start gap-2">
                            ...
                            <div>
                              <span class="text-sm font-medium"
                                >German-style CV (Lebenslauf)</span
                              >
                              <p class="text-xs text-muted-foreground">
                          ...
                          <li class="flex items-start gap-2">
                            ...
                            <div>
                              <span class="text-sm font-medium"
                                >Digital application versions</span
                              >
                              <p class="text-xs text-muted-foreground">
                ...
                >
                  <p class="flex items-start gap-2">
                    ...
                    >
                      ...
                      <path d="M10 22h4"></path></svg
                    ><span
                      ><strong>Interview Tip:</strong> Request your training
          ...
          <section class="py-16 bg-muted/30">
            <div class="container px-4 md:px-6">
              ...
              <div class="grid md:grid-cols-2 gap-10 items-center mb-16">
                  ...
                  <div class="space-y-4">
                    ...
                    >
                      <h4 class="font-medium mb-2 flex items-center gap-2">
                        ...
                        ><span>Visa Timeline (6-3 months before)</span>
                      </h4>
                      <ul class="space-y-2">
                        <li class="flex items-start gap-2">
                          <svg
                          ...
                          <div>
                            <span class="text-sm font-medium"
                              >Document collection (6 months before)</span
                            >
                            <p class="text-xs text-muted-foreground">
                        ...
                        <li class="flex items-start gap-2">
                          ...
                          <div>
                            <span class="text-sm font-medium"
                              >Blocked account setup (if needed)</span
                            >
                            <p class="text-xs text-muted-foreground">
                        ...
                        <li class="flex items-start gap-2">
                          ...
                          <div>
                            <span class="text-sm font-medium"
                              >Application submission (4 months before)</span
                            >
                            <p class="text-xs text-muted-foreground">
                        ...
                        <li class="flex items-start gap-2">
                          ...
                          <div>
                            <span class="text-sm font-medium"
                              >Visa processing (3-1 months before)</span
                            >
                            <p class="text-xs text-muted-foreground">
                      ...
                      >
                        <p class="flex items-start gap-2">
                          ...
                          >
                            ...
                            <path d="M10 22h4"></path></svg
                          ><span
                            ><strong>Visa Tip:</strong> Apply for health
                ...
                >
                  <img
                    alt="Preparing for departure to Germany"
                    loading="lazy"
                    decoding="async"
                    data-nimg="fill"
                    class="object-cover"
                    ...
                    "
                    sizes="100vw"
                    src="{{ asset('assets/_next/departure5381.jpeg') }}"
                  />
                  <div
                    class="absolute bottom-0 left-0 right-0 bg-secondary/95 p-4"
                  >
                      ...
                      <div>
                        ...
                        <ul class="space-y-2">
                          <li class="flex items-start gap-2">
                            ...
                            <div>
                              <span class="text-sm font-medium"
                                >Request employer assistance</span
                              >
                              <p class="text-xs text-muted-foreground">
                          ...
                          <li class="flex items-start gap-2">
                            ...
                            <div>
                              <span class="text-sm font-medium"
                                >Book temporary accommodation</span
                              >
                              <p class="text-xs text-muted-foreground">
                          ...
                          <li class="flex items-start gap-2">
                            ...
                            <div>
                              <span class="text-sm font-medium"
                                >Prepare housing application documents</span
                              >
                              <p class="text-xs text-muted-foreground">
                      ...
                      <div>
                        ...
                        <ul class="space-y-2">
                          ...
                          <li class="flex items-start gap-2">
                            ...
                            <div>
                              <span class="text-sm font-medium"
                                >Plan first-week itinerary</span
                              >
                              <p class="text-xs text-muted-foreground">
              ...
              >
                ...
                >
                  <svg
                    ...
                    stroke-linecap="round"
                    stroke-linejoin="round"
                    class="lucide lucide-bookmark h-5 w-5 text-primary"
                  >
                    <path
                      d="m19 21-7-4-7 4V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v16z"
                    ></path></svg
                  ><span>Final Preparations Checklist</span>
                </h3>
                <p class="text-muted-foreground mb-4">
                ...
                <div class="grid sm:grid-cols-2 gap-4">
                  ...
                  >
                    <h4
                      class="font-medium text-sm mb-1 flex items-center gap-1"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                      ...
                      ><span>Financial Preparations</span>
                    </h4>
                    <ul
                      class="space-y-1 text-xs text-muted-foreground list-inside list-disc pl-1"
                    >
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                        <path d="m9 11 3 3L22 4"></path></svg
                      ><span>Logistics and Communications</span>
                    </h4>
                    <ul
                      class="space-y-1 text-xs text-muted-foreground list-inside list-disc pl-1"
                    >
          ...
          <section class="py-16">
            <div class="container px-4 md:px-6">
              ...
              <div class="grid md:grid-cols-2 gap-10 items-center mb-16">
                ...
                >
                  <img
                    alt="First steps after arriving in Germany"
                    loading="lazy"
                    decoding="async"
                    data-nimg="fill"
                    class="object-cover"
                    ...
                    "
                    sizes="100vw"
                    src="{{ asset('assets/_next/training550a.jpeg') }}"
                  />
                  <div
                    class="absolute bottom-0 left-0 right-0 bg-secondary/95 p-4"
                  >
                    ...
                    >
                      <h4 class="font-medium mb-2 flex items-center gap-2">
                        ...
                        >
                          <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                          <path d="m9 11 3 3L22 4"></path></svg
                        ><span>Essential Administrative Tasks</span>
                      </h4>
                      <ul class="space-y-2">
                        <li class="flex items-start gap-2">
                          <svg
                          ...
                          <div>
                            <span class="text-sm font-medium"
                              >Address Registration (Anmeldung)</span
                            >
                            <p class="text-xs text-muted-foreground">
                        ...
                        <li class="flex items-start gap-2">
                          ...
                          <div>
                            <span class="text-sm font-medium"
                              >Health Insurance Confirmation</span
                            >
                            <p class="text-xs text-muted-foreground">
                        ...
                        <li class="flex items-start gap-2">
                          ...
                          <div>
                            <span class="text-sm font-medium"
                              >Residence Permit Application</span
                            >
                            <p class="text-xs text-muted-foreground">
                      ...
                      >
                        <p class="flex items-start gap-2">
                          ...
                          >
                            ...
                            <path d="M10 22h4"></path></svg
                          ><span
                            ><strong>Pro Tip:</strong> Ask your employer for
                      ...
                      <div>
                        ...
                        <ul class="space-y-2">
                          <li class="flex items-start gap-2">
                            ...
                            <div>
                              <span class="text-sm font-medium"
                                >Tax ID (Steueridentifikationsnummer)</span
                              >
                              <p class="text-xs text-muted-foreground">
                      ...
                      <div>
                        ...
                        <ul class="space-y-2">
                          <li class="flex items-start gap-2">
                            ...
                            <div>
                              <span class="text-sm font-medium"
                                >Public transportation pass</span
                              >
                              <p class="text-xs text-muted-foreground">
              ...
              >
                ...
                >
                  <svg
                    ...
                    stroke-linecap="round"
                    stroke-linejoin="round"
                    class="lucide lucide-globe h-5 w-5 text-secondary"
                  >
                    <circle cx="12" cy="12" r="10"></circle>
                    <path
                      d="M12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 0-20"
          ...
          <section class="py-16 bg-muted/30">
            <div class="container px-4 md:px-6">
              ...
              <div class="max-w-4xl mx-auto">
                <div class="relative">
                  <div
                    class="absolute left-1/2 top-0 bottom-0 w-0.5 bg-primary/20 transform -translate-x-1/2 z-0"
                  ></div>
                  <div
                    class="relative z-10 flex items-center justify-center mb-16"
                  >
                    <div
                      class="bg-primary w-10 h-10 rounded-full flex items-center justify-center"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                  ...
                  >
                    ...
                    >
                      <span
                        class="bg-primary/10 text-primary px-2 py-0.5 rounded text-sm"
                        >Months 1-4</span
                  ...
                  >
                    ...
                    >
                      <span
                        class="bg-primary/10 text-primary px-2 py-0.5 rounded text-sm"
                        >Months 5-12</span
                      ><span>First Year Development</span>
                    </h3>
                    <p class="text-muted-foreground mb-4">
                  ...
                  >
                    ...
                    >
                      <span
                        class="bg-primary/10 text-primary px-2 py-0.5 rounded text-sm"
                        >Around Month 18</span
                      ><span>Interim Examinations</span>
                    </h3>
                    <p class="text-muted-foreground mb-4">
                  ...
                  >
                    ...
                    >
                      <span
                        class="bg-primary/10 text-primary px-2 py-0.5 rounded text-sm"
                        >Final 3-6 Months</span
                      ><span>Final Examination &amp; Graduation</span>
                    </h3>
                    <p class="text-muted-foreground mb-4">
