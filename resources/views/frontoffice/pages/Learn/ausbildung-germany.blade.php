...
@section('meta')
    ...
    <meta name="keywords" content="Ausbildung Germany 2026,vocational training Germany,apprenticeship Germany,German dual education,earn while learning,job application Germany,cover letter generator,international students Germany,work and study Germany">
    <meta property="og:title" content="Ausbildung Germany 2026: Earn €1,300/Month While Learning | 85% Job Placement">
    <meta property="og:description" content="Start your Ausbildung in Germany 2026! Earn €900-1,300/month while training. Smart application tools help you apply 10x faster with personalized cover letters &amp; job matching. 60,000+ positions from 238 verified employers.">
@endsection
        ...
        <main>
          ...
          >
            ...
            <div class="container mx-auto px-4 relative z-10">
              ...
              >
                <div
                  class="bg-white rounded-2xl border-2 border-[#344F1F]/10 p-6 animate-pulse"
                >
                  <div class="flex items-start gap-4 mb-4">
                    <div
                      class="w-16 h-16 bg-gray-200 rounded-xl flex-shrink-0"
                    ></div>
                    <div class="flex-1">
              ...
              <div class="flex justify-center">
                <div
                  class="h-12 bg-gray-200 rounded-full w-48 animate-pulse"
                ></div>
              </div>
            </div>
          </section>
