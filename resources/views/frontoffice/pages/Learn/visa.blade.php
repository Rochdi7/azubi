...
@section('content')
    <div class="flex flex-col">
        <section
            ...
            <img alt="Bavarian Alps in autumn - majestic German mountain landscape" loading="eager" decoding="async"
            ...
            <div
                ...
                <div class="flex flex-col gap-4 sm:gap-5">
                    <div class="animate-fade-in-up animation-delay-100">
                        <div class="inline-flex items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 border-2 border-white/80 text-white backdrop-blur-sm bg-white/10 hover:bg-white/20 px-3 py-1.5 text-sm font-semibold"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                ...
                                stroke-linejoin="round" class="lucide lucide-plane h-4 w-4 mr-2" aria-hidden="true">
                                <path
                    ...
                    <h1
                        ...
                        German Visa Requirements for Ausbildung
                    </h1>
                    <p class="text-lg leading-relaxed text-white/90 drop-shadow-lg animate-fade-in-up animation-delay-300">
                        Complete guide to obtaining your National Visa (D-visa) for
                        vocational training in Germany, including documentation,
                        blocked account, and application process.
                    </p>
                    <nav class="flex flex-col sm:flex-row gap-3 sm:gap-4 animate-fade-in-up animation-delay-400 mt-2 w-full max-w-md mx-auto justify-center"
                        ...
                        <a class="inline-flex items-center justify-center gap-2 whitespace-nowrap focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 active:translate-y-0 h-14 bg-[#F4991A] hover:bg-[#E5890F] text-white shadow-lg hover:shadow-xl transition-all duration-300 rounded-full px-6 sm:px-7 py-5 text-base font-semibold w-full sm:w-auto hover:-translate-y-1 inline-flex items-center justify-center"
                            aria-label="Check Documents" href="{{ route('front.tools.document-checklist') }}"><span
                                ...
                                </svg></span><span>Check Documents</span></a><a
                            ...
                            aria-label="View Process" href="#visa-process"><span aria-hidden="true"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round" class="lucide lucide-plane w-5 h-5 mr-2">
                                    <path
                                        d="M17.8 19.2 16 11l3.5-3.5C21 6 21.5 4 21 3c-1-.5-3 0-4.5 1.5L13 8 4.8 6.2c-.5-.1-.9.1-1.1.5l-.3.5c-.2.5-.1 1 .3 1.3L9 12l-2 3H4l-1 1 3 2 2 3 1-1v-3l3-2 3.5 5.3c.3.4.8.5 1.3.3l.5-.2c.4-.3.6-.7.5-1.2z">
                                    </path>
                                </svg></span><span>View Process</span></a>
                    </nav>
                </div>
            </div>
        ...
        <section id="visa-process" class="py-16">
            <div class="container px-4 md:px-6">
                <h2 class="tracking-tight font-bold text-2xl sm:text-3xl text-secondary mb-6">
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    <div class="rounded-xl text-card-foreground shadow bg-card border border-primary/10">
                        <div class="p-6">
                            <h3
                                class="tracking-tight font-semibold text-base sm:text-lg text-secondary mb-3 flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round"
                                    class="lucide lucide-globe mr-2 h-5 w-5 text-primary">
                                    <circle cx="12" cy="12" r="10"></circle>
                                    <path d="M12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 0-20"></path>
                                    <path d="M2 12h20"></path>
                                </svg>National Visa (D-Visa)
                            </h3>
                            <p class="mb-4 text-muted-foreground">
                                The initial visa you&#x27;ll apply for at the German
                                embassy or consulate in your home country. This allows
                                entry to Germany to begin your Ausbildung.
                            </p>
                            <ul class="space-y-2">
                                <li class="flex items-start gap-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        ...
                                        <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                        <path d="m9 11 3 3L22 4"></path>
                                    </svg><span>Valid for 90 days initially</span>
                                </li>
                                <li class="flex items-start gap-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                        ...
                                        <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                        <path d="m9 11 3 3L22 4"></path>
                                    </svg><span>Requires Ausbildung contract from a German
                                        employer</span>
                                </li>
                                <li class="flex items-start gap-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        ...
                                        <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                        <path d="m9 11 3 3L22 4"></path>
                                    </svg><span>Must be obtained before entering Germany</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="p-6">
                            <h3
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round"
                                    class="lucide lucide-file-text mr-2 h-5 w-5 text-primary">
                                    <path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z"></path>
                                    <path d="M14 2v4a2 2 0 0 0 2 2h4"></path>
                                    <path d="M10 9H8"></path>
                                    <path d="M16 13H8"></path>
                                    <path d="M16 17H8"></path>
                                </svg>Residence Permit
                            </h3>
                            <p class="mb-4 text-muted-foreground">
                                Once in Germany, you&#x27;ll convert your National Visa
                                into a Residence Permit for the duration of your
                                Ausbildung program.
                            </p>
                            <ul class="space-y-2">
                                <li class="flex items-start gap-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        ...
                                        <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                        <path d="m9 11 3 3L22 4"></path>
                                    </svg><span>Valid for the duration of your Ausbildung (2-3.5
                                        years)</span>
                                </li>
                                <li class="flex items-start gap-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                ...
                                <li class="flex items-start gap-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        ...
                                        <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                        <path d="m9 11 3 3L22 4"></path>
                                    </svg><span>Includes work authorization for your training
                                        position</span>
                                </li>
                            </ul>
                        </div>
        ...
        <section class="py-16 bg-muted/30">
            <div class="container px-4 md:px-6">
                ...
                <div class="bg-card border border-primary/10 rounded-xl p-6 md:p-8">
                    <div class="mb-8">
                        <p class="text-lg mb-4">
                            The process of obtaining a visa for your Ausbildung in
                            Germany involves several key steps:
                        </p>
                    </div>
                    <div class="space-y-6">
                        <div class="flex gap-4">
                            <div
                                class="flex-shrink-0 w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center text-primary font-bold">
                                1
                            </div>
                            <div>
                                <h3 class="tracking-tight font-semibold text-base sm:text-lg text-secondary mb-1">
                                    Secure an Ausbildung Position
                                </h3>
                                <p class="text-muted-foreground">
                                    Before applying for a visa, you must have a signed
                                    training contract (Ausbildungsvertrag) from a German
                                    employer. Azubi helps with finding suitable
                                    positions and preparing applications.
                                </p>
                            </div>
                        </div>
                        <div class="flex gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-muted-foreground">
                                    Prepare all necessary documents, including your training
                                    contract, language certificate, educational credentials,
                                    financial proof, and passport. All non-English/German
                        ...
                        <div class="flex gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-muted-foreground">
                                    Schedule an appointment at the German Embassy or
                                    Consulate in your region. Appointments should be booked
                                    2-3 months before your planned departure to Germany.
                                </p>
                            </div>
                        </div>
                        <div class="flex gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-muted-foreground">
                                    Present your documents and answer questions about your
                                    Ausbildung plans. Be prepared to demonstrate your
                                    genuine interest in the vocational training and your
                                    plans for after completion.
                                </p>
                            </div>
                        </div>
                        <div class="flex gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-muted-foreground">
                                    Processing times vary but typically take 4-8 weeks. Once
                                    approved, you&#x27;ll receive your visa sticker in your
                                    passport, valid for entry to Germany.
                                </p>
                            </div>
                        </div>
                        <div class="flex gap-4">
                            ...
                            <div>
                                <h3 class="tracking-tight font-semibold text-base sm:text-lg text-secondary mb-1">
                                    Register in Germany &amp; Convert to Residence Permit
                                </h3>
                                <p class="text-muted-foreground">
                        ...
                        <div class="flex items-start gap-4">
                            <div class="p-2 rounded-lg bg-primary/10">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round"
                                    class="lucide lucide-folder-open h-5 w-5 text-primary">
                                    <path
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-sm text-muted-foreground mb-3">
                                    Store and manage all your visa documents securely in one
                                    place
                                </p>
                                <div
                                    class="text-sm font-medium text-primary hover:underline inline-flex items-center gap-1 opacity-50 pointer-events-none">
                                    Use Document Manager<svg xmlns="http://www.w3.org/2000/svg" width="24"
        ...
        <section class="py-16">
            <div class="container px-4 md:px-6">
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    <div class="rounded-xl text-card-foreground shadow h-full bg-card border border-primary/10">
                        <div class="p-6">
                            ...
                            <ul class="space-y-3">
                                <li class="flex items-start gap-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        ...
                                        <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                        <path d="m9 11 3 3L22 4"></path>
                                    </svg><span>Valid passport (with at least 1 year validity)</span>
                                </li>
                                <li class="flex items-start gap-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                        ...
                                        <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                        <path d="m9 11 3 3L22 4"></path>
                                    </svg><span>Completed visa application form</span>
                                </li>
                                <li class="flex items-start gap-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                        ...
                                        <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                        <path d="m9 11 3 3L22 4"></path>
                                    </svg><span>3 biometric passport photos (35x45mm)</span>
                                </li>
                                <li class="flex items-start gap-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                        ...
                                        <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                        <path d="m9 11 3 3L22 4"></path>
                                    </svg><span>Cover letter explaining your purpose and plans</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <ul class="space-y-3">
                                <li class="flex items-start gap-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        ...
                                        <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                        <path d="m9 11 3 3L22 4"></path>
                                    </svg><span>Signed Ausbildung contract (Ausbildungsvertrag)</span>
                                </li>
                                <li class="flex items-start gap-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                        ...
                                        <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                        <path d="m9 11 3 3L22 4"></path>
                                    </svg><span>German language certificate (minimum B1 level)</span>
                                </li>
                                <li class="flex items-start gap-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                        ...
                                        <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                        <path d="m9 11 3 3L22 4"></path>
                                    </svg><span>Educational certificates with translations</span>
                                </li>
                                <li class="flex items-start gap-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                        ...
                                        <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                        <path d="m9 11 3 3L22 4"></path>
                                    </svg><span>CV/resume in German format</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <ul class="space-y-3">
                                ...
                                <li class="flex items-start gap-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        ...
                                        <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                        <path d="m9 11 3 3L22 4"></path>
                                    </svg><span>Proof of travel health insurance for initial
                                        period</span>
                                </li>
                            </ul>
                        </div>
                            ...
                            <ul class="space-y-3">
                                <li class="flex items-start gap-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        ...
                                        <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                        <path d="m9 11 3 3L22 4"></path>
                                    </svg><span>Proof of accommodation in Germany (if
                                        available)</span>
                                </li>
                                <li class="flex items-start gap-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        ...
                                        <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                        <path d="m9 11 3 3L22 4"></path>
                                    </svg><span>Previous visa refusals documentation (if
                                        applicable)</span>
                                </li>
                                <li class="flex items-start gap-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        ...
                                        <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                        <path d="m9 11 3 3L22 4"></path>
                                    </svg><span>Declaration of authenticity for submitted
                                        documents</span>
                                </li>
                            </ul>
                        </div>
        ...
        <section class="py-16 bg-muted/30">
            <div class="container px-4 md:px-6">
                <h2 class="tracking-tight font-bold text-2xl sm:text-3xl text-secondary mb-6">
                    Post-Arrival Immigration Process
                </h2>
                <div class="bg-card border border-primary/10 rounded-xl p-6 md:p-8">
                    <p class="mb-6">
                        After arriving in Germany, you&#x27;ll need to complete
                        several immigration steps to legally settle and begin your
                        Ausbildung:
                    </p>
                    <div class="space-y-4">
                        <div class="bg-secondary border border-primary/10 rounded-lg p-4">
                            <h3
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round"
                                    class="lucide lucide-calendar mr-2 h-5 w-5 text-primary">
                                    <path d="M8 2v4"></path>
                                    <path d="M16 2v4"></path>
                                    <rect width="18" height="18" x="3" y="4" rx="2"></rect>
                                    <path d="M3 10h18"></path>
                                </svg>Address Registration (Anmeldung)
                            </h3>
                        ...
                        <div class="bg-secondary border border-primary/10 rounded-lg p-4">
                            <h3
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    ...
                                    <path d="M16 13H8"></path>
                                    <path d="M16 17H8"></path>
                                </svg>Residence Permit Application
                            </h3>
                            <p class="text-sm text-white/90">
                        ...
                        <div class="bg-secondary border border-primary/10 rounded-lg p-4">
                            <h3
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round"
                                    class="lucide lucide-circle-help mr-2 h-5 w-5 text-primary">
                                    <circle cx="12" cy="12" r="10"></circle>
                                    <path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"></path>
                                    <path d="M12 17h.01"></path>
                                </svg>Health Insurance Registration
                            </h3>
                            <p class="text-sm text-white/90">
                                ...
                                contributions partially covered by your employer.
                            </p>
                        </div>
                        <div class="bg-secondary border border-primary/10 rounded-lg p-4">
                            <h3
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round"
                                    class="lucide lucide-circle-alert mr-2 h-5 w-5 text-primary">
                                    <circle cx="12" cy="12" r="10"></circle>
                                    <line x1="12" x2="12" y1="8" y2="12"></line>
                                    <line x1="12" x2="12.01" y1="16" y2="16"></line>
                                </svg>Tax ID (Steueridentifikationsnummer)
                            </h3>
                            <p class="text-sm text-white/90">
                ...
                <div class="bg-card border border-primary/10 rounded-xl" data-orientation="vertical">
                    ...
                    ">
                            <div class="pt-1 pb-4 leading-relaxed text-sm text-muted-foreground space-y-2">
                                <p>
                                    In most countries, Ausbildung visa processing takes around <strong>8 to 12
                                        weeks</strong>
                    ...
                    ">
                            <div class="pt-1 pb-4 leading-relaxed text-sm text-muted-foreground space-y-2">
                                ...
                                <p>
                                    Showing at least beginner-level German and clear motivation for vocational training
                                    improves
                    ...
                    ">
                            <div class="pt-1 pb-4 leading-relaxed text-sm text-muted-foreground space-y-2">
                                ...
                                <p>
                                    The balance is released monthly up to a limit, so authorities know your living expenses
                                    are
                    ...
                    ">
                            <div class="pt-1 pb-4 leading-relaxed text-sm text-muted-foreground space-y-2">
                                <p>
                                    Yes. Common reasons include incomplete documents, unclear financial proof, weak
                                    interview
                                    answers, or inconsistencies in your training plan.
                                </p>
                                <p>
                                    You can usually reapply after fixing the issues and submitting a stronger, complete
                                    file.
                                </p>
                            </div>
                        </div>
                    ...
                    ">
                            <div class="pt-1 pb-4 leading-relaxed text-sm text-muted-foreground space-y-2">
                                <p>
                                    Usually not at the initial stage. The Ausbildung visa is typically issued for the
                                    trainee
                                    first.
                                </p>
                                <p>
                                    Family reunion may be possible later after you secure residence status, sufficient
                                    income,
                ...
                <div
                    ...
                    <div class="flex flex-col gap-8 items-center text-center">
                        <h2 class="tracking-tight font-bold text-2xl sm:text-3xl text-white text-center">
                            Get Your Job Offer First, Then Visa
                        </h2>
                        <p class="text-base text-white/90 leading-relaxed max-w-2xl text-center">
                            ...
                            kits. Once you have a training contract, your visa journey
                            begins.
                        </p>
