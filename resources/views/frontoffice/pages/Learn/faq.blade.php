...
@section('title', '50+ Ausbildung FAQ - Complete Guide for International Students 2026 | Azubi')

@section('meta')
    <meta name="description"
        content="Comprehensive answers to all Ausbildung questions. From applications to career success - your complete guide to German vocational training. Updated for 2026." />
    <meta name="keywords"
        content="ausbildung faq, german vocational training, international students, ausbildung guide 2026" />
    <meta property="og:title" content="50+ Ausbildung FAQ - Complete Guide for International Students 2026" />
    <meta property="og:description"
        content="Comprehensive answers to all Ausbildung questions. From applications to career success - your complete guide to German vocational training. Updated for 2026." />
    <meta property="og:url" content="https://azubi.ma/ausbildung-faq" />
...
@section('content')
    <div class="flex flex-col min-h-screen">
        <section
            ...
            <img alt="Black Forest in autumn - scenic German forest landscape" loading="eager" decoding="async"
                ...
                color: transparent;
              "
                sizes="100vw" src="{{ asset('assets/images/heroes/black-forest-hero-autumn.jpeg') }}" />
                    ...
                    <div class="animate-fade-in-up animation-delay-100">
                        <div class="inline-flex items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 border-2 border-white/80 text-white backdrop-blur-sm bg-white/10 hover:bg-white/20 px-3 py-1.5 text-sm font-semibold"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                ...
                                stroke-linejoin="round" class="lucide lucide-circle-help h-4 w-4 mr-2" aria-hidden="true">
                    ...
                    <nav class="flex flex-col sm:flex-row gap-3 sm:gap-4 animate-fade-in-up animation-delay-400 mt-2 w-full max-w-md mx-auto justify-center"
                        ...
                        <a class="inline-flex items-center justify-center gap-2 whitespace-nowrap focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 active:translate-y-0 h-14 bg-[#5D5DE9] hover:bg-[#2C3340] text-white shadow-lg hover:shadow-xl transition-all duration-300 rounded-full px-6 sm:px-7 py-5 text-base font-semibold w-full sm:w-auto hover:-translate-y-1 inline-flex items-center justify-center"
                            aria-label="Browse Questions" href="#faq-categories"><span aria-hidden="true"><svg
                                ...
                                </svg></span><span>Browse Questions</span></a><a
                            ...
                            aria-label="Ask a Question" href="{{ route('front.contact') }}"><span aria-hidden="true"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round" class="lucide lucide-message-square w-5 h-5 mr-2">
                                    <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path>
                                </svg></span><span>Ask a Question</span></a>
                    </nav>
                </div>
            </div>
        ...
        <section id="faq-categories" class="py-8 bg-background border-b border-primary/10">
            <div class="container px-4 md:px-6 max-w-4xl mx-auto">
                <div class="flex justify-center mb-6">
                    <div
                        ...
                        <span class="flex items-center gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                ...
                                <path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"></path>
                                <path d="M12 17h.01"></path>
                            </svg><span class="font-medium">34<!-- -->+ Questions Answered</span></span>
                    </div>
                </div>
                <div class="w-full">
                    <div class="relative max-w-2xl mx-auto mb-6 px-4 sm:px-0">
                        <div class="relative flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                ...
                                <circle cx="11" cy="11" r="8"></circle>
                                <path d="m21 21-4.3-4.3"></path>
                            </svg><input id="faq-search" type="text"
                                ...
                                placeholder="Search questions, answers, or topics..." value="" /><button
                                id="faq-filter-btn"
        ...
        <section class="py-12 bg-background">
            <div class="container mx-auto px-4 max-w-4xl">
                ...
                <div id="faq-items" class="space-y-4" data-faq-container>
                    <div class="border border-primary/10 rounded-lg bg-card overflow-hidden" data-category="daily-life">
                        <button
                            ...
                            aria-expanded="false">
                            <h3 class="tracking-tight font-semibold text-secondary pr-4 text-base sm:text-lg">
                        ...
                        <div class="transition-all duration-200 ease-in-out max-h-0 opacity-0 overflow-hidden">
                            <div class="px-6 pb-6">
                    ...
                    <div class="border border-primary/10 rounded-lg bg-card overflow-hidden" data-category="basics">
                        <button
                            class="w-full text-left p-6 flex items-center justify-between hover:bg-muted/50 transition-colors focus:outline-none focus:ring-2 focus:ring-primary/20 focus:ring-inset"
                            aria-expanded="false">
                            <h3 class="tracking-tight font-semibold text-secondary pr-4 text-base sm:text-lg">
                    ...
                    <div class="border border-primary/10 rounded-lg bg-card overflow-hidden" data-category="career">
                        <button
                            class="w-full text-left p-6 flex items-center justify-between hover:bg-muted/50 transition-colors focus:outline-none focus:ring-2 focus:ring-primary/20 focus:ring-inset"
                            aria-expanded="false">
                            <h3 class="tracking-tight font-semibold text-secondary pr-4 text-base sm:text-lg">
                    ...
                    <div class="border border-primary/10 rounded-lg bg-card overflow-hidden" data-category="finances">
                        <button
                            class="w-full text-left p-6 flex items-center justify-between hover:bg-muted/50 transition-colors focus:outline-none focus:ring-2 focus:ring-primary/20 focus:ring-inset"
                            aria-expanded="false">
                            <h3 class="tracking-tight font-semibold text-secondary pr-4 text-base sm:text-lg">
                    ...
                    <div class="border border-primary/10 rounded-lg bg-card overflow-hidden" data-category="visa">
                        <button
                            class="w-full text-left p-6 flex items-center justify-between hover:bg-muted/50 transition-colors focus:outline-none focus:ring-2 focus:ring-primary/20 focus:ring-inset"
                            aria-expanded="false">
                            <h3 class="tracking-tight font-semibold text-secondary pr-4 text-base sm:text-lg">
                    ...
                    <div class="border border-primary/10 rounded-lg bg-card overflow-hidden" data-category="language">
                        <button
                            class="w-full text-left p-6 flex items-center justify-between hover:bg-muted/50 transition-colors focus:outline-none focus:ring-2 focus:ring-primary/20 focus:ring-inset"
                            aria-expanded="false">
                            <h3 class="tracking-tight font-semibold text-secondary pr-4 text-base sm:text-lg">
                    ...
                    <div class="border border-primary/10 rounded-lg bg-card overflow-hidden" data-category="application">
                        <button
                            class="w-full text-left p-6 flex items-center justify-between hover:bg-muted/50 transition-colors focus:outline-none focus:ring-2 focus:ring-primary/20 focus:ring-inset"
                            aria-expanded="false">
                            <h3 class="tracking-tight font-semibold text-secondary pr-4 text-base sm:text-lg">
                                ...
                                <div class="border-t border-border pt-4">
                                    <div class="text-muted-foreground leading-relaxed">
                                        ...
                                        <div class="mb-1">
                                            ...
                                            <strong>visa to search for training positions</strong>
                    ...
                    <div class="border border-primary/10 rounded-lg bg-card overflow-hidden" data-category="requirements">
                        <button
                            class="w-full text-left p-6 flex items-center justify-between hover:bg-muted/50 transition-colors focus:outline-none focus:ring-2 focus:ring-primary/20 focus:ring-inset"
                            aria-expanded="false">
                            <h3 class="tracking-tight font-semibold text-secondary pr-4 text-base sm:text-lg">
                            ...
                            <div class="px-6 pb-6">
                                <div class="border-t border-border pt-4">
                                    <div class="text-muted-foreground leading-relaxed">
                                        <div class="mb-1">
                                            The
                                            <strong>German federal government announced a minimum
                                        ...
                                        <br />
                                        <div class="mb-1">
                                            <strong>After Completion (2025 projections):</strong>
                                        </div>
                            ...
                            <div class="px-6 pb-6">
                                <div class="border-t border-border pt-4">
                                    <div class="text-muted-foreground leading-relaxed">
                                        ...
                                        <br />
                                        <div class="mb-1">
                                            <strong>Requirements for Permanent Residency:</strong>
                                        </div>
                                        <div class="mb-1">
                    ...
                    <div class="border border-primary/10 rounded-lg bg-card overflow-hidden"
                                ...
                                <div class="border-t border-border pt-4">
                                    <div class="text-muted-foreground leading-relaxed">
                                        <div class="mb-1">
                                            ...
                                            following documents
                                            <strong>must be professionally translated into
                                                German</strong>
                                            and notarized:
                                        </div>
                                        <br />
                                        <div class="mb-1">
                                            <strong>Essential Documents Requiring
                                                Translation:</strong>
                                        </div>
                                        <div class="mb-1">
                                        ...
                                        <br />
                                        <div class="mb-1">
                                            <strong>Documents NOT Requiring Translation:</strong>
                                        </div>
                                        <div class="mb-1">
                            ...
                            <div class="px-6 pb-6">
                                <div class="border-t border-border pt-4">
                                    <div class="text-muted-foreground leading-relaxed">
                                        ...
                                        <br />
                                        <div class="mb-1">
                                            <strong>Best Cities for International Students
                                                (2025):</strong>
                                        </div>
                                        <br />
                                        <div class="mb-1">
                            ...
                            <div class="px-6 pb-6">
                                <div class="border-t border-border pt-4">
                                    <div class="text-muted-foreground leading-relaxed">
                                        ...
                                        <div class="mb-1">
                                            -
                                            <strong>ZAB (Central Office for Foreign
                                                Education)</strong>
                            ...
                            <div class="px-6 pb-6">
                                <div class="border-t border-border pt-4">
                                    <div class="text-muted-foreground leading-relaxed">
                                        ...
                                        <br />
                                        <div class="mb-1">
                                            <strong>1. Healthcare &amp; Nursing (40,000+
                                                openings)</strong>
                                        </div>
                                        <div class="mb-1">
                                        ...
                                        <br />
                                        <div class="mb-1">
                                            <strong>2. IT &amp; Technology (25,000+ openings)</strong>
                                        </div>
                                        <div class="mb-1">
                                        ...
                                        <br />
                                        <div class="mb-1">
                                            <strong>3. Engineering &amp; Manufacturing (18,000+
                                                openings)</strong>
                                        </div>
                                        <div class="mb-1">
                                        ...
                                        <br />
                                        <div class="mb-1">
                                            <strong>4. Green Energy &amp; Environment (15,000+
                                                openings)</strong>
                                        </div>
                                        <div class="mb-1">
                                        ...
                                        <br />
                                        <div class="mb-1">
                                            <strong>5. Logistics &amp; Supply Chain (12,000+
                                                openings)</strong>
                                        </div>
                                        <div class="mb-1">
                            ...
                            <div class="px-6 pb-6">
                                <div class="border-t border-border pt-4">
                                    <div class="text-muted-foreground leading-relaxed">
                                        ...
                                        <br />
                                        <div class="mb-1">
                                            <strong>Major Cities (Berlin, Munich, Hamburg,
                                                Frankfurt):</strong>
                                        </div>
                                        <div class="mb-1">
                                        ...
                                        <br />
                                        <div class="mb-1">
                                            <strong>Mid-Size Cities (Dresden, Leipzig, Hannover,
                                                Bremen):</strong>
                                        </div>
                                        <div class="mb-1">
                                        ...
                                        <br />
                                        <div class="mb-1">
                                            <strong>Smaller Cities (Chemnitz, Magdeburg, Erfurt,
                                                Rostock):</strong>
                                        </div>
                                        <div class="mb-1">
                            ...
                            <div class="px-6 pb-6">
                                <div class="border-t border-border pt-4">
                                    <div class="text-muted-foreground leading-relaxed">
                                        ...
                                        <br />
                                        <div class="mb-1">
                                            <strong>High-Paying Sectors (€40,000+ starting):</strong>
                                        </div>
                                        <br />
                                        <div class="mb-1">
                                            <strong>IT &amp; Technology:</strong>
                                        ...
                                        <br />
                                        <div class="mb-1">
                                            <strong>Mid-Range Sectors (€30,000-40,000
                                                starting):</strong>
                                        </div>
                                        <br />
                                        <div class="mb-1">
                                        ...
                                        <br />
                                        <div class="mb-1">
                                            <strong>Solid Earning Sectors (€25,000-35,000
                                                starting):</strong>
                                        </div>
                                        <br />
                                        <div class="mb-1">
                                        ...
                                        <br />
                                        <div class="mb-1">
                                            <strong>Additional Benefits (often included):</strong>
                                        </div>
                                        <div class="mb-1">
                            ...
                            <div class="px-6 pb-6">
                                <div class="border-t border-border pt-4">
                                    <div class="text-muted-foreground leading-relaxed">
                                        ...
                                        <br />
                                        <div class="mb-1">
                                            <strong>Phase 2: Application Period (3-6 months)</strong>
                                        </div>
                                        <div class="mb-1">
                                        ...
                                        <br />
                                        <div class="mb-1">
                                            <strong>Phase 3: Visa &amp; Travel (2-3 months)</strong>
                                        </div>
                                        <div class="mb-1">
                                        ...
                                        <br />
                                        <div class="mb-1">
                                            <strong>18 months before start (January for September
                                                start):</strong>
                                        </div>
                                        <div class="mb-1">
