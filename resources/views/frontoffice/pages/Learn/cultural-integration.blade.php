                ...
                <div class="max-w-2xl mx-auto">
                    <div class="bg-card border border-primary/10 rounded-xl p-6">
                        <div class="flex items-start gap-4">
                            <div class="p-2 rounded-lg azubi-bg-beige">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
        ...
        <section class="py-16 bg-muted/30">
            <div class="container px-4 md:px-6">
                    ...
                    <div>
                        ...
                        <div class="p-4 azubi-bg-beige/5 border border-primary/20 rounded-lg">
                            ...
                            <ul class="space-y-4">
                                <li class="flex items-start gap-2">
                                    <div
                                        class="azubi-bg-beige w-6 h-6 rounded-full flex items-center justify-center shrink-0 mt-0.5">
                ...
                <div class="grid gap-8 md:grid-cols-2 mt-16">
                    <div class="rounded-xl text-card-foreground shadow bg-card border border-primary/10">
                        <div class="p-6">
                            <div class="azubi-bg-beige w-12 h-12 rounded-lg flex items-center justify-center mb-4">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round"
                                    class="lucide lucide-heart text-[#5D5DE9] h-6 w-6">
                                    <path
                                        d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z">
                                    </path>
                                </svg>
                        ...
                        <div class="p-6">
                            <div class="azubi-bg-beige w-12 h-12 rounded-lg flex items-center justify-center mb-4">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round"
                                    class="lucide lucide-globe text-[#5D5DE9] h-6 w-6">
                                    <circle cx="12" cy="12" r="10"></circle>
                                    <path d="M12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 0-20"></path>
                                    <path d="M2 12h20"></path>
                                </svg>
                ...
                <div class="mt-12 p-6 azubi-bg-beige/5 border border-primary/20 rounded-xl max-w-3xl mx-auto">
                    ...
                    <div class="space-y-4">
                        <div class="flex items-start gap-3">
                            <div class="azubi-bg-beige w-8 h-8 rounded-full flex items-center justify-center shrink-0 mt-0.5">
                                <span class="text-white font-bold text-sm">1</span>
                            </div>
                            <div>
                                <h4 class="tracking-tight font-semibold sm:text-base text-secondary text-base">
                ...
                <div class="max-w-4xl mx-auto">
                    ...
                    <div class="grid md:grid-cols-3 gap-6 mb-10">
                        <a class="group block p-5 bg-card border border-primary/10 rounded-xl hover:border-primary/20 hover:shadow-md transition-all"
                            ...
                            <div class="flex items-center mb-3">
                                <div
                                    class="azubi-bg-beige/10 w-10 h-10 rounded-lg flex items-center justify-center group-hover:azubi-bg-beige/20 transition-all">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                        stroke-linecap="round" stroke-linejoin="round"
