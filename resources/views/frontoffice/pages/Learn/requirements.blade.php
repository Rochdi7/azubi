...
@section('title', 'Ausbildung Requirements 2026: Age, Education & German Level | Azubi')

@section('meta')
    <meta name="description"
        content="Check Ausbildung eligibility: 16-35 age range, school certificate (10th grade), B1 German (B2 for healthcare). Free eligibility checker with instant results." />
    <meta name="keywords"
        content="ausbildung requirements,ausbildung eligibility,ausbildung age limit,ausbildung education requirements,german level ausbildung,who can do ausbildung" />
    <meta property="og:title" content="Ausbildung Requirements 2026: Age, Education &amp; German Level" />
    <meta property="og:description"
        content="Check Ausbildung eligibility: 16-35 age range, school certificate (10th grade), B1 German (B2 for healthcare). Free eligibility checker with instant results." />
    <meta property="og:image" content="https://images.azubi.ma/og-images/requirements.png" />
...
@section('content')
    <div class="flex flex-col">
                    ...
                    <div class="animate-fade-in-up animation-delay-100">
                        <div class="inline-flex items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 border-2 border-white/80 text-white backdrop-blur-sm bg-white/10 hover:bg-white/20 px-3 py-1.5 text-sm font-semibold"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                ...
                                stroke-linejoin="round" class="lucide lucide-file-check h-4 w-4 mr-2" aria-hidden="true">
                    ...
                    <nav class="flex flex-col sm:flex-row gap-3 sm:gap-4 animate-fade-in-up animation-delay-400 mt-2 w-full max-w-md mx-auto justify-center"
                        ...
                        <a class="inline-flex items-center justify-center gap-2 whitespace-nowrap focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 active:translate-y-0 h-14 bg-[#F4991A] hover:bg-[#E5890F] text-white shadow-lg hover:shadow-xl transition-all duration-300 rounded-full px-6 sm:px-7 py-5 text-base font-semibold w-full sm:w-auto hover:-translate-y-1 inline-flex items-center justify-center"
                            aria-label="Check Eligibility" href="{{ route('front.tools.eligibility-checker') }}"><span
                                ...
                                </svg></span><span>Check Eligibility</span></a><a
                            ...
                            aria-label="View All Requirements" href="#requirements-section"><span aria-hidden="true"><svg
                                ...
                                </svg></span><span>View All Requirements</span></a>
                    </nav>
                </div>
            </div>
                    ...
                    <div
                        ...
                        <div class="p-6">
                            <div class="mb-4">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round" class="lucide lucide-school h-8 w-8 text-primary">
                            ...
                            <ul class="space-y-2 mb-4">
                                <li class="flex items-start gap-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        ...
                                        <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                        <path d="m9 11 3 3L22 4"></path>
                                    </svg><span>Science background for healthcare, IT, and
                                ...
                                <li class="flex items-start gap-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        ...
                                        <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                        <path d="m9 11 3 3L22 4"></path>
                                    </svg><span>Business/Commerce background for retail, logistics,
                                ...
                                <li class="flex items-start gap-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        ...
                                        <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                        <path d="m9 11 3 3L22 4"></path>
                                    </svg><span>Vocational diploma graduates are also eligible</span>
                                </li>
                                <li class="flex items-start gap-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                        ...
                                        <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                        <path d="m9 11 3 3L22 4"></path>
                                    </svg><span>Bachelor&#x27;s degree holders can apply for advanced
                                        standing</span>
                                </li>
                            </ul>
                        </div>
                            ...
                            <ul class="space-y-2 mb-4">
                                ...
                                <li class="flex items-start gap-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        ...
                                        <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                        <path d="m9 11 3 3L22 4"></path>
                                    </svg><span>Healthcare sector often requires B2 level</span>
                                </li>
                                <li class="flex items-start gap-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                        ...
                                        <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                        <path d="m9 11 3 3L22 4"></path>
                                    </svg><span>Certification from Goethe-Institut or telc</span>
                                </li>
                                <li class="flex items-start gap-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    ...
                                    </svg><span>English-only applications are not accepted</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <ul class="space-y-2 mb-4">
                                <li class="flex items-start gap-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        ...
                                        <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                        <path d="m9 11 3 3L22 4"></path>
                                    </svg><span>Ideal age range: 18-30 years</span>
                                </li>
                                <li class="flex items-start gap-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                        ...
                                        <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                        <path d="m9 11 3 3L22 4"></path>
                                    </svg><span>Applicants up to 35 may be considered for high-demand
                                        sectors</span>
                                </li>
                                <li class="flex items-start gap-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                ...
                                <li class="flex items-start gap-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        ...
                                        <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                        <path d="m9 11 3 3L22 4"></path>
                                    </svg><span>Clean background check</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <ul class="space-y-2 mb-4">
                                <li class="flex items-start gap-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        ...
                                        <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                        <path d="m9 11 3 3L22 4"></path>
                                    </svg><span>Valid passport (minimum 1 year validity)</span>
                                </li>
                                <li class="flex items-start gap-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                        ...
                                        <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                        <path d="m9 11 3 3L22 4"></path>
                                    </svg><span>Signed training contract from German employer</span>
                                </li>
                                <li class="flex items-start gap-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                        ...
                                        <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                        <path d="m9 11 3 3L22 4"></path>
                                    </svg><span>Proof of German language skills (certificate)</span>
                                </li>
                                <li class="flex items-start gap-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                        ...
                                        <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                        <path d="m9 11 3 3L22 4"></path>
                                    </svg><span>Biometric photos and completed application
                                        forms</span>
                                </li>
                            </ul>
                        </div>
                            ...
                            <ul class="space-y-2 mb-4">
                                ...
                                <li class="flex items-start gap-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        ...
                                        <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                        <path d="m9 11 3 3L22 4"></path>
                                    </svg><span>Visa application fee (approximately €75)</span>
                                </li>
                                <li class="flex items-start gap-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                        ...
                                        <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                        <path d="m9 11 3 3L22 4"></path>
                                    </svg><span>Health insurance for visa application</span>
                                </li>
                                <li class="flex items-start gap-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                        ...
                                        <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                        <path d="m9 11 3 3L22 4"></path>
                                    </svg><span>Funds for travel to Germany</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <ul class="space-y-2 mb-4">
                                <li class="flex items-start gap-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        ...
                                        <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                        <path d="m9 11 3 3L22 4"></path>
                                    </svg><span>German-style CV (Lebenslauf)</span>
                                </li>
                                <li class="flex items-start gap-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                        ...
                                        <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                        <path d="m9 11 3 3L22 4"></path>
                                    </svg><span>Motivation letter (Motivationsschreiben)</span>
                                </li>
                                <li class="flex items-start gap-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                        ...
                                        <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                        <path d="m9 11 3 3L22 4"></path>
                                    </svg><span>Educational certificates with German
                                        translations</span>
                                </li>
                                <li class="flex items-start gap-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        ...
                                        <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                        <path d="m9 11 3 3L22 4"></path>
                                    </svg><span>German language certificate</span>
                                </li>
                            </ul>
                        </div>
                    </div>
        ...
        <section class="py-16 bg-muted/30">
            <div class="container px-4 md:px-6">
                <h2 class="tracking-tight font-bold text-2xl sm:text-3xl text-secondary mb-6 text-center">
                ...
                <div dir="ltr" data-orientation="horizontal" class="max-w-4xl mx-auto">
                    <div role="tablist" aria-orientation="horizontal"
                        ...
                        <button type="button" role="tab" aria-selected="true"
                            ...
                            Science</button><button type="button" role="tab" aria-selected="false"
                            aria-controls="radix-«R2guslb»-content-commerce" data-state="inactive"
                            id="radix-«R2guslb»-trigger-commerce"
                            class="inline-flex flex-shrink-0 items-center whitespace-nowrap rounded-lg px-4 py-2.5 text-sm font-semibold ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-white data-[state=active]:text-primary data-[state=active]:shadow-md hover:bg-white/50 w-full justify-start sm:justify-center"
                            tabindex="-1" data-orientation="horizontal" data-radix-collection-item="">
                            Business/Commerce</button><button type="button" role="tab" aria-selected="false"
                            aria-controls="radix-«R2guslb»-content-arts" data-state="inactive"
                    ...
                    <div data-state="active" data-orientation="horizontal" role="tabpanel"
                        aria-labelledby="radix-«R2guslb»-trigger-science" id="radix-«R2guslb»-content-science"
                        tabindex="0"
                        ...
                        <ul class="grid grid-cols-1 md:grid-cols-2 gap-2 mb-6">
                            <li class="flex items-center gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    ...
                                    <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                    <path d="m9 11 3 3L22 4"></path>
                                </svg><span>Healthcare &amp; Nursing (biology students)</span>
                            </li>
                            <li class="flex items-center gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    ...
                                    <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                    <path d="m9 11 3 3L22 4"></path>
                                </svg><span>IT &amp; Software Development</span>
                            </li>
                            <li class="flex items-center gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    ...
                                    <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                    <path d="m9 11 3 3L22 4"></path>
                                </svg><span>Engineering &amp; Technical</span>
                            </li>
                            <li class="flex items-center gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    ...
                                    <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                    <path d="m9 11 3 3L22 4"></path>
                                </svg><span>Laboratory Technician</span>
                            </li>
                        </ul>
                    ...
                    <div data-state="inactive" data-orientation="horizontal" role="tabpanel"
                        aria-labelledby="radix-«R2guslb»-trigger-commerce" hidden=""
                        id="radix-«R2guslb»-content-commerce" tabindex="0"
                        class="ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 p-6 bg-card border rounded-lg mt-6">
                        <h3 class="tracking-tight font-semibold text-base sm:text-lg text-secondary mb-4">
                            Business/Commerce Background
                        </h3>
                        <p class="mb-4">
                            Students with a business or commerce background are well-suited for a variety of commercial and
                            administrative Ausbildung programs.
                        </p>
                        <h4 class="tracking-tight font-semibold text-sm sm:text-base text-secondary mb-2">
                            Recommended Sectors:
                        </h4>
                        <ul class="grid grid-cols-1 md:grid-cols-2 gap-2 mb-6">
                            <li class="flex items-center gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    ...
                                    <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                    <path d="m9 11 3 3L22 4"></path>
                                </svg><span>Banking &amp; Finance (Bankkaufmann/-frau)</span>
                            </li>
                            <li class="flex items-center gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    ...
                                    <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                    <path d="m9 11 3 3L22 4"></path>
                                </svg><span>Office Management (Kaufmann/-frau f&uuml;r B&uuml;romanagement)</span>
                            </li>
                            <li class="flex items-center gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    ...
                                    <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                    <path d="m9 11 3 3L22 4"></path>
                                </svg><span>Retail &amp; Wholesale (Kaufmann/-frau im Handel)</span>
                            </li>
                            <li class="flex items-center gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    ...
                                    <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                    <path d="m9 11 3 3L22 4"></path>
                                </svg><span>Insurance &amp; Tax Consulting</span>
                            </li>
                        </ul>
                        <p class="text-sm text-muted-foreground">
                            Note: Strong mathematics skills are beneficial for banking and finance sectors. Accounting
                            knowledge gives you an advantage in tax consulting roles.
                        </p>
                    </div>
                    <div data-state="inactive" data-orientation="horizontal" role="tabpanel"
                        aria-labelledby="radix-«R2guslb»-trigger-arts" hidden=""
                        id="radix-«R2guslb»-content-arts" tabindex="0"
                        class="ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 p-6 bg-card border rounded-lg mt-6">
                        <h3 class="tracking-tight font-semibold text-base sm:text-lg text-secondary mb-4">
                            Arts/Humanities Background
                        </h3>
                        <p class="mb-4">
                            Students with an arts or humanities background can pursue creative and communication-focused
                            Ausbildung programs.
                        </p>
                        <h4 class="tracking-tight font-semibold text-sm sm:text-base text-secondary mb-2">
                            Recommended Sectors:
                        ...
                        <ul class="grid grid-cols-1 md:grid-cols-2 gap-2 mb-6">
                            <li class="flex items-center gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    ...
                                    <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                    <path d="m9 11 3 3L22 4"></path>
                                </svg><span>Media &amp; Design (Mediengestalter/in)</span>
                            </li>
                            <li class="flex items-center gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    ...
                                    <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                    <path d="m9 11 3 3L22 4"></path>
                                </svg><span>Event Management (Veranstaltungskaufmann/-frau)</span>
                            </li>
                            <li class="flex items-center gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    ...
                                    <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                    <path d="m9 11 3 3L22 4"></path>
                                </svg><span>Hotel &amp; Tourism (Hotelfachmann/-frau)</span>
                            </li>
                            <li class="flex items-center gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    ...
                                    <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                                    <path d="m9 11 3 3L22 4"></path>
                                </svg><span>Social Work &amp; Education (Erzieher/in)</span>
                            </li>
                        </ul>
                        <p class="text-sm text-muted-foreground">
                            Note: Language skills are highly valued in tourism and hotel sectors. A creative portfolio can
                            strengthen applications for media and design programs.
                        </p>
                    </div>
                </div>
            </div>
    ...
    @push('scripts')
        <script src="{{ asset('assets/js/requirements-tabs.js') }}"></script>
    @endpush
@endsection
