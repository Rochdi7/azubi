...
<div class="flex flex-col">
          ...
          >
            <img
              alt="Saxon Switzerland in autumn - dramatic sandstone formations in Germany"
              loading="eager"
              decoding="async"
              data-nimg="fill"
              ...
              "
              sizes="100vw"
              src="{{ asset('assets/_next/saxon-switzerland-hero-autumndb61.jpeg') }}"
            />
                ...
                <div class="animate-fade-in-up animation-delay-100">
                  ...
                  >
                    <svg
                      ...
                      class="lucide lucide-house h-4 w-4 mr-2"
                      aria-hidden="true"
                    >
                      <path
                  ...
                  <a
                    ...
                    ><span aria-hidden="true"
                      ><svg
                        ...
                        stroke-linecap="round"
                        stroke-linejoin="round"
                        class="lucide lucide-house w-5 h-5 mr-2"
                      >
                        <path
                          d="M15 21v-8a1 1 0 0 0-1-1h-4a1 1 0 0 0-1 1v8"
                        ></path>
          ...
          <section id="housing-options" class="py-16">
            <div class="container px-4 md:px-6">
              ...
              <div class="grid md:grid-cols-2 gap-10 items-center">
                ...
                >
                  <img
                    alt="Apartment building in Germany"
                    loading="lazy"
                    decoding="async"
                    data-nimg="fill"
                    class="object-cover"
                    ...
                    "
                    sizes="100vw"
                    src="{{ asset('assets/_next/housing-germany6e22.jpeg') }}"
                  />
                  <div
                    class="absolute bottom-0 left-0 right-0 bg-card/95 border-t border-primary/10 p-4"
                  >
                ...
                <div>
                  ...
                  <ul class="space-y-3">
                    <li class="flex items-start gap-3">
                      ...
                      ><span>Consider proximity to your training location</span>
                    </li>
                    <li class="flex items-start gap-3">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                      ...
                      >
                        ...
                        <path d="m9 11 3 3L22 4"></path></svg
                      ><span
                        >Research the neighborhood and transportation
                        options</span
                      >
                    </li>
                    <li class="flex items-start gap-3">
                    ...
                    <li class="flex items-start gap-3">
                      ...
                      >
                        ...
                        <path d="m9 11 3 3L22 4"></path></svg
                      ><span
                        >Check if utilities and internet are included in the
                        rent</span
                      >
                    </li>
                  </ul>
              ...
              <div class="grid gap-8 md:grid-cols-3 mt-16">
                        ...
                        <ul class="space-y-1">
                          ...
                          >
                            ...
                            >
                              <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                              <path d="m9 11 3 3L22 4"></path></svg
                            ><span>Affordable monthly rent (€250-350)</span>
                          </li>
                          <li
                            class="flex items-start gap-2 text-sm text-muted-foreground"
                          >
                            ...
                            >
                              <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                              <path d="m9 11 3 3L22 4"></path></svg
                            ><span>Usually furnished with basic amenities</span>
                          </li>
                          <li
                            class="flex items-start gap-2 text-sm text-muted-foreground"
                          >
                            ...
                            >
                              ...
                              <path d="m9 11 3 3L22 4"></path></svg
                            ><span
                              >All-inclusive pricing (utilities, internet)</span
                            >
                          </li>
                          <li
                            class="flex items-start gap-2 text-sm text-muted-foreground"
                          >
                            ...
                            >
                              <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                              <path d="m9 11 3 3L22 4"></path></svg
                            ><span>Community of fellow students/trainees</span>
                          </li>
                        </ul>
                      </div>
                      <div>
                          ...
                          >
                            ...
                            >
                              ...
                              <line
                                ...
                                y2="16"
                              ></line></svg
                            ><span>Usually small rooms (10-16 m²)</span>
                          </li>
                          <li
                            class="flex items-start gap-2 text-sm text-muted-foreground"
                          >
                            ...
                            >
                              ...
                              <line
                                ...
                                y2="16"
                              ></line></svg
                            ><span>Often shared kitchens and bathrooms</span>
                          </li>
                          <li
                            class="flex items-start gap-2 text-sm text-muted-foreground"
                          >
                            ...
                            >
                              ...
                              <line
                                ...
                                y2="16"
                              ></line></svg
                            ><span>High demand with waiting lists</span>
                          </li>
                        </ul>
                      </div>
                    </div>
                ...
                >
                  <div class="p-6">
                    <div
                      class="bg-green-500 w-12 h-12 rounded-lg flex items-center justify-center mb-4"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                        ...
                        <ul class="space-y-1">
                          ...
                          >
                            ...
                            >
                              ...
                              <path d="m9 11 3 3L22 4"></path></svg
                            ><span
                              >Moderate costs (€300-500 depending on city)</span
                            >
                          </li>
                          <li
                            class="flex items-start gap-2 text-sm text-muted-foreground"
                          >
                            ...
                            >
                              ...
                              <path d="m9 11 3 3L22 4"></path></svg
                            ><span
                              >Social interaction and language practice</span
                            >
                          </li>
                          <li
                            class="flex items-start gap-2 text-sm text-muted-foreground"
                          >
                            ...
                            >
                              <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                              <path d="m9 11 3 3L22 4"></path></svg
                            ><span>More space than dormitories</span>
                          </li>
                          <li
                            class="flex items-start gap-2 text-sm text-muted-foreground"
                          >
                            ...
                            >
                              <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                              <path d="m9 11 3 3L22 4"></path></svg
                            ><span>Cultural integration opportunities</span>
                          </li>
                        </ul>
                      </div>
                      <div>
                        ...
                        <ul class="space-y-1">
                          ...
                          >
                            ...
                            >
                              ...
                              <line
                                ...
                                y2="16"
                              ></line></svg
                            ><span>Compatibility with roommates varies</span>
                          </li>
                          <li
                            class="flex items-start gap-2 text-sm text-muted-foreground"
                          >
                          ...
                          >
                            ...
                            >
                              ...
                              ></line></svg
                            ><span
                              >Shared responsibility for cleaning/bills</span
                            >
                          </li>
                        </ul>
                      </div>
                ...
                >
                  <div class="p-6">
                    <div
                      class="bg-amber-500 w-12 h-12 rounded-lg flex items-center justify-center mb-4"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                        ...
                        <ul class="space-y-1">
                          ...
                          >
                            ...
                            >
                              <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                              <path d="m9 11 3 3L22 4"></path></svg
                            ><span>Complete privacy and independence</span>
                          </li>
                          <li
                            class="flex items-start gap-2 text-sm text-muted-foreground"
                          >
                            ...
                            >
                              <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                              <path d="m9 11 3 3L22 4"></path></svg
                            ><span>No compromises on lifestyle</span>
                          </li>
                          <li
                            class="flex items-start gap-2 text-sm text-muted-foreground"
                          >
                            ...
                            >
                              <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                              <path d="m9 11 3 3L22 4"></path></svg
                            ><span>Option to have visitors anytime</span>
                          </li>
                          <li
                            class="flex items-start gap-2 text-sm text-muted-foreground"
                          >
                            ...
                            >
                              ...
                              <path d="m9 11 3 3L22 4"></path></svg
                            ><span
                              >Often better equipped kitchens/bathrooms</span
                            >
                          </li>
                        </ul>
                      </div>
                        ...
                        <ul class="space-y-1">
                          ...
                          >
                            ...
                            >
                              ...
                              ></line></svg
                            ><span
                              >Highest cost (€450-800+ depending on city)</span
                            >
                          </li>
                          <li
                            class="flex items-start gap-2 text-sm text-muted-foreground"
                          >
                            ...
                            >
                              ...
                              ></line></svg
                            ><span
                              >Requires full deposit (3 months&#x27; rent)</span
                            >
                          </li>
                          <li
                            class="flex items-start gap-2 text-sm text-muted-foreground"
                          >
                            ...
                            >
                              ...
                              <line
                                ...
                                y2="16"
                              ></line></svg
                            ><span>May be unfurnished (additional costs)</span>
                          </li>
                          <li
                            class="flex items-start gap-2 text-sm text-muted-foreground"
                          >
                            ...
                            >
                              ...
                              ></line></svg
                            ><span
                              >More extensive application requirements</span
                            >
                          </li>
                        </ul>
                      </div>
          ...
          <section class="py-16 bg-muted/30">
            <div class="container px-4 md:px-6">
              ...
              <div class="grid md:grid-cols-2 gap-10 items-center">
                  ...
                  <div class="space-y-4 mb-6">
                    ...
                    >
                      ...
                      <ul class="space-y-2 text-sm text-muted-foreground">
                        <li class="flex items-start gap-2">
                          <span class="font-medium w-28">Kaltmiete:</span
                          ><span
                            >&quot;Cold rent&quot; - basic rent without
                            utilities</span
                          >
                        </li>
                        <li class="flex items-start gap-2">
                          <span class="font-medium w-28">Warmmiete:</span
                          ><span
                            >&quot;Warm rent&quot; - includes heating and some
                            utilities</span
                          >
                        </li>
                        <li class="flex items-start gap-2">
                          <span class="font-medium w-28">Nebenkosten:</span
                          ><span
                            >Additional costs/utilities (water, garbage,
                            etc.)</span
                          >
                        </li>
                        <li class="flex items-start gap-2">
                          <span class="font-medium w-28">Kaution:</span
                          ><span
                        ...
                        <li class="flex items-start gap-2">
                          <span class="font-medium w-28">Provision:</span
                          ><span>Real estate agent fee (if applicable)</span>
                        </li>
                      </ul>
                    </div>
                  </div>
                ...
                >
                  <img
                    alt="Signing a rental contract in Germany"
                    loading="lazy"
                    decoding="async"
                    data-nimg="fill"
                    class="object-cover"
                    ...
                    "
                    sizes="100vw"
                    src="{{ asset('assets/_next/housing-rentald80e.jpeg') }}"
                  />
                  <div
                    class="absolute bottom-0 left-0 right-0 bg-card/95 border-t border-primary/10 p-4"
                  >
                          ...
                          <ul class="space-y-1 text-sm text-muted-foreground">
                            <li class="flex items-start gap-2">
                              ...
                              >
                                ...
                                ></path>
                                <path d="m9 11 3 3L22 4"></path></svg
                              ><span>Copy of ID or passport with visa</span>
                            </li>
                            <li class="flex items-start gap-2">
                              <svg
                                xmlns="http://www.w3.org/2000/svg"
                              ...
                              >
                                ...
                                <path d="m9 11 3 3L22 4"></path></svg
                              ><span
                                >Proof of income (Ausbildung contract)</span
                              >
                            </li>
                            <li class="flex items-start gap-2">
                              <svg
                              ...
                              >
                                ...
                                ></path>
                                <path d="m9 11 3 3L22 4"></path></svg
                              ><span>SCHUFA credit report (if available)</span>
                            </li>
                            <li class="flex items-start gap-2">
                              <svg
                                xmlns="http://www.w3.org/2000/svg"
                              ...
                              >
                                ...
                                <path d="m9 11 3 3L22 4"></path></svg
                              ><span
                                >Letter from previous landlord (if
                                applicable)</span
                              >
                            </li>
                            <li class="flex items-start gap-2">
                            ...
                            <li class="flex items-start gap-2">
                              ...
                              >
                                ...
                                <path d="m9 11 3 3L22 4"></path></svg
                              ><span
                                >Application letter (Bewerbungsschreiben)</span
                              >
                            </li>
                          </ul>
                        </div>
              ...
              >
                ...
                >
                  <svg
                    ...
                    stroke-linecap="round"
                    stroke-linejoin="round"
                    class="lucide lucide-circle-alert h-5 w-5 text-amber-500"
                  >
                    <circle cx="12" cy="12" r="10"></circle>
                    <line x1="12" x2="12" y1="8" y2="12"></line>
                    <line x1="12" x2="12.01" y1="16" y2="16"></line></svg
                  ><span>Important: Registration Requirement</span>
                </h3>
                ...
                <ul class="space-y-1 mb-2">
                  <li class="flex items-start gap-2">
                    ...
                    ><span class="text-sm text-muted-foreground"
                      >Your passport and visa/residence permit</span
                    >
                  </li>
                  <li class="flex items-start gap-2">
                    <svg
                    ...
                    >
                      ...
                      <path d="m9 11 3 3L22 4"></path></svg
                    ><span class="text-sm text-muted-foreground"
                      >Completed registration form (available at the office or
                      online)</span
                    >
                  </li>
                  <li class="flex items-start gap-2">
                  ...
                  <li class="flex items-start gap-2">
                    ...
                    >
                      ...
                      <path d="m9 11 3 3L22 4"></path></svg
                    ><span class="text-sm text-muted-foreground"
                      >Landlord confirmation (Wohnungsgeberbestätigung)</span
                    >
                  </li>
                </ul>
                <p class="text-sm text-muted-foreground">
          ...
          <section class="py-16">
            <div class="container px-4 md:px-6">
              ...
              <div class="grid md:grid-cols-2 gap-10 items-center">
                ...
                >
                  <img
                    alt="Housing costs comparison across German regions"
                    loading="lazy"
                    decoding="async"
                    data-nimg="fill"
                    class="object-cover"
                    ...
                    "
                    sizes="100vw"
                    src="{{ asset('assets/_next/housing-costs-mapac7a.jpeg') }}"
                  />
                  <div
                    class="absolute bottom-0 left-0 right-0 bg-card/95 border-t border-primary/10 p-4"
                  >
                  ...
                  <div class="p-4 bg-card border border-primary/10 rounded-lg">
                    ...
                    <div class="mt-3 pt-3 border-t border-border">
                      <div class="flex justify-between">
                        <span class="font-medium">Total Monthly:</span
                        ><span class="font-medium">€420-670</span>
                      </div>
                    </div>
                  </div>
                </div>
                    ...
                    <table class="w-full border-collapse text-sm">
                      <thead>
                        <tr class="bg-muted/50">
                          <th
                            class="border-b border-r border-border px-4 py-3 text-left font-medium"
                          >
                            City/Region
                          </th>
                          <th
                          ...
                          <th
                            class="border-b border-border px-4 py-3 text-left font-medium"
                          >
              ...
              <div class="mt-12 max-w-3xl mx-auto">
                ...
                <div class="grid sm:grid-cols-2 gap-6">
                  <div class="p-4 bg-card rounded-lg border border-primary/10">
                    ...
                    <ul class="space-y-2 text-sm text-muted-foreground">
                      <li class="flex items-start gap-2">
                        <span class="font-medium w-32">Security deposit:</span
                        ><span>2-3 months&#x27; rent (refundable)</span>
                      </li>
                      <li class="flex items-start gap-2">
                        <span class="font-medium w-32">Agent fee:</span
                        ><span
                          >Up to 2 months&#x27; rent + VAT (if applicable)</span
                        >
                      </li>
                      <li class="flex items-start gap-2">
                        <span class="font-medium w-32">Furniture:</span
                        ><span>€500-1,500 for unfurnished apartments</span>
                      </li>
                      <li class="flex items-start gap-2">
                        <span class="font-medium w-32">Basic supplies:</span
                        ><span>€200-300 for kitchen/bathroom essentials</span>
                      </li>
                      <li class="flex items-start gap-2">
                        <span class="font-medium w-32">Internet setup:</span
                        ><span>€30-70 activation fee</span>
                      </li>
                    </ul>
                  </div>
                  <div class="p-4 bg-card rounded-lg border border-primary/10">
                    ...
                    <ul class="space-y-2 text-sm text-muted-foreground">
                      <li class="flex items-start gap-2">
                        <span class="font-medium w-32">Electricity:</span
                        ><span>€30-60 per month</span>
                      </li>
                      <li class="flex items-start gap-2">
                        <span class="font-medium w-32">Internet:</span
                        ><span>€25-40 per month</span>
                      </li>
                      <li class="flex items-start gap-2">
                        <span class="font-medium w-32">Broadcasting fee:</span
                        ><span>€17.50 per month (mandatory)</span>
                      </li>
                      <li class="flex items-start gap-2">
                        <span class="font-medium w-32">Renters insurance:</span
                        ><span>€5-10 per month (recommended)</span>
                      </li>
                      <li class="flex items-start gap-2">
                        <span class="font-medium w-32">Building fees:</span
                        ><span>Variable, often included in Nebenkosten</span>
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              >
                ...
                >
                  <svg
                    ...
                    stroke-linecap="round"
                    stroke-linejoin="round"
                    class="lucide lucide-lightbulb h-5 w-5 text-accent"
                  >
                    <path
                ...
                <ul class="space-y-2">
                  <li class="flex items-start gap-2">
                    ...
                    <div>
                      <span class="font-medium"
                        >Apply for housing benefits if eligible</span
                      >
                      <p class="text-sm text-muted-foreground">
                  ...
                  <li class="flex items-start gap-2">
                    ...
                    <div>
                      <span class="font-medium"
                        >Consider locations with good public transport but
                  ...
                  <li class="flex items-start gap-2">
                    ...
                    <div>
                      <span class="font-medium"
                        >Budget for initial setup costs</span
                      >
                      <p class="text-sm text-muted-foreground">
                  ...
                  <li class="flex items-start gap-2">
                    ...
                    <div>
                      <span class="font-medium"
                        >Check if your training company offers housing
                        assistance</span
                      >
                      <p class="text-sm text-muted-foreground">
            ...
            <div class="container px-4 md:px-6">
              ...
              <div class="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
                    ...
                    <ul class="space-y-2">
                      <li class="flex items-start gap-2">
                        ...
                        >
                          ...
                          <path d="m9 11 3 3L22 4"></path></svg
                        ><span class="text-sm"
                          >Begin 3-4 months before your planned arrival</span
                        >
                      </li>
                      <li class="flex items-start gap-2">
                        <svg
                        ...
                        >
                          ...
                          <path d="m9 11 3 3L22 4"></path></svg
                        ><span class="text-sm"
                          >Avoid peak seasons (August-October,
                          February-April)</span
                        >
                      </li>
                      <li class="flex items-start gap-2">
                        ...
                        >
                          ...
                          <path d="m9 11 3 3L22 4"></path></svg
                        ><span class="text-sm"
                          >Check listings daily and respond quickly</span
                        >
                      </li>
                      <li class="flex items-start gap-2">
                        <svg
                        ...
                        >
                          ...
                          <path d="m9 11 3 3L22 4"></path></svg
                        ><span class="text-sm"
                          >Schedule viewing appointments immediately</span
                        >
                      </li>
                    </ul>
                  </div>
                ...
                >
                  <div class="p-6">
                    <div
                      class="bg-red-500 w-12 h-12 rounded-lg flex items-center justify-center mb-4"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                    ...
                    <ul class="space-y-2">
                      <li class="flex items-start gap-2">
                        ...
                        >
                          ...
                          <line x1="12" x2="12.01" y1="16" y2="16"></line></svg
                        ><span class="text-sm"
                          >Rent significantly below market average</span
                        >
                      </li>
                      <li class="flex items-start gap-2">
                        <svg
                        ...
                        >
                          ...
                          <line x1="12" x2="12.01" y1="16" y2="16"></line></svg
                        ><span class="text-sm"
                          >Requests for money before viewing the property</span
                        >
                      </li>
                      <li class="flex items-start gap-2">
                        <svg
                        ...
                        >
                          ...
                          <line x1="12" x2="12.01" y1="16" y2="16"></line></svg
                        ><span class="text-sm"
                          >Refusal to provide a proper contract</span
                        >
                      </li>
                      <li class="flex items-start gap-2">
                        <svg
                        ...
                        >
                          ...
                          <line x1="12" x2="12.01" y1="16" y2="16"></line></svg
                        ><span class="text-sm"
                          >Landlord claiming to be abroad/unable to show
                          property</span
                        >
                      </li>
                      <li class="flex items-start gap-2">
                        ...
                        >
                          ...
                          <line x1="12" x2="12.01" y1="16" y2="16"></line></svg
                        ><span class="text-sm"
                          >Pressure to decide immediately without proper
                          viewing</span
                        >
                      </li>
                    </ul>
                    ...
                    <ul class="space-y-2">
                      <li class="flex items-start gap-2">
                        ...
                        >
                          ...
                          <path d="m9 11 3 3L22 4"></path></svg
                        ><span class="text-sm"
                          >Protection against unfair rent increases</span
                        >
                      </li>
                      <li class="flex items-start gap-2">
                        <svg
                        ...
                        >
                          ...
                          <path d="m9 11 3 3L22 4"></path></svg
                        ><span class="text-sm"
                          >Required notice periods for termination</span
                        >
                      </li>
                      <li class="flex items-start gap-2">
                        <svg
                        ...
                        >
                          ...
                          <path d="m9 11 3 3L22 4"></path></svg
                        ><span class="text-sm"
                          >Rights regarding maintenance and repairs</span
                        >
                      </li>
                      <li class="flex items-start gap-2">
                        <svg
                        ...
                        >
                          ...
                          <path d="m9 11 3 3L22 4"></path></svg
                        ><span class="text-sm"
                          >Regulated deposit handling procedures</span
                        >
                      </li>
                      <li class="flex items-start gap-2">
                        <svg
                        ...
                        >
                          ...
                          <path d="m9 11 3 3L22 4"></path></svg
                        ><span class="text-sm"
                          >Access to tenant associations for support</span
                        >
                      </li>
                    </ul>
                  </div>
                    ...
                    <ul class="space-y-2">
                      <li class="flex items-start gap-2">
                        ...
                        >
                          ...
                          <path d="m9 11 3 3L22 4"></path></svg
                        ><span class="text-sm"
                          >Register within 2 weeks of moving in</span
                        >
                      </li>
                      <li class="flex items-start gap-2">
                        <svg
                        ...
                        >
                          ...
                          <path d="m9 11 3 3L22 4"></path></svg
                        ><span class="text-sm"
                          >Book appointment at local Bürgeramt</span
                        >
                      </li>
                      <li class="flex items-start gap-2">
                        <svg
                      ...
                      <li class="flex items-start gap-2">
                        ...
                        >
                          ...
                          <path d="m9 11 3 3L22 4"></path></svg
                        ><span class="text-sm"
                          >Required for bank accounts, insurance, etc.</span
                        >
                      </li>
                      <li class="flex items-start gap-2">
                        <svg
                        ...
                        >
                          ...
                          <path d="m9 11 3 3L22 4"></path></svg
                        ><span class="text-sm"
                          >Update registration when changing address</span
                        >
                      </li>
                    </ul>
                  </div>
              ...
              <div
                class="mt-12 p-6 bg-card rounded-xl border border-primary/10 max-w-3xl mx-auto"
              >
                <h3
                  class="tracking-tight font-semibold text-base sm:text-lg text-secondary mb-4"
                >
                    ...
                    <ul class="space-y-2 text-sm text-muted-foreground">
                      ...
                      <li class="flex items-start gap-2">
                        ...
                        >
                          ...
                          <path d="m12 5 7 7-7 7"></path></svg
                        ><a
                          href="https://www.studenten-wg.de/"
                          target="_blank"
                          rel="noopener noreferrer"
                          class="hover:underline"
                          >Studenten-WG.de</a
                    ...
                    <ul class="space-y-2 text-sm text-muted-foreground">
                      <li class="flex items-start gap-2">
                        ...
                        ><a
                          ...
                          rel="noopener noreferrer"
                          class="hover:underline"
                          >Studentenwerke (Student Services)</a
                        >
                      </li>
                      <li class="flex items-start gap-2">
                        <svg
                        ...
                        ><a
                          ...
                          rel="noopener noreferrer"
                          class="hover:underline"
                          >Deutscher Mieterbund (Tenants&#x27; Association)</a
                        >
                      </li>
                      <li class="flex items-start gap-2">
                        <svg
                        ...
                        ><a
                          ...
                          rel="noopener noreferrer"
                          class="hover:underline"
                          >DAAD (German Academic Exchange Service)</a
                        >
                      </li>
                      <li class="flex items-start gap-2">
                        <svg
                        ...
                        ><a
                          ...
                          rel="noopener noreferrer"
                          class="hover:underline"
                          >Make it in Germany (Official Portal)</a
                        >
                      </li>
                    </ul>
                  </div>
                ...
                <div
                  class="mt-6 p-3 bg-card border border-primary/10 rounded-lg text-sm text-muted-foreground"
                >
              ...
              <div
                class="mt-8 p-6 border border-primary/10 rounded-xl bg-card max-w-3xl mx-auto"
              >
                <h3
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  <a
                    ...
                    ><span class="text-sm font-medium"
                      >Daily Life During Ausbildung</span
                    ></a
                  ><a
                    class="p-3 bg-background hover:bg-muted rounded-lg border border-border flex items-center gap-2 transition-colors"
                    href="visa.html"
