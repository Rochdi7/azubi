...
@section('title', 'Contact Us | Get in Touch with GoAusbildung | GoAusbildung')

@section('meta')
    <meta name="description"
        content="Have questions about Ausbildung in Germany? Get in touch with GoAusbildung. We're here to help you navigate your vocational training journey in Germany.">
    <meta name="keywords"
        content="contact GoAusbildung,Ausbildung in Germany,vocational training Germany,German apprenticeship,student advisory for Ausbildung">
    <meta property="og:title" content="Contact Us | Get in Touch with GoAusbildung">
                    ...
                    <div class="mx-auto w-full px-4 sm:px-6 lg:px-8 max-w-7xl relative z-10">
                        <div class="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
                            <div class="space-y-6 text-center lg:text-left">
                                ...
                                <div class="space-y-4">
                                    <h1
                                        class="text-4xl md:text-5xl lg:text-6xl font-bold text-secondary leading-tight tracking-tight">
                                    ...
                                    <div class="flex items-start gap-3 lg:justify-start">
                                        ...
                                        <div class="flex-1 text-left">
                                            <span class="block text-base font-semibold text-secondary">Direct
                                                Email</span>
                                            <span
                                                class="text-sm text-muted-foreground">hello@goausbildung.com</span>
                                        </div>
                                    </div>
                                </div>
                                <!-- CTA -->
                            ...
                            <div class="hidden lg:flex relative justify-center items-center min-h-[500px]">
                                <div class="relative w-full max-w-lg">
                                    <img alt="GoAusbildung mascot welcoming you" width="600" height="600"
                                        class="w-full h-auto"
                    ...
                    <div class="mx-auto w-full px-4 sm:px-6 lg:px-8 max-w-7xl">
                            ...
                            <div>
                                <div
                                    ...
                                    <div class="p-6">
                                        ...
                                        <a href="mailto:hello@goausbildung.com"
                            ...
                            <div>
                                <div
                                    ...
                                    <div class="p-6">
                                        ...
                                        <a href="https://wa.me/971522884118" target="_blank" rel="noopener noreferrer"
                                            class="text-primary font-medium hover:text-orange-hover transition-colors inline-flex items-center gap-2 group text-sm">
                                            Start Chat
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                        ...
                        <div class="text-center mb-8">
                            ...
                            <p class="text-lg text-muted-foreground max-w-2xl mx-auto">We're proud to serve students
                                globally with offices in Dubai and Bangalore.</p>
                        </div>
                        ...
                        <div class="grid md:grid-cols-2 gap-8 relative">
                            ...
                            <div>
                                <div
                                    class="text-card-foreground h-full bg-card border-0 shadow-md rounded-2xl overflow-hidden">
                                    <div class="p-0">
                                        <div class="p-4" style="background-color:rgba(244,153,26,0.1)">
                                            <div class="flex items-center gap-3">
                                                ...
                                                <h3 class="font-semibold text-lg text-secondary">Dubai HQ</h3>
                                            </div>
                                        </div>
                                        <div class="p-6 space-y-4">
                                            <p class="text-sm text-muted-foreground leading-relaxed">
                                                Onyx Building, Unit 101-228<br>Al Khabeesi, Dubai 239532<br>United Arab
                                                Emirates
                                            </p>
                                            <div class="pt-4 border-t space-y-2">
                                                <div class="flex items-center gap-2">
                                                    ...
                                                    <a href="mailto:hello@goausbildung.com"
                                                        class="text-sm text-primary hover:underline">hello@goausbildung.com</a>
                                                </div>
                                                <div class="flex items-center gap-2">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                        viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    ...
                                                    <a href="tel:+971522884118"
                                                        class="text-sm text-primary hover:underline">+971 52 288
                                                        4118</a>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="p-0">
                                        <div class="p-4" style="background-color:rgba(244,153,26,0.1)">
                                            <div class="flex items-center gap-3">
                                                ...
                                                <h3 class="font-semibold text-lg text-secondary">India Office -
                                                    Bangalore</h3>
                                            </div>
                                        </div>
                                        <div class="p-6 space-y-4">
                                            <p class="text-sm text-muted-foreground leading-relaxed">
                                                No. 113, Kanaka Towers<br>16th Cross, JP Nagar 4th Phase<br>Dollars
                                                Colony, Bangalore 560078<br>Karnataka, India
                                            </p>
                                            <div class="pt-4 border-t space-y-2">
                                                <div class="flex items-center gap-2">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                        ...
                        <div class="grid lg:grid-cols-[1fr_0.4fr] gap-8 items-start max-w-5xl mx-auto">
                            ...
                            <div class="hidden lg:flex flex-col items-center space-y-4">
                                <img src="{{ asset('assets/_next/mascot_studying_malec9f9.jpeg') }}"
                                    alt="GoAusbildung mascot encouraging you" class="w-full max-w-[280px] h-auto">
                    ...
                    <div class="mx-auto w-full px-4 sm:px-6 lg:px-8 max-w-7xl">
                                ...
                                <div
                                    ...
                                    <div class="faq-content-tw" style="display:none;">
                                        <div class="px-5 pb-5 text-sm text-muted-foreground leading-relaxed">
                                            Getting started is easy! Create a free account on GoAusbildung, complete your
                        ...
                        <div class="mt-12 text-center">
                            ...
                            <div class="inline-flex items-center justify-center px-6 py-3 rounded-full text-primary font-medium"
                                ...
                                Email us at <a href="mailto:hello@goausbildung.com"
                                    class="hover:underline font-semibold ml-1">hello@goausbildung.com</a>
                            </div>
                        </div>
                    </div>
                </section>
