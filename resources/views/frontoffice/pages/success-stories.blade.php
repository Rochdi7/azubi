    ...
    <main>
        <section class="relative min-h-[30vh] w-full overflow-visible">
            <div
                ...
                <div class="relative w-32 h-32 sm:w-40 sm:h-40 mx-auto animate-appear">
                    <img alt="Young Oak mascot - Celebrating student success stories" decoding="async" data-nimg="fill"
        ...
        <section class="py-12">
            <div class="container px-4 md:px-6">
                <div class="space-y-10">
                    <div class="group relative w-full max-w-2xl mx-auto transition-all duration-300">
                        <div class="relative flex items-center">
                            ...
                            </svg><input type="search" placeholder="Search by name, university, course or intake..."
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
                                ...
                                <div class="p-6 pt-6 pb-6 px-6">
                                    ...
                                    <div class="mt-4">
                                        <a target="_blank" rel="noopener noreferrer"
                                            href="https://www.instagram.com/p/DTAioS5j87b/?utm_source=ig_web_copy_link&amp;igsh=MzRlODBiNWFlZA=="><button
                            ...
                            <div
                                ...
                                <div class="p-6 pt-6 pb-6 px-6">
                                    ...
                                    <div class="mt-4">
                                        <a target="_blank" rel="noopener noreferrer"
                                            href="https://www.instagram.com/p/DS1lpytD1kV/?utm_source=ig_web_copy_link&amp;igsh=MzRlODBiNWFlZA=="><button
                                                class="whitespace-nowrap font-semibold transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 border-2 border-primary bg-transparent text-primary shadow-sm hover:bg-[#F7F8FA] hover:text-[#2C3340] hover:border-[#2C3340]/30 hover:-translate-y-0.5 active:translate-y-0 h-10 px-6 text-sm w-full flex items-center justify-center gap-2 rounded-full">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <div
                                ...
                                <div class="p-6 pt-6 pb-6 px-6">
                                    ...
                                    <div class="mt-4">
                                        <a target="_blank" rel="noopener noreferrer"
                                            href="https://www.instagram.com/p/DS1d-LaD-5K/?utm_source=ig_web_copy_link&amp;igsh=MzRlODBiNWFlZA=="><button
                                                class="whitespace-nowrap font-semibold transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 border-2 border-primary bg-transparent text-primary shadow-sm hover:bg-[#F7F8FA] hover:text-[#2C3340] hover:border-[#2C3340]/30 hover:-translate-y-0.5 active:translate-y-0 h-10 px-6 text-sm w-full flex items-center justify-center gap-2 rounded-full">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <div
                                ...
                                <div class="p-6 pt-6 pb-6 px-6">
                                    ...
                                    <div class="mt-4">
                                        <a target="_blank" rel="noopener noreferrer"
                                            href="https://www.instagram.com/p/DSSMfFpj4TE/?utm_source=ig_web_copy_link&amp;igsh=MzRlODBiNWFlZA=="><button
                                                class="whitespace-nowrap font-semibold transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 border-2 border-primary bg-transparent text-primary shadow-sm hover:bg-[#F7F8FA] hover:text-[#2C3340] hover:border-[#2C3340]/30 hover:-translate-y-0.5 active:translate-y-0 h-10 px-6 text-sm w-full flex items-center justify-center gap-2 rounded-full">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <div
                                ...
                                <div class="p-6 pt-6 pb-6 px-6">
                                    ...
                                    <div class="mt-4">
                                        <a target="_blank" rel="noopener noreferrer"
                                            href="https://www.instagram.com/p/DQrWiBPj4Gv/?utm_source=ig_web_copy_link&amp;igsh=MzRlODBiNWFlZA=="><button
                                                class="whitespace-nowrap font-semibold transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 border-2 border-primary bg-transparent text-primary shadow-sm hover:bg-[#F7F8FA] hover:text-[#2C3340] hover:border-[#2C3340]/30 hover:-translate-y-0.5 active:translate-y-0 h-10 px-6 text-sm w-full flex items-center justify-center gap-2 rounded-full">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <div
                                ...
                                <div class="p-6 pt-6 pb-6 px-6">
                                    ...
                                    <div class="mt-4">
                                        <a target="_blank" rel="noopener noreferrer"
                                            href="https://www.instagram.com/p/DQ4LPcZDxBE/?utm_source=ig_web_copy_link&amp;igsh=MzRlODBiNWFlZA=="><button
                                                class="whitespace-nowrap font-semibold transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 border-2 border-primary bg-transparent text-primary shadow-sm hover:bg-[#F7F8FA] hover:text-[#2C3340] hover:border-[#2C3340]/30 hover:-translate-y-0.5 active:translate-y-0 h-10 px-6 text-sm w-full flex items-center justify-center gap-2 rounded-full">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <div
                                ...
                                <div class="p-6 pt-6 pb-6 px-6">
                                    ...
                                    <div class="mt-4">
                                        <a target="_blank" rel="noopener noreferrer"
                                            href="https://www.instagram.com/p/DRPSbc2D3iQ/?utm_source=ig_web_copy_link"><button
                                                class="whitespace-nowrap font-semibold transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 border-2 border-primary bg-transparent text-primary shadow-sm hover:bg-[#F7F8FA] hover:text-[#2C3340] hover:border-[#2C3340]/30 hover:-translate-y-0.5 active:translate-y-0 h-10 px-6 text-sm w-full flex items-center justify-center gap-2 rounded-full">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <div
                                ...
                                <div class="p-6 pt-6 pb-6 px-6">
                                    ...
                                    <div class="mt-4">
                                        <a target="_blank" rel="noopener noreferrer"
                                            href="https://www.instagram.com/p/DRXJG-7j9qA/?utm_source=ig_web_copy_link&amp;igsh=MzRlODBiNWFlZA=="><button
                                                class="whitespace-nowrap font-semibold transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 border-2 border-primary bg-transparent text-primary shadow-sm hover:bg-[#F7F8FA] hover:text-[#2C3340] hover:border-[#2C3340]/30 hover:-translate-y-0.5 active:translate-y-0 h-10 px-6 text-sm w-full flex items-center justify-center gap-2 rounded-full">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <div
                                ...
                                <div class="p-6 pt-6 pb-6 px-6">
                                    ...
                                    <div class="mt-4">
                                        <a target="_blank" rel="noopener noreferrer"
                                            href="https://www.instagram.com/p/DRhoVKOjcmP/?utm_source=ig_web_copy_link&amp;igsh=MzRlODBiNWFlZA=="><button
                                                class="whitespace-nowrap font-semibold transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 border-2 border-primary bg-transparent text-primary shadow-sm hover:bg-[#F7F8FA] hover:text-[#2C3340] hover:border-[#2C3340]/30 hover:-translate-y-0.5 active:translate-y-0 h-10 px-6 text-sm w-full flex items-center justify-center gap-2 rounded-full">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                ...
                <div
                    ...
                    <div class="flex flex-col gap-8 items-center text-center">
                        <div
                            ...
                            <span class="text-white font-medium">Your Success Story Awaits</span>
                        </div>
                        ...
                        <div class="flex flex-col sm:flex-row items-center gap-3">
                            <a href="{{ route('front.jobs') }}"
                                ...
                                Job Openings</a><a href="{{ route('front.tools.eligibility-checker') }}"
