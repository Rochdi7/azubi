...
@section('title', 'Blocked Account Calculator | GoAusbildung')

@section('meta')
    <meta name="description" content="Calculate exact blocked account requirements for your Ausbildung visa application including monthly breakdown and total costs.">
    <meta property="og:title" content="Blocked Account Calculator | GoAusbildung">
    <meta property="og:description" content="Calculate exact blocked account requirements for your Ausbildung visa application including monthly breakdown and total costs.">
@endsection
...
@section('content')
          <main role="main" class="py-8 md:py-12">
            <div class="container px-4 md:px-6 max-w-7xl mx-auto">
                ...
                <div class="grid md:grid-cols-2 gap-6">
                  <div class="space-y-3">
                    <label
                      ...
                      for="provider"
                      >Blocked Account Provider</label
                    ><button
                      type="button"
                      role="combobox"
                  ...
                  <div class="flex gap-4">
                    ...
                    >
                      Calculate Total Costs<svg
                        ...
                        stroke-linecap="round"
                        stroke-linejoin="round"
                        class="lucide lucide-wallet ml-2 h-4 w-4"
                        aria-hidden="true"
                      >
                        <path
              ...
              >
                ...
                <div class="space-y-4">
                  ...
                  >
                    ...
                    >
                      <span class="font-semibold text-foreground pr-4"
                        >What is a blocked account (Sperrkonto) for
                        Germany?</span
                      ><svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                  ...
                  >
                    ...
                    >
                      <span class="font-semibold text-foreground pr-4"
                        >How much money do I need in my blocked account for
                        Ausbildung in 2026?</span
                      ><svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                        height="24"
                  ...
                  >
                    ...
                    >
                      <span class="font-semibold text-foreground pr-4"
                        >When do I need to open my blocked account?</span
                      ><svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                        height="24"
                  ...
                  >
                    ...
                    >
                      <span class="font-semibold text-foreground pr-4"
                        >Which banks offer blocked accounts for Germany?</span
                      ><svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                        height="24"
                  ...
                  >
                    ...
                    >
                      <span class="font-semibold text-foreground pr-4"
                        >What are the total costs for opening a blocked
                        account?</span
                      ><svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                  ...
                  >
                    ...
                    >
                      <span class="font-semibold text-foreground pr-4"
                        >Can I use a blocked account from my home country
                        bank?</span
                      ><svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                  ...
                  >
                    ...
                    >
                      <span class="font-semibold text-foreground pr-4"
                        >How do monthly withdrawals from blocked account
                        work?</span
                      ><svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                  ...
                  >
                    ...
                    >
                      <span class="font-semibold text-foreground pr-4"
                        >What happens to my blocked account money if my visa is
                        rejected?</span
                      ><svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                  ...
                  >
                    ...
                    >
                      <span class="font-semibold text-foreground pr-4"
                        >Do I need a blocked account if I have an Ausbildung
                        contract with stipend?</span
                      ><svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                        height="24"
                  ...
                  >
                    ...
                    >
                      <span class="font-semibold text-foreground pr-4"
                        >Can I top up my blocked account after opening it?</span
                      ><svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                        height="24"
              ...
              <section
                class="bg-beige rounded-2xl border-2 border-border p-8 text-center"
              >
