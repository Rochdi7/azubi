        ...
        <div class="container px-4 md:px-6 max-w-7xl mx-auto">
            ...
            <div class="flex items-start gap-4 md:gap-6">
                <div class="p-3 md:p-4 rounded-xl bg-orange/10 flex-shrink-0" aria-hidden="true">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                        class="lucide lucide-file-text h-8 w-8 md:h-10 md:w-10 text-orange">
            ...
            <div class="space-y-8">
                ...
                <div class="text-card-foreground shadow p-8 rounded-2xl bg-cream border-2 border-beige">
                    <div class="mb-8">
                        ...
                        <p class="text-green/70">Provide your details to generate a comprehensive document checklist
                    ...
                    <div class="space-y-8">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <!-- Nationality -->
                            <div class="space-y-2">
                                <label class="text-sm leading-none text-green font-semibold" for="nationality">Nationality
                                    *</label>
                            ...
                            <!-- Sector -->
                            <div class="space-y-2">
                                <label class="text-sm leading-none text-green font-semibold" for="dc-sector">Ausbildung
                                    Sector *</label>
                                <select id="dc-sector"
                                    class="flex h-12 w-full items-center rounded-lg border border-input bg-white px-4 py-3 text-sm font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary hover:border-primary/50"
                                    required>
                            ...
                            <!-- Education Level -->
                            <div class="space-y-2">
                                <label class="text-sm leading-none text-green font-semibold" for="education">Education Level
                                    *</label>
                                <select id="education"
                                    class="flex h-12 w-full items-center rounded-lg border border-input bg-white px-4 py-3 text-sm font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary hover:border-primary/50"
                                    required>
                            ...
                            <!-- Visa Type -->
                            <div class="space-y-2">
                                <label class="text-sm leading-none text-green font-semibold" for="visaType">Visa Type
                                    *</label>
                                <select id="visaType"
                                    class="flex h-12 w-full items-center rounded-lg border border-input bg-white px-4 py-3 text-sm font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary hover:border-primary/50"
                                    required>
                            ...
                            <!-- Family Status -->
                            <div class="space-y-2">
                                <label class="text-sm leading-none text-green font-semibold" for="familyStatus">Family
                                    Status *</label>
                            ...
                            <!-- Current Location -->
                            <div class="space-y-2">
                                <label class="text-sm leading-none text-green font-semibold" for="location">Current
                                    Location *</label>
                            ...
                            <!-- Budget Range -->
                            <div class="space-y-2">
                                <label class="text-sm leading-none text-green font-semibold" for="budget">Budget Range
                                    *</label>
                                <select id="budget"
                                    class="flex h-12 w-full items-center rounded-lg border border-input bg-white px-4 py-3 text-sm font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary hover:border-primary/50"
                                    required>
                            ...
                            <!-- Desired Start Date -->
                            <div class="space-y-2">
                                <label class="text-sm leading-none text-green font-semibold" for="startDate">Desired Start
                                    Date</label>
                ...
                <div id="checklist-results" class="hidden space-y-6">
                    ...
                    <div class="text-card-foreground shadow p-6 rounded-2xl bg-cream border-2 border-beige">
                        ...
                        <div class="w-full bg-beige rounded-full h-3 mb-4">
                            <div id="checklist-progress-bar" class="bg-green h-3 rounded-full transition-all duration-500"
                                style="width: 0%"></div>
                        </div>
                ...
                <div id="dc-how-it-works">
                    <div class="text-card-foreground shadow p-8 rounded-2xl bg-cream border-2 border-beige">
                        ...
                        <p class="text-green/70 mb-8">Get a complete, personalized checklist of all required documents for
                            your Ausbildung visa application based on your nationality and situation.</p>
                        <div class="grid md:grid-cols-3 gap-6">
                            <div
                                class="flex flex-col items-center text-center p-6 rounded-xl bg-white border-2 border-beige">
                                ...
                                <p class="text-sm text-green/70">Provide your nationality, sector, education level, visa
                            ...
                            <div
                                ...
                                <p class="text-sm text-green/70">Choose your Ausbildung sector and visa type to identify
                            ...
                            <div
                                ...
                                <p class="text-sm text-green/70">Receive a comprehensive checklist with all required
                        ...
                        <div class="space-y-3">
                            <div class="flex items-start gap-3 bg-white border-2 border-beige rounded-xl p-4">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round"
                                    class="lucide lucide-globe w-5 h-5 text-orange flex-shrink-0 mt-0.5">
                                    <circle cx="12" cy="12" r="10"></circle>
                                    <path d="M12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 0-20"></path>
                                    <path d="M2 12h20"></path>
                                </svg>
                                <div>
                                    <h4 class="font-bold text-green text-sm">Nationality</h4>
                                    <p class="text-xs text-green/70">Your country of citizenship</p>
                                </div>
                            </div>
                            <div class="flex items-start gap-3 bg-white border-2 border-beige rounded-xl p-4">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round"
                                    class="lucide lucide-briefcase w-5 h-5 text-orange flex-shrink-0 mt-0.5">
                                    <path d="M16 20V4a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"></path>
                                    <rect width="20" height="14" x="2" y="6" rx="2"></rect>
                                </svg>
                                <div>
                                    <h4 class="font-bold text-green text-sm">Sector</h4>
                                    <p class="text-xs text-green/70">Healthcare, IT, Engineering, Hospitality, etc.</p>
                                </div>
                            </div>
                            <div class="flex items-start gap-3 bg-white border-2 border-beige rounded-xl p-4">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round"
                                    class="lucide lucide-graduation-cap w-5 h-5 text-orange flex-shrink-0 mt-0.5">
                                    <path
                                ...
                                <div>
                                    <h4 class="font-bold text-green text-sm">Education Level</h4>
                                    <p class="text-xs text-green/70">High School, Bachelor's, Master's, PhD, etc.</p>
                                </div>
                            </div>
                            <div class="flex items-start gap-3 bg-white border-2 border-beige rounded-xl p-4">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round"
                                    class="lucide lucide-file-text w-5 h-5 text-orange flex-shrink-0 mt-0.5">
                                    <path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z"></path>
                                    <path d="M14 2v4a2 2 0 0 0 2 2h4"></path>
                                    <path d="M10 9H8"></path>
                                    <path d="M16 13H8"></path>
                                ...
                                <div>
                                    <h4 class="font-bold text-green text-sm">Visa Type</h4>
                                    <p class="text-xs text-green/70">Ausbildung Training Visa, Work Visa, Student Visa,
                                        etc.</p>
                                </div>
                            </div>
                            <div class="flex items-start gap-3 bg-white border-2 border-beige rounded-xl p-4">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round"
                                    class="lucide lucide-users w-5 h-5 text-orange flex-shrink-0 mt-0.5">
                                    <path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"></path>
                                    <circle cx="9" cy="7" r="4"></circle>
                                    <path d="M22 21v-2a4 4 0 0 0-3-3.87"></path>
                                    <path d="M16 3.13a4 4 0 0 1 0 7.75"></path>
                                ...
                                <div>
                                    <h4 class="font-bold text-green text-sm">Family Status</h4>
                                    <p class="text-xs text-green/70">Single, Couple, With Children</p>
                                </div>
                            </div>
                            <div class="flex items-start gap-3 bg-white border-2 border-beige rounded-xl p-4">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round"
                                    class="lucide lucide-map-pin w-5 h-5 text-orange flex-shrink-0 mt-0.5">
                                    <path
                                ...
                                <div>
                                    <h4 class="font-bold text-green text-sm">Current Location</h4>
                                    <p class="text-xs text-green/70">City and country where you currently live</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="space-y-3">
                            <div class="flex items-start gap-3 bg-white border-2 border-beige rounded-xl p-4">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round"
                                    class="lucide lucide-file-check w-5 h-5 text-green flex-shrink-0 mt-0.5">
                                    <path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z"></path>
                                    <path d="M14 2v4a2 2 0 0 0 2 2h4"></path>
                                    <path d="m9 15 2 2 4-4"></path>
                                </svg>
                                <div>
                                    <h4 class="font-bold text-green text-sm">Complete Checklist</h4>
                                    <p class="text-xs text-green/70">All required documents organized by category</p>
                                </div>
                            </div>
                            <div class="flex items-start gap-3 bg-white border-2 border-beige rounded-xl p-4">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round"
                                    class="lucide lucide-globe w-5 h-5 text-green flex-shrink-0 mt-0.5">
                                    <circle cx="12" cy="12" r="10"></circle>
                                    <path d="M12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 0-20"></path>
                                    <path d="M2 12h20"></path>
                                </svg>
                                <div>
                                    <h4 class="font-bold text-green text-sm">Country-Specific Docs</h4>
                                    <p class="text-xs text-green/70">Additional documents required based on your
                                        nationality</p>
                                </div>
                            </div>
                            <div class="flex items-start gap-3 bg-white border-2 border-beige rounded-xl p-4">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round"
                                    class="lucide lucide-calendar w-5 h-5 text-green flex-shrink-0 mt-0.5">
                                    <path d="M8 2v4"></path>
                                    <path d="M16 2v4"></path>
                                ...
                                <div>
                                    <h4 class="font-bold text-green text-sm">Timeline</h4>
                                    <p class="text-xs text-green/70">Estimated time to collect each document</p>
                                </div>
                            </div>
                            <div class="flex items-start gap-3 bg-white border-2 border-beige rounded-xl p-4">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round"
                                    class="lucide lucide-coins w-5 h-5 text-green flex-shrink-0 mt-0.5">
                                ...
                                <div>
                                    <h4 class="font-bold text-green text-sm">Cost Estimates</h4>
                                    <p class="text-xs text-green/70">Approximate costs for obtaining documents</p>
                                </div>
                            </div>
                            <div class="flex items-start gap-3 bg-white border-2 border-beige rounded-xl p-4">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round"
                                    class="lucide lucide-clock w-5 h-5 text-green flex-shrink-0 mt-0.5">
                                    <circle cx="12" cy="12" r="10"></circle>
                                    <polyline points="12 6 12 12 16 14"></polyline>
                                </svg>
                                <div>
                                    <h4 class="font-bold text-green text-sm">Processing Times</h4>
                                    <p class="text-xs text-green/70">Expected processing duration for each document</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-beige/50 border border-beige rounded-xl p-4 text-center">
                    <p class="text-sm text-green/70">Checklists are tailored to your nationality and include
                    ...
                    <div class="divide-y divide-beige">
                        <div class="faq-item">
                            <button
                                ...
                                <span class="font-semibold text-green pr-4">What documents are required for Ausbildung
                                    application?</span>
                            ...
                            <div class="faq-content hidden px-6 pb-6 text-sm text-green/70 leading-relaxed">The core
                                required documents include: valid passport, birth certificate (apostilled), high school
                                ...
                                format, and medical fitness certificate. Additional documents may be required based on your
                        ...
                        <div class="faq-item">
                            <button
                                class="faq-toggle w-full flex items-center justify-between p-6 text-left hover:bg-beige/50 transition-colors"
                                onclick="toggleFaq(this)">
                                <span class="font-semibold text-green pr-4">Do document requirements vary by
                                    nationality?</span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <div class="faq-content hidden px-6 pb-6 text-sm text-green/70 leading-relaxed">Yes, document
                        ...
                        <div class="faq-item">
                            <button
                                class="faq-toggle w-full flex items-center justify-between p-6 text-left hover:bg-beige/50 transition-colors"
                                onclick="toggleFaq(this)">
                                <span class="font-semibold text-green pr-4">What is apostille and which documents need
                                    it?</span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <div class="faq-content hidden px-6 pb-6 text-sm text-green/70 leading-relaxed">An apostille is
                        ...
                        <div class="faq-item">
                            <button
                                class="faq-toggle w-full flex items-center justify-between p-6 text-left hover:bg-beige/50 transition-colors"
                                onclick="toggleFaq(this)">
                                <span class="font-semibold text-green pr-4">Do I need to translate all documents to
                                    German?</span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <div class="faq-content hidden px-6 pb-6 text-sm text-green/70 leading-relaxed">Yes, all
                        ...
                        <div class="faq-item">
                            <button
                                class="faq-toggle w-full flex items-center justify-between p-6 text-left hover:bg-beige/50 transition-colors"
                                onclick="toggleFaq(this)">
                                <span class="font-semibold text-green pr-4">What is the total cost for document
                                    preparation?</span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <div class="faq-content hidden px-6 pb-6 text-sm text-green/70 leading-relaxed">The total cost
                        ...
                        <div class="faq-item">
                            <button
                                class="faq-toggle w-full flex items-center justify-between p-6 text-left hover:bg-beige/50 transition-colors"
                                onclick="toggleFaq(this)">
                                <span class="font-semibold text-green pr-4">How long does it take to collect all
                                    documents?</span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <div class="faq-content hidden px-6 pb-6 text-sm text-green/70 leading-relaxed">The complete
