...
@section('title', 'Ausbildung vs University Comparison | GoAusbildung')

@section('meta')
    <meta name="description" content="Compare Ausbildung (vocational training) vs University education in Germany with personalized analysis and salary projections.">
    <meta property="og:title" content="Ausbildung vs University Comparison | GoAusbildung">
    <meta property="og:description" content="Compare Ausbildung (vocational training) vs University education in Germany with personalized analysis and salary projections.">
@endsection
...
@section('content')
          <main role="main" class="py-8 md:py-12">
            <div class="container px-4 md:px-6 max-w-7xl mx-auto">
              <main role="main">
                <section
                  class="bg-beige border-2 border-border rounded-2xl p-6 mb-8"
                >
                  <div class="flex items-start gap-4">
                    <div class="p-3 bg-[#344F1F] rounded-xl" aria-hidden="true">
                      <svg
                        ...
                        class="lucide lucide-scale h-6 w-6 text-cream"
                      >
                        <path
                ...
                <div class="space-y-4">
                  <div
                    class="bg-white rounded-2xl border-2 border-gray-200 p-8"
                  >
                    <div class="mb-8">
                      <div class="flex justify-between mb-2">
                        <div
                          class="h-2 flex-1 mx-1 rounded-full bg-primary"
                        ></div>
                        <div
                          class="h-2 flex-1 mx-1 rounded-full bg-gray-200"
                        ></div>
                        <div
                          class="h-2 flex-1 mx-1 rounded-full bg-gray-200"
                        ></div>
                    ...
                    <div class="space-y-6">
                      ...
                      <div>
                        ...
                        ><button
                          type="button"
                          role="combobox"
                          aria-controls="radix-«R94l3peslb»"
                          aria-expanded="false"
                      ...
                      <div>
                        ...
                        ><button
                          type="button"
                          role="combobox"
                          aria-controls="radix-«R9kl3peslb»"
                          aria-expanded="false"
                          aria-autocomplete="none"
                          dir="ltr"
                          data-state="closed"
                          ...
                          class="flex h-12 w-full items-center justify-between rounded-lg border border-input bg-white px-4 py-3 text-sm font-medium ring-offset-background placeholder:text-muted-foreground transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary disabled:cursor-not-allowed disabled:opacity-50 hover:border-primary/50 [&amp;&gt;span]:line-clamp-1"
                        >
                          <span style="pointer-events: none">Select field</span
                          ><svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
                            height="24"
                      ...
                      <div>
                        ...
                        ><button
                          type="button"
                          role="combobox"
                          aria-controls="radix-«Ra4l3peslb»"
                          aria-expanded="false"
                          aria-autocomplete="none"
                          dir="ltr"
                          data-state="closed"
                          ...
                          class="flex h-12 w-full items-center justify-between rounded-lg border border-input bg-white px-4 py-3 text-sm font-medium ring-offset-background placeholder:text-muted-foreground transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary disabled:cursor-not-allowed disabled:opacity-50 hover:border-primary/50 [&amp;&gt;span]:line-clamp-1"
                        >
                          <span style="pointer-events: none">Select goal</span
                          ><svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
                            height="24"
                  ...
                  >
                    ...
                    <div class="space-y-4">
                      ...
                      >
                        ...
                        >
                          <span class="font-semibold text-foreground pr-4"
                            ...
                            Ausbildung and University in Germany?</span
                          ><svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
                            height="24"
                        ...
                        >
                          ...
                          >
                            ...
                            (Bachelor + Master) with job search required
                      ...
                      >
                        ...
                        >
                          <span class="font-semibold text-foreground pr-4"
                            >Which pathway is financially better for
                      ...
                      >
                        ...
                        >
                          <span class="font-semibold text-foreground pr-4"
                            >Can I earn money during Ausbildung but not during
                            University?</span
                          ><svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
                      ...
                      >
                        ...
                        >
                          <span class="font-semibold text-foreground pr-4"
                            >Which is faster to employment: Ausbildung or
                            University?</span
                          ><svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
                      ...
                      >
                        ...
                        >
                          <span class="font-semibold text-foreground pr-4"
                            >What are the language requirements and how strict
                            are they?</span
                          ><svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
                        ...
                        >
                          ...
                          >
                            ...
                            during visa interviews. Without the required level,
                      ...
                      >
                        ...
                        >
                          <span class="font-semibold text-foreground pr-4"
                            >Which pathway offers better permanent residency
                            (PR) chances?</span
                          ><svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
                      ...
                      >
                        ...
                        >
                          <span class="font-semibold text-foreground pr-4"
                            >Can I switch from Ausbildung to University or vice
                            versa later?</span
                          ><svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
                      ...
                      >
                        ...
                        >
                          <span class="font-semibold text-foreground pr-4"
                            >Which has better long-term career prospects and
                            salary growth?</span
                          ><svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
                      ...
                      >
                        ...
                        >
                          <span class="font-semibold text-foreground pr-4"
                            >Do employers in Germany value Ausbildung or
                            University degrees more?</span
                          ><svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
                            height="24"
                      ...
                      >
                        ...
                        >
                          <span class="font-semibold text-foreground pr-4"
                            >What is the visa process difference between
                            Ausbildung and University?</span
                          ><svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
                            height="24"
                      ...
                      >
                        ...
                        >
                          <span class="font-semibold text-foreground pr-4"
                            >Which option is better for specific fields like IT,
                            Healthcare, Engineering, or Business?</span
                          ><svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
                            height="24"
                      ...
                      ><div class="mb-4">
                        ...
                        >
                          <svg
                            ...
                            stroke-linecap="round"
                            stroke-linejoin="round"
                            class="lucide lucide-target w-6 h-6 text-orange group-hover:text-white transition-colors"
                          >
                            <circle cx="12" cy="12" r="10"></circle>
                            <circle cx="12" cy="12" r="6"></circle>
                            <circle cx="12" cy="12" r="2"></circle>
                ...
                <div class="container mx-auto px-4 lg:px-6 my-16">
                  <section
                    class="relative py-16 md:py-20 rounded-2xl overflow-hidden shadow-lg mt-12"
                  >
                    <img
                      alt="Background"
                      loading="lazy"
