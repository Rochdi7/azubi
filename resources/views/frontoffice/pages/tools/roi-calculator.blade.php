        ...
        <div class="container px-4 md:px-6 max-w-7xl mx-auto">
            ...
            <div class="text-card-foreground shadow p-6 rounded-2xl border-2 bg-cream border-beige mb-6">
                <div class="flex items-start gap-4">
                    ...
                    <div class="flex-1 space-y-2">
                        ...
                        <p class="text-green/70 text-sm leading-relaxed">Discover the true financial benefits of German
            ...
            <div class="text-card-foreground shadow p-8 rounded-2xl bg-cream border-2 border-beige mb-6">
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    <!-- Sector Select -->
                    <div class="space-y-2">
                        <label class="text-sm leading-none text-green font-semibold" for="sector">Ausbildung Sector
                            *</label>
                        <select id="sector"
                    ...
                    <div class="space-y-2">
                        <label class="text-sm leading-none text-green font-semibold" for="trainingDuration">Training
                        ...
                        <input type="range" id="trainingDuration" min="2" max="3.5" step="0.5"
                            value="3"
                            class="w-full h-2 bg-beige rounded-lg appearance-none cursor-pointer accent-primary">
                    </div>

                    <!-- Initial Investment Slider -->
                    <div class="space-y-2">
                        <label class="text-sm leading-none text-green font-semibold" for="initialCosts">Initial Investment
                            (&euro;)</label>
                    ...
                    <div class="space-y-2">
                        <label class="text-sm leading-none text-green font-semibold" for="monthlyExpenses">Monthly
                            Expenses (&euro;)</label>
                    ...
                    <div class="space-y-2 md:col-span-2">
                        <label class="text-sm leading-none text-green font-semibold" for="germanLevel">Current German
                            Level</label>
            ...
            <div id="how-it-works" class="mb-6">
                <div class="text-card-foreground shadow p-8 rounded-2xl bg-cream border-2 border-beige">
                    ...
                    <p class="text-green/70 mb-8">Calculate your return on investment for Ausbildung vs home country
                    ...
                    <div class="grid md:grid-cols-3 gap-6">
                        <div class="flex flex-col items-center text-center p-6 rounded-xl bg-white border-2 border-beige">
                            ...
                            <p class="text-sm text-green/70">Choose the Ausbildung sector that matches your career goals.
                        ...
                        <div class="flex flex-col items-center text-center p-6 rounded-xl bg-white border-2 border-beige">
                            ...
                            <p class="text-sm text-green/70">Configure your training duration, initial costs, monthly
                        ...
                        <div class="flex flex-col items-center text-center p-6 rounded-xl bg-white border-2 border-beige">
                            ...
                            <p class="text-sm text-green/70">Review your complete financial breakdown including break-even
            ...
            <div class="text-card-foreground shadow rounded-2xl bg-cream border-2 border-beige mb-6 overflow-hidden">
                ...
                <div class="divide-y divide-beige" id="faq-container">
                    <div class="faq-item">
                        ...
                        <div class="faq-content hidden px-6 pb-6 text-sm text-green/70 leading-relaxed">The Ausbildung ROI
                    ...
                    <div class="faq-item">
                        <button
                            class="faq-toggle w-full flex items-center justify-between p-6 text-left hover:bg-beige/50 transition-colors"
                            onclick="toggleFaq(this)">
                            <span class="font-semibold text-green pr-4">How much stipend will I earn during
                                Ausbildung?</span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round"
                        ...
                        <div class="faq-content hidden px-6 pb-6 text-sm text-green/70 leading-relaxed">Ausbildung stipend
                    ...
                    <div class="faq-item">
                        <button
                            class="faq-toggle w-full flex items-center justify-between p-6 text-left hover:bg-beige/50 transition-colors"
                            onclick="toggleFaq(this)">
                            <span class="font-semibold text-green pr-4">What is the typical payback period for Ausbildung
                                investment?</span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round"
                        ...
                        <div class="faq-content hidden px-6 pb-6 text-sm text-green/70 leading-relaxed">The payback period
                    ...
                    <div class="faq-item">
                        <button
                            class="faq-toggle w-full flex items-center justify-between p-6 text-left hover:bg-beige/50 transition-colors"
                            onclick="toggleFaq(this)">
                            <span class="font-semibold text-green pr-4">How does Ausbildung ROI compare to a university
                                degree?</span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round"
                        ...
                        <div class="faq-content hidden px-6 pb-6 text-sm text-green/70 leading-relaxed">Ausbildung
                    ...
                    <div class="faq-item">
                        <button
                            class="faq-toggle w-full flex items-center justify-between p-6 text-left hover:bg-beige/50 transition-colors"
                            onclick="toggleFaq(this)">
                            <span class="font-semibold text-green pr-4">What salary can I expect after completing
                                Ausbildung?</span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round"
                        ...
                        <div class="faq-content hidden px-6 pb-6 text-sm text-green/70 leading-relaxed">Post-Ausbildung
                    ...
                    <div class="faq-item">
                        ...
                        <div class="faq-content hidden px-6 pb-6 text-sm text-green/70 leading-relaxed">You can improve
