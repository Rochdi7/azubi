...
@section('meta')
    ...
    <meta name="keywords" content="ausbildung roi calculator,vocational training germany cost,ausbildung investment,german apprenticeship salary,ausbildung stipend calculator,break even ausbildung">
@endsection
...
@section('content')
        ...
        <div class="container px-4 md:px-6 max-w-7xl mx-auto">
            ...
            <div class="flex items-start gap-4 md:gap-6">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <h1 class="tracking-tight font-bold text-3xl sm:text-4xl md:text-5xl text-secondary mb-3">Ausbildung ROI Calculator</h1>
                    <p class="text-base md:text-lg text-muted-foreground max-w-3xl">Calculate the financial benefits of German vocational training compared to other education options with 5-year projection.</p>
                </div>
            </div>
        </div>
    </header>
    ...
    <main role="main" class="py-8 md:py-12">
        <div class="container px-4 md:px-6 max-w-7xl mx-auto">
            ...
            <!-- Info Banner -->
            <div class="text-card-foreground shadow p-6 rounded-2xl border-2 bg-cream border-beige mb-6">
                <div class="flex items-start gap-4">
                    <div class="p-3 rounded-xl flex-shrink-0 bg-green text-cream">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-calculator h-6 w-6">
                    ...
                    <div class="flex-1 space-y-2">
                        <h2 class="text-xl font-semibold text-green">Calculate Your Ausbildung ROI</h2>
                        <p class="text-green/70 text-sm leading-relaxed">Discover the true financial benefits of German vocational training. This calculator analyzes your total investment, monthly stipend earnings (&euro;850-&euro;1,300), and post-training salary potential to show exactly when you'll break even and your long-term financial gains compared to university education.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="text-card-foreground shadow p-8 rounded-2xl bg-cream border-2 border-beige mb-6">
                <div class="mb-8">
                    <h2 class="text-2xl font-bold text-green mb-2">Enter Your Details</h2>
                </div>
                <div class="grid md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-2">
                        <label class="text-sm leading-none text-green font-semibold" for="trainingDuration">Training Duration (years)</label>
                        <p class="text-sm text-muted-foreground"><span id="duration-display">3</span> years</p>
                        <input type="range" id="trainingDuration" min="2" max="3.5" step="0.5" value="3" class="w-full h-2 bg-beige rounded-lg appearance-none cursor-pointer accent-primary">
                    </div>

                    <!-- Initial Investment Slider -->
                    <div class="space-y-2">
                        <label class="text-sm leading-none text-green font-semibold" for="initialCosts">Initial Investment (&euro;)</label>
                        <p class="text-sm text-muted-foreground">Includes visa costs, flights, setup costs in Germany and language preparation</p>
                        <div class="text-sm text-muted-foreground text-right"><span id="initial-display">14,000</span>&euro;</div>
                        <input type="range" id="initialCosts" min="10000" max="20000" step="1000" value="14000" class="w-full h-2 bg-beige rounded-lg appearance-none cursor-pointer accent-primary">
                    </div>

                    <!-- Monthly Expenses Slider -->
                    <div class="space-y-2">
                        <label class="text-sm leading-none text-green font-semibold" for="monthlyExpenses">Monthly Expenses (&euro;)</label>
                        <p class="text-sm text-muted-foreground">Includes rent, food, transportation, health insurance, etc.</p>
                        <div class="text-sm text-muted-foreground text-right"><span id="expenses-display">750</span>&euro;</div>
                        <input type="range" id="monthlyExpenses" min="600" max="1000" step="50" value="750" class="w-full h-2 bg-beige rounded-lg appearance-none cursor-pointer accent-primary">
                    </div>

                    <!-- German Level Select -->
                    <div class="space-y-2 md:col-span-2">
                        <label class="text-sm leading-none text-green font-semibold" for="germanLevel">Current German Level</label>
                        <p class="text-sm text-muted-foreground">This affects language course costs in your initial investment</p>
                        <select id="germanLevel" class="flex h-12 w-full items-center rounded-lg border border-input bg-white px-4 py-3 text-sm font-medium ring-offset-background transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary hover:border-primary/50">
                ...
                <div class="text-card-foreground shadow p-8 rounded-2xl border-2 bg-cream border-beige mb-6">
                    <div class="mb-6">
                        <div class="flex items-center gap-3 mb-2">
                            ...
                            <h2 class="text-2xl font-bold text-green">Your ROI Analysis</h2>
                        </div>
                    </div>

                    <!-- Mascot -->
                    <div class="flex justify-center mb-8" aria-hidden="true">
                        <img src="{{ asset('assets/_next/mascot_welcomingfad6.jpeg') }}" alt="Young Oak mascot celebrating your ROI results" width="150" height="150" class="animate-float-slow" />
                    </div>

                    <!-- Row 1: 2 cards -->
                    <div class="grid md:grid-cols-2 gap-4 mb-6">
                        <div class="rounded-xl border bg-white p-4 flex items-start gap-3" id="card-investment">
                            <div class="p-2 rounded-lg bg-beige flex-shrink-0">
                        ...
                        <div class="rounded-xl border bg-white p-4 flex items-start gap-3 border-green/20" id="card-stipend">
                            ...
                            <div>
                                ...
                                <p class="text-xl font-bold text-green" id="result-stipend">-</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="grid md:grid-cols-2 gap-4 mb-6">
                        <div class="rounded-xl border bg-white p-4 flex items-start gap-3" id="card-monthly">
                            <div class="p-2 rounded-lg bg-green/10 flex-shrink-0">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-green"><path d="M22 12h-2.48a2 2 0 0 0-1.93 1.46l-2.35 8.36a.25.25 0 0 1-.48 0L9.24 2.18a.25.25 0 0 0-.48 0l-2.35 8.36A2 2 0 0 1 4.49 12H2"></path></svg>
                            </div>
                            <div>
                    ...
                    <div class="grid md:grid-cols-3 gap-4 mb-6">
                        <div class="rounded-xl border bg-white p-4 flex items-start gap-3 border-orange/20">
                            <div class="p-2 rounded-lg bg-orange/10 flex-shrink-0">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-orange"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg>
                            </div>
                            <div>
                                <p class="text-sm text-muted-foreground">Time to ROI</p>
                                <p class="text-xl font-bold text-orange" id="result-time">-</p>
                            </div>
                        </div>
                        <div class="rounded-xl border bg-white p-4 flex items-start gap-3 border-green/20">
                            ...
                            <div>
                                ...
                                <p class="text-xl font-bold text-green" id="result-salary">-</p>
                            </div>
                        </div>
                        <div class="rounded-xl border bg-white p-4 flex items-start gap-3 border-green/20">
                            <div class="p-2 rounded-lg bg-green/10 flex-shrink-0">
                            ...
                            <div>
                                ...
                                <p class="text-xl font-bold text-green" id="result-5year">-</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="text-sm text-muted-foreground p-4 bg-muted rounded-lg flex items-start gap-2">
                        ...
                        <p>These calculations are estimates based on average values. Actual figures may vary based on location, company, and personal circumstances.</p>
                    </div>
                </div>
            </div>
            ...
            <div id="how-it-works" class="mb-6">
                <div class="text-card-foreground shadow p-8 rounded-2xl bg-cream border-2 border-beige">
                    <h2 class="text-2xl font-bold text-green mb-2">How to Use the ROI Calculator</h2>
                    <p class="text-green/70 mb-8">Calculate your return on investment for Ausbildung vs home country career. Compare earnings, costs, and long-term financial benefits.</p>
                    <div class="grid md:grid-cols-3 gap-6">
                        <div class="flex flex-col items-center text-center p-6 rounded-xl bg-white border-2 border-beige">
                            ...
                            <h3 class="font-bold text-green mb-2">Select Your Sector</h3>
                            <p class="text-sm text-green/70">Choose the Ausbildung sector that matches your career goals. Different sectors offer different stipend ranges and post-training salaries.</p>
                        </div>
                        <div class="flex flex-col items-center text-center p-6 rounded-xl bg-white border-2 border-beige">
                            <div class="p-3 rounded-xl bg-green/10 mb-4">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="h-6 w-6 text-green"><path d="M12 20h9"></path><path d="M16.376 3.622a1 1 0 0 1 3.002 3.002L7.368 18.635a2 2 0 0 1-.855.506l-2.872.838a.5.5 0 0 1-.62-.62l.838-2.872a2 2 0 0 1 .506-.854z"></path></svg>
                            </div>
                            <h3 class="font-bold text-green mb-2">Enter Your Details</h3>
                            <p class="text-sm text-green/70">Configure your training duration, initial costs, monthly expenses, and current German level to get personalized calculations.</p>
                        </div>
                        <div class="flex flex-col items-center text-center p-6 rounded-xl bg-white border-2 border-beige">
                            <div class="p-3 rounded-xl bg-green/10 mb-4">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="h-6 w-6 text-green"><rect width="16" height="20" x="4" y="2" rx="2"></rect><line x1="8" x2="16" y1="6" y2="6"></line><line x1="16" x2="16" y1="14" y2="18"></line><path d="M16 10h.01"></path><path d="M12 10h.01"></path><path d="M8 10h.01"></path><path d="M12 14h.01"></path><path d="M8 14h.01"></path><path d="M12 18h.01"></path><path d="M8 18h.01"></path></svg>
                            </div>
                            <h3 class="font-bold text-green mb-2">Compare ROI Results</h3>
                            <p class="text-sm text-green/70">Review your complete financial breakdown including break-even point, 5-year earnings projection, and monthly balance during training.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="divide-y divide-beige" id="faq-container">
                    <div class="faq-item">
                        <button class="faq-toggle w-full flex items-center justify-between p-6 text-left hover:bg-beige/50 transition-colors" onclick="toggleFaq(this)">
                            <span class="font-semibold text-green pr-4">What is the Ausbildung ROI Calculator?</span>
                        ...
                        <div class="faq-content hidden px-6 pb-6 text-sm text-green/70 leading-relaxed">The Ausbildung ROI Calculator is a free financial planning tool that helps you calculate the Return on Investment (ROI) for German vocational training programs. It analyzes total costs (blocked account, living expenses, insurance, visa fees), training stipend earnings (typically &euro;850-&euro;1,300/month), and post-training salary potential to determine how quickly your investment pays back and your long-term financial gains.</div>
                    </div>
                    <div class="faq-item">
                        <button class="faq-toggle w-full flex items-center justify-between p-6 text-left hover:bg-beige/50 transition-colors" onclick="toggleFaq(this)">
                            <span class="font-semibold text-green pr-4">How much stipend will I earn during Ausbildung?</span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="faq-chevron text-muted-foreground flex-shrink-0 transition-transform duration-200"><path d="m6 9 6 6 6-6"></path></svg>
                        </button>
                        <div class="faq-content hidden px-6 pb-6 text-sm text-green/70 leading-relaxed">Ausbildung stipend (training salary) varies by sector and training year: Year 1: &euro;850-&euro;1,050/month, Year 2: &euro;950-&euro;1,150/month, Year 3: &euro;1,050-&euro;1,300/month. Healthcare and IT sectors typically offer higher stipends (&euro;1,100-&euro;1,300 in Year 3), while hospitality may be lower (&euro;850-&euro;1,000). Total earnings over 3 years typically range from &euro;33,000 to &euro;42,000.</div>
                    </div>
                    <div class="faq-item">
                        <button class="faq-toggle w-full flex items-center justify-between p-6 text-left hover:bg-beige/50 transition-colors" onclick="toggleFaq(this)">
                            <span class="font-semibold text-green pr-4">What is the typical payback period for Ausbildung investment?</span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="faq-chevron text-muted-foreground flex-shrink-0 transition-transform duration-200"><path d="m6 9 6 6 6-6"></path></svg>
                        </button>
                        <div class="faq-content hidden px-6 pb-6 text-sm text-green/70 leading-relaxed">The payback period typically ranges from 1-3 years after completing Ausbildung. For example, if you invest &euro;25,000 total and earn a post-training salary of &euro;3,000/month (&euro;36,000/year), with living costs of &euro;1,000/month (&euro;12,000/year), your annual savings are &euro;24,000. Minus the &euro;33,000-&euro;42,000 you already earned during training, you often break even within 1-2 years post-graduation.</div>
                    </div>
                    <div class="faq-item">
                        <button class="faq-toggle w-full flex items-center justify-between p-6 text-left hover:bg-beige/50 transition-colors" onclick="toggleFaq(this)">
                            <span class="font-semibold text-green pr-4">How does Ausbildung ROI compare to a university degree?</span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="faq-chevron text-muted-foreground flex-shrink-0 transition-transform duration-200"><path d="m6 9 6 6 6-6"></path></svg>
                        </button>
                        <div class="faq-content hidden px-6 pb-6 text-sm text-green/70 leading-relaxed">Ausbildung typically offers better short-term ROI than university: Ausbildung: 3 years, earn &euro;33,000-&euro;42,000 during training, start work immediately, break even in 1-3 years. University: 3-4 years, no earnings (or minimal part-time), higher total costs (&euro;30,000-&euro;60,000), break even in 4-7 years. However, university may offer higher long-term earnings in some fields.</div>
                    </div>
                    <div class="faq-item">
                        <button class="faq-toggle w-full flex items-center justify-between p-6 text-left hover:bg-beige/50 transition-colors" onclick="toggleFaq(this)">
                            <span class="font-semibold text-green pr-4">What salary can I expect after completing Ausbildung?</span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="faq-chevron text-muted-foreground flex-shrink-0 transition-transform duration-200"><path d="m6 9 6 6 6-6"></path></svg>
                        </button>
                        <div class="faq-content hidden px-6 pb-6 text-sm text-green/70 leading-relaxed">Post-Ausbildung salaries vary by sector: Healthcare (Nursing): &euro;2,800-&euro;3,500/month, IT & Technology: &euro;3,000-&euro;4,000/month, Engineering: &euro;2,800-&euro;3,800/month, Business Administration: &euro;2,500-&euro;3,200/month, Hospitality: &euro;2,200-&euro;2,800/month. With experience (5-10 years), salaries can increase to &euro;3,500-&euro;5,500/month.</div>
                    </div>
                    <div class="faq-item">
                        <button class="faq-toggle w-full flex items-center justify-between p-6 text-left hover:bg-beige/50 transition-colors" onclick="toggleFaq(this)">
                            <span class="font-semibold text-green pr-4">What factors can improve my Ausbildung ROI?</span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="faq-chevron text-muted-foreground flex-shrink-0 transition-transform duration-200"><path d="m6 9 6 6 6-6"></path></svg>
                        </button>
                        <div class="faq-content hidden px-6 pb-6 text-sm text-green/70 leading-relaxed">You can improve your ROI by: (1) Choosing high-paying sectors (Healthcare, IT, Engineering), (2) Living in affordable cities (Leipzig, Dresden vs Munich, Frankfurt), (3) Securing scholarships or company sponsorships, (4) Working part-time (up to 20 hours/week) during training, (5) Minimizing initial costs (shared housing, used furniture), (6) Completing language training in home country (cheaper than in Germany), (7) Negotiating higher starting salary after training completion.</div>
                    </div>
                </div>
            </div>
