...
@section('title', 'Language Proficiency Calculator | GoAusbildung')

@section('meta')
    <meta name="description" content="Interactive assessment to determine your current German language level (A1-C2) with personalized recommendations for Ausbildung preparation.">
    <meta property="og:title" content="Language Proficiency Calculator | GoAusbildung">
    <meta property="og:description" content="Interactive assessment to determine your current German language level (A1-C2) with personalized recommendations for Ausbildung preparation.">
@endsection
...
@section('content')
          <main role="main" class="py-8 md:py-12">
            <div class="container px-4 md:px-6 max-w-7xl mx-auto">
              <div
                class="text-card-foreground shadow p-6 rounded-2xl border-2 bg-beige border-orange"
              >
                <div class="flex items-start gap-4">
                  <div
                    class="p-3 rounded-xl flex-shrink-0 bg-orange text-white"
                  >
                    <svg
              ...
              >
                ...
                <div class="grid md:grid-cols-2 gap-6">
                  <div class="space-y-2" data-error="false">
                    ...
                    ><button
                      type="button"
                      role="combobox"
                      aria-controls="radix-«R4b53peslb»"
                      aria-expanded="false"
                  ...
                  <div class="space-y-2" data-error="false">
                    <label
                      class="text-sm leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 text-green font-semibold"
                      >Target German Level<!-- --> </label
                    ><button
                      type="button"
                      role="combobox"
                      aria-controls="radix-«R4j53peslb»"
                      aria-expanded="false"
                      aria-autocomplete="none"
                      dir="ltr"
                      data-state="closed"
                  ...
                  <div class="space-y-2" data-error="false">
                    ...
                    ><button
                      type="button"
                      role="combobox"
                      aria-controls="radix-«R5353peslb»"
                      aria-expanded="false"
                      aria-autocomplete="none"
                      dir="ltr"
                      data-state="closed"
                  ...
                  <div class="md:col-span-2">
                    <div class="space-y-2" data-error="false">
                      <label
                        class="text-sm leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 text-green font-semibold"
                        >Target Ausbildung Sector<!-- --> </label
                      ><button
                        type="button"
                        role="combobox"
                        aria-controls="radix-«Rlb53peslb»"
                        aria-expanded="false"
                        aria-autocomplete="none"
                        dir="ltr"
                        data-state="closed"
                      ...
                      ></select>
                      <div
                        class="flex items-center gap-2 text-xs text-gray-600 bg-cream rounded-lg p-3 mt-2"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="24"
                          ...
                          stroke-linecap="round"
                          stroke-linejoin="round"
                          class="lucide lucide-target h-4 w-4 text-orange"
                          aria-hidden="true"
                        >
                          <circle cx="12" cy="12" r="10"></circle>
                        ...
                        ><span
                          ><strong>Requirement:</strong> Minimum
                          <strong>A2</strong>, Recommended
                          <strong class="text-orange">B1</strong></span
                        >
                      </div>
                    </div>
                  </div>
                ...
                <div class="space-y-4">
                  <div class="flex gap-4">
                    ...
                    >
                      Calculate Learning Timeline<svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                        height="24"
                        viewBox="0 0 24 24"
                        ...
                        stroke-linecap="round"
                        stroke-linejoin="round"
                        class="lucide lucide-languages ml-2 h-4 w-4"
                        aria-hidden="true"
                      >
                        ...
                        <div class="flex items-start gap-3">
                          <div class="p-2 bg-beige rounded-lg flex-shrink-0">
                            <svg
                              ...
                              stroke-linecap="round"
                              stroke-linejoin="round"
                              class="lucide lucide-book-open w-5 h-5 text-orange"
                            >
                        ...
                        <div class="flex items-start gap-3">
                          <div class="p-2 bg-beige rounded-lg flex-shrink-0">
                            <svg
                              ...
                              stroke-linecap="round"
                              stroke-linejoin="round"
                              class="lucide lucide-book-open w-5 h-5 text-green"
                            >
                              <path d="M12 7v14"></path>
                              <path
                                d="M3 18a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h5a4 4 0 0 1 4 4 4 4 0 0 1 4-4h5a1 1 0 0 1 1 1v13a1 1 0 0 1-1 1h-6a3 3 0 0 0-3 3 3 3 0 0 0-3-3z"
                      ...
                      >
                        <div class="flex items-start gap-3">
                          ...
                          <div class="flex-1">
                            ...
                            <p class="text-sm text-green/70">
                              Total hours required and sector fit assessment
                            </p>
                          </div>
                        </div>
                      </div>
              ...
              >
                ...
                <div class="space-y-4">
                  ...
                  >
                    ...
                    >
                      <span class="font-semibold text-foreground pr-4"
                        >What German language level do I need for Ausbildung in
                        Germany?</span
                      ><svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                  ...
                  >
                    ...
                    >
                      <span class="font-semibold text-foreground pr-4"
                        >How long does it take to learn German from A1 to
                        B2?</span
                      ><svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                  ...
                  >
                    ...
                    >
                      <span class="font-semibold text-foreground pr-4"
                        >Can I start my Ausbildung with A2 German level?</span
                      ><svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                        height="24"
                  ...
                  >
                    ...
                    >
                      <span class="font-semibold text-foreground pr-4"
                        >What are the CEFR levels (A1, A2, B1, B2, C1,
                        C2)?</span
                      ><svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                  ...
                  >
                    ...
                    >
                      <span class="font-semibold text-foreground pr-4"
                        >How much does German language learning cost?</span
                      ><svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                        height="24"
                  ...
                  >
                    ...
                    >
                      <span class="font-semibold text-foreground pr-4"
                        >Is Goethe-Zertifikat required for Ausbildung
                        visa?</span
                      ><svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                    ...
                    >
                      ...
                      >
                        ...
                        recommended and often required by employers and visa
                  ...
                  >
                    ...
                    >
                      <span class="font-semibold text-foreground pr-4"
                        >Can I learn German while working during
                        Ausbildung?</span
                      ><svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                  ...
                  >
                    ...
                    >
                      <span class="font-semibold text-foreground pr-4"
                        >What is the fastest way to learn German for
                        Ausbildung?</span
                      ><svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                  ...
                  >
                    ...
                    >
                      <span class="font-semibold text-foreground pr-4"
                        >Do I need to know German before applying for
                        Ausbildung?</span
                      ><svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                  ...
                  >
                    ...
                    >
                      <span class="font-semibold text-foreground pr-4"
                        >How is German proficiency tested for Ausbildung
                        applications?</span
                      ><svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                    ...
                    ><div class="mb-4">
                      ...
                      >
                        <svg
                          ...
                          stroke-linecap="round"
                          stroke-linejoin="round"
                          class="lucide lucide-circle-check-big w-6 h-6 text-orange group-hover:text-white transition-colors"
                        >
                          <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                          <path d="m9 11 3 3L22 4"></path>
                        </svg>
