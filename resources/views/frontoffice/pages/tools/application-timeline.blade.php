...
@section('title', 'Application Timeline Planner | GoAusbildung')

@section('meta')
    <meta name="description" content="Calculate realistic timelines based on nationality, German level, and sector. Get AI-powered strategic guidance with month-by-month action plans.">
    <meta property="og:title" content="Application Timeline Planner | GoAusbildung">
    <meta property="og:description" content="Calculate realistic timelines based on nationality, German level, and sector. Get AI-powered strategic guidance with month-by-month action plans.">
@endsection
                      ...
                      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-2" data-error="false">
                          <label
                            ...
                            for="startDate"
                            >When will you start preparing?<!-- --> </label
                          ><input
                            type="date"
                        ...
                        <div class="space-y-2" data-error="false">
                          ...
                          >
                            <span style="pointer-events: none"
                              >Select your current level</span
                            ><svg
                        ...
                        <div class="space-y-2" data-error="false">
                          <label
                            class="text-sm leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 text-green font-semibold"
                            for="urgency"
                            >Timeline Urgency<!-- --> </label
                          ><button
                            type="button"
                            role="combobox"
                            aria-controls="radix-«Ra333peslb»"
                            aria-expanded="false"
                            aria-autocomplete="none"
                            dir="ltr"
                            data-state="closed"
                        ...
                        <div class="space-y-2" data-error="false">
                          <label
                            class="text-sm leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 text-green font-semibold"
                            for="weeklyHours"
                            >Weekly Hours for Preparation<!-- --> </label
                          ><input
                            type="number"
                            class="flex h-10 w-full border bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:cursor-not-allowed disabled:opacity-50 rounded-xl border-beige"
                            id="weeklyHours"
                        ...
                        <div class="space-y-2" data-error="false">
                          <label
                            class="text-sm leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 text-green font-semibold"
                            for="financialSituation"
                            >Financial Situation<!-- -->
                            <!-- -->*</label
                          ><button
                            type="button"
                            role="combobox"
                            aria-controls="radix-«Raj33peslb»"
                            aria-expanded="false"
                            aria-autocomplete="none"
                            dir="ltr"
                            data-state="closed"
                          ...
                          >
                            <span style="pointer-events: none"
                              >Select financial situation</span
                            ><svg
                              xmlns="http://www.w3.org/2000/svg"
                              width="24"
                              height="24"
                    ...
                    <div class="flex items-start gap-4">
                      ...
                      <div class="flex-1">
                        ...
                        <p class="text-green/70">
                          ...
                          application process. Track deadlines, required
                        ...
                        >
                          <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1">
                              ...
                              <p class="text-sm text-green/70">
                                When to prepare each required document
                              </p>
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="flex items-start gap-3">
                            <div class="p-2 bg-beige rounded-lg flex-shrink-0">
                              <svg
                                ...
                                stroke-linecap="round"
                                stroke-linejoin="round"
                                class="lucide lucide-languages w-5 h-5 text-green"
                              >
                                <path d="m5 8 6 6"></path>
                                <path d="m4 14 6-6 2-3"></path>
                                <path d="M2 5h12"></path>
                          ...
                          <div class="flex items-start gap-3">
                            <div class="p-2 bg-beige rounded-lg flex-shrink-0">
                              <svg
                                ...
                                stroke-linecap="round"
                                stroke-linejoin="round"
                                class="lucide lucide-circle-check w-5 h-5 text-green"
                              >
                                <circle cx="12" cy="12" r="10"></circle>
                  ...
                  >
                    ...
                    <div class="space-y-4">
                      ...
                      >
                        ...
                        >
                          <span class="font-semibold text-foreground pr-4"
                            >How accurate is the Application Timeline
                            Planner?</span
                          ><svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
                      ...
                      >
                        ...
                        >
                          <span class="font-semibold text-foreground pr-4"
                            >Can I really learn German while preparing documents
                      ...
                      >
                        ...
                        >
                          <span class="font-semibold text-foreground pr-4"
                            >What if I get my Ausbildung contract earlier than
                            expected?</span
                          ><svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
                      ...
                      >
                        ...
                        >
                          <span class="font-semibold text-foreground pr-4"
                            >Why does my nationality affect the visa processing
                            time?</span
                          ><svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
                      ...
                      >
                        ...
                        >
                          <span class="font-semibold text-foreground pr-4"
                            >Can the AI Strategic Guidance help if I am behind
                            schedule?</span
                          ><svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
                      ...
                      >
                        ...
                        >
                          <span class="font-semibold text-foreground pr-4"
                            >What happens if I miss the intake deadline I am
                            planning for?</span
                          ><svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
