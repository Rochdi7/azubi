...
@section('title', 'Daily Life as Ausbildung Trainee: Schedule, School & Social Life | GoAusbildung')

@section('meta')
    <meta name="description" content="What to expect during Ausbildung: typical 8am-5pm work schedule, 1-2 days/week vocational school, weekends off, and social life in Germany. Real trainee experiences." />
    <meta name="keywords" content="ausbildung daily life,ausbildung schedule,berufsschule,vocational school germany,ausbildung work life balance,life in germany trainee" />
    <meta property="og:title" content="Daily Life as Ausbildung Trainee: Schedule, School &amp; Social Life" />
    <meta property="og:description" content="What to expect during Ausbildung: typical 8am-5pm work schedule, 1-2 days/week vocational school, weekends off, and social life in Germany. Real trainee experiences." />
    <meta property="og:image" content="https://images.goausbildung.com/og-images/daily-life.png" />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:title" content="Daily Life as Ausbildung Trainee: Schedule, School &amp; Social Life" />
    <meta name="twitter:description" content="What to expect during Ausbildung: typical 8am-5pm work schedule, 1-2 days/week vocational school, weekends off, and social life in Germany. Real trainee experiences." />
...
<div class="flex flex-col">
          ...
          >
            <img
              alt="Rhine Valley in autumn - scenic German river landscape with vineyards representing daily life culture"
              loading="eager"
              decoding="async"
              data-nimg="fill"
                  ...
                  <a
                    ...
                    ><span aria-hidden="true"
                      ...
                      >
                        ...
                        ></path></svg></span
                    ><span>Explore Training Programs</span></a
                  ><a
                    ...
                    ><span>View Schedule Details</span></a
                  >
                </nav>
              </div>
            </div>
          ...
          <section id="typical-schedule" class="py-16">
            <div class="container px-4 md:px-6">
              ...
              <div class="grid md:grid-cols-2 gap-10 items-center">
                ...
                >
                  <img
                    alt="Ausbildung student checking schedule"
                    loading="lazy"
                    decoding="async"
                    data-nimg="fill"
                    class="object-cover"
                    ...
                    "
                    sizes="100vw"
                    src="{{ asset('assets/_next/daily-schedule859b.jpeg') }}"
                  />
                  <div
                ...
                <div>
                  ...
                  <div class="space-y-4 mb-6">
                    <div
                      class="p-4 bg-card border border-primary/10 rounded-lg"
                    >
                      <h4
                      ...
                      <div class="grid grid-cols-7 gap-1.5 text-xs">
                        <div
                          class="p-1.5 bg-background rounded border border-border text-center font-medium"
                        >
                          Mon
                        </div>
                        <div
                ...
                >
                  <div class="p-6">
                    ...
                    <div class="space-y-4">
                      <div>
                        <h4
                          class="tracking-tight font-semibold sm:text-base text-secondary text-sm mb-1"
                        >
                      ...
                      <div>
                        ...
                        <ul class="space-y-1">
                          ...
                          >
                            ...
                            ><span
                              >Rotation through different departments (based on
                              training plan)</span
                            >
                          </li>
                          <li
                          ...
                          >
                            ...
                            >
                              ...
                              <path d="m9 11 3 3L22 4"></path></svg
                            ><span
                              >Assigned tasks under supervision of experienced
                              colleagues</span
                            >
                          </li>
                          <li
                          ...
                          >
                            ...
                            >
                              ...
                              <path d="m9 11 3 3L22 4"></path></svg
                            ><span
                              >Regular meetings with your training
                              supervisor</span
                            >
                          </li>
                          <li
                          ...
                          >
                            ...
                            >
                              ...
                              <path d="m9 11 3 3L22 4"></path></svg
                            ><span
                              >Documentation of tasks in your training report
                              book</span
                            >
                          </li>
                          <li
                          ...
                          >
                            ...
                            >
                              ...
                              <path d="m9 11 3 3L22 4"></path></svg
                            ><span
                              >Increasing responsibility as your skills
                              develop</span
                            >
                          </li>
                        </ul>
                        ...
                        <ul class="space-y-1">
                          ...
                          >
                            ...
                            >
                              ...
                              <path d="m9 11 3 3L22 4"></path></svg
                            ><span
                              >Profession-specific theoretical knowledge</span
                            >
                          </li>
                          <li
                            class="flex items-start gap-2 text-sm text-muted-foreground"
                          >
                            ...
                            >
                              <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                              <path d="m9 11 3 3L22 4"></path></svg
                            ><span>German language and communication</span>
                          </li>
                          <li
                            class="flex items-start gap-2 text-sm text-muted-foreground"
                          >
                            ...
                            >
                              <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                              <path d="m9 11 3 3L22 4"></path></svg
                            ><span>Economics and social studies</span>
                          </li>
                          <li
                            class="flex items-start gap-2 text-sm text-muted-foreground"
                          >
                            ...
                            >
                              <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                              <path d="m9 11 3 3L22 4"></path></svg
                            ><span>Mathematics and natural sciences</span>
                          </li>
                          <li
                            class="flex items-start gap-2 text-sm text-muted-foreground"
                          >
                            ...
                            >
                              <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                              <path d="m9 11 3 3L22 4"></path></svg
                            ><span>Field-specific IT and digitalization</span>
                          </li>
                        </ul>
                      </div>
                    </div>
              ...
              <div
                class="mt-12 p-6 bg-card border border-primary/10 rounded-xl max-w-3xl mx-auto"
              >
                <h3
                ...
                >
                  <svg
                    ...
                    stroke-linecap="round"
                    stroke-linejoin="round"
                    class="lucide lucide-pen-tool h-5 w-5 text-primary"
                  >
                    <path
            ...
            <div class="container px-4 md:px-6">
              ...
              <div class="grid gap-8 md:grid-cols-3">
                ...
                >
                  <div class="p-6">
                    <div
                      class="bg-card w-12 h-12 rounded-lg flex items-center justify-center mb-4"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                  ...
                  <div class="p-6">
                    ...
                    <ul class="space-y-2">
                      ...
                      <li class="flex items-start gap-2">
                        ...
                        <div>
                          <span class="text-sm font-medium"
                            >Connect theory to practice</span
                          >
                          <p class="text-xs text-muted-foreground">
              ...
              >
                ...
                >
                  ...
                  ><span>Handling Workload Throughout Your Ausbildung</span>
                </h3>
                <p class="text-muted-foreground mb-4">
                ...
                <div
                  class="mt-5 p-3 bg-background rounded-lg border border-border text-sm text-muted-foreground"
                >
          ...
          <section class="py-16">
            <div class="container px-4 md:px-6">
              ...
              <div class="grid md:grid-cols-2 gap-10 items-center">
                ...
                >
                  <img
                    alt="International students socializing in Germany"
                    loading="lazy"
                    decoding="async"
                    data-nimg="fill"
                    class="object-cover"
                    ...
                    "
                    sizes="100vw"
                    src="{{ asset('assets/_next/student-socialfe90.jpeg') }}"
                  />
                  <div
                    class="absolute bottom-0 left-0 right-0 bg-secondary/95 p-4"
                  >
                ...
                <div>
                  ...
                  <div class="space-y-4">
                    <div
                      class="p-4 bg-card border border-secondary/10 rounded-lg"
                    >
                      <h4
                      ...
                      <ul class="space-y-2">
                        ...
                        <li class="flex items-start gap-2">
                          ...
                          <div>
                            <span class="text-sm font-medium"
                              >Vocational School Classmates</span
                            >
                            <p class="text-xs text-muted-foreground">
                  ...
                  <div class="p-6">
                    ...
                    <div class="space-y-3">
                      <div class="flex items-start gap-2">
                        ...
                        <div>
                          <span class="text-sm font-medium"
                            >Join sports clubs and hobby groups</span
                          >
                          <p class="text-xs text-muted-foreground">
                      ...
                      <div class="flex items-start gap-2">
                        ...
                        <div>
                          <span class="text-sm font-medium"
                            >Participate in company events</span
                          >
                          <p class="text-xs text-muted-foreground">
                      ...
                      <div class="flex items-start gap-2">
                        ...
                        <div>
                          <span class="text-sm font-medium"
                            >Understand cultural differences</span
                          >
                          <p class="text-xs text-muted-foreground">
                      ...
                      <div class="flex items-start gap-2">
                        ...
                        <div>
                          <span class="text-sm font-medium"
                            >Respect personal boundaries</span
                          >
                          <p class="text-xs text-muted-foreground">
                  ...
                  <div class="p-6">
                    ...
                    <div class="space-y-3">
                      ...
                      <div class="flex items-start gap-2">
                        ...
                        <div>
                          <span class="text-sm font-medium"
                            >Language exchange partners</span
                          >
                          <p class="text-xs text-muted-foreground">
                      ...
                      <div class="flex items-start gap-2">
                        ...
                        <div>
                          <span class="text-sm font-medium"
                            >Local events and activities</span
                          >
                          <p class="text-xs text-muted-foreground">
              ...
              <div
                class="mt-12 p-6 bg-card border border-secondary/10 rounded-xl max-w-3xl mx-auto"
              >
                <h3
                  class="tracking-tight font-semibold sm:text-lg text-secondary text-lg mb-3 flex items-center gap-2"
                >
                  <svg
                    ...
                    stroke-linecap="round"
                    stroke-linejoin="round"
                    class="lucide lucide-map h-5 w-5 text-secondary"
                  >
                    <path
                      d="M14.106 5.553a2 2 0 0 0 1.788 0l3.659-1.83A1 1 0 0 1 21 4.619v12.764a1 1 0 0 1-.553.894l-4.553 2.277a2 2 0 0 1-1.788 0l-4.212-2.106a2 2 0 0 0-1.788 0l-3.659 1.83A1 1 0 0 1 3 19.381V6.618a1 1 0 0 1 .553-.894l4.553-2.277a2 2 0 0 1 1.788 0z"
                    ></path>
                    <path d="M15 5.764v15"></path>
                    <path d="M9 3.236v15"></path></svg
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                        <path d="m9 11 3 3L22 4"></path></svg
                      ><span>Explore Local Traditions</span>
                    </h4>
                    <p class="text-xs text-muted-foreground">
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                        <path d="m9 11 3 3L22 4"></path></svg
                      ><span>Understand Workplace Culture</span>
                    </h4>
                    <p class="text-xs text-muted-foreground">
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                        <path d="m9 11 3 3L22 4"></path></svg
                      ><span>Engage with Local History</span>
                    </h4>
                    <p class="text-xs text-muted-foreground">
                    ...
                    <ul class="space-y-2">
                      <li class="flex items-start gap-2">
                        ...
                        >
                          ...
                          <path d="m9 11 3 3L22 4"></path></svg
                        ><span class="text-sm"
                          >Designated training supervisors at companies</span
                        >
                      </li>
                      <li class="flex items-start gap-2">
                        <svg
                        ...
                        >
                          ...
                          <path d="m9 11 3 3L22 4"></path></svg
                        ><span class="text-sm"
                          >Peer mentoring from advanced trainees</span
                        >
                      </li>
                      <li class="flex items-start gap-2">
                        <svg
                        ...
                        >
                          ...
                          <path d="m9 11 3 3L22 4"></path></svg
                        ><span class="text-sm"
                          >Regular feedback sessions and check-ins</span
                        >
                      </li>
                      <li class="flex items-start gap-2">
                        <svg
                        ...
                        >
                          ...
                          <path d="m9 11 3 3L22 4"></path></svg
                        ><span class="text-sm"
                          >Professional development guidance</span
                        >
                      </li>
                    </ul>
                  </div>
                    ...
                    <ul class="space-y-2">
                      <li class="flex items-start gap-2">
                        ...
                        >
                          ...
                          <path d="m9 11 3 3L22 4"></path></svg
                        ><span class="text-sm"
                          >Student councils (Schülervertretung)</span
                        >
                      </li>
                      <li class="flex items-start gap-2">
                        <svg
                        ...
                        >
                          ...
                          <path d="m9 11 3 3L22 4"></path></svg
                        ><span class="text-sm"
                          >Field-specific student associations</span
                        >
                      </li>
                      <li class="flex items-start gap-2">
                        <svg
                        ...
                        >
                          ...
                          <path d="m9 11 3 3L22 4"></path></svg
                        ><span class="text-sm"
                          >Study groups and peer tutoring</span
                        >
                      </li>
                      <li class="flex items-start gap-2">
                        <svg
                        ...
                        >
                          ...
                          <path d="m9 11 3 3L22 4"></path></svg
                        ><span class="text-sm"
                          >Social events and networking opportunities</span
                        >
                      </li>
                    </ul>
                  </div>
                    ...
                    <ul class="space-y-2">
                      <li class="flex items-start gap-2">
                        ...
                        >
                          ...
                          <path d="m9 11 3 3L22 4"></path></svg
                        ><span class="text-sm"
                          >International student associations</span
                        >
                      </li>
                      <li class="flex items-start gap-2">
                        <svg
                        ...
                        >
                          <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                          <path d="m9 11 3 3L22 4"></path></svg
                        ><span class="text-sm">Cultural exchange programs</span>
                      </li>
                      <li class="flex items-start gap-2">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                        ...
                        >
                          ...
                          <path d="m9 11 3 3L22 4"></path></svg
                        ><span class="text-sm"
                          >Regional expatriate communities</span
                        >
                      </li>
                      <li class="flex items-start gap-2">
                        <svg
                        ...
                        >
                          ...
                          <path d="m9 11 3 3L22 4"></path></svg
                        ><span class="text-sm"
                          >Social media groups for internationals</span
                        >
                      </li>
                    </ul>
                  </div>
                    ...
                    <ul class="space-y-2">
                      <li class="flex items-start gap-2">
                        ...
                        >
                          ...
                          <path d="m9 11 3 3L22 4"></path></svg
                        ><span class="text-sm"
                          >Academic advisors at vocational schools</span
                        >
                      </li>
                      <li class="flex items-start gap-2">
                        <svg
                        ...
                        >
                          ...
                          <path d="m9 11 3 3L22 4"></path></svg
                        ><span class="text-sm"
                          >Company HR support services</span
                        >
                      </li>
                      <li class="flex items-start gap-2">
                        <svg
                        ...
                        >
                          ...
                          <path d="m9 11 3 3L22 4"></path></svg
                        ><span class="text-sm"
                          >Mental health resources and counseling</span
                        >
                      </li>
                      <li class="flex items-start gap-2">
                        <svg
                        ...
                        >
                          ...
                          <path d="m9 11 3 3L22 4"></path></svg
                        ><span class="text-sm"
                          >Integration assistance for internationals</span
                        >
                      </li>
                    </ul>
                  </div>
              ...
              >
                ...
                >
                  <svg
                    ...
                    stroke-linecap="round"
                    stroke-linejoin="round"
                    class="lucide lucide-lightbulb h-5 w-5 text-secondary"
                  >
                    <path
                  ...
                  ><span>When to Seek Support</span>
                </h3>
                <p class="text-muted-foreground mb-4">
                    ...
                    <ul class="space-y-2 text-sm text-muted-foreground">
                      <li class="flex items-start gap-2">
                        ...
                        >
                          ...
                          <path d="m9 11 3 3L22 4"></path></svg
                        ><span
                          >Difficulty understanding course material or work
                          tasks</span
                        >
                      </li>
                      <li class="flex items-start gap-2">
                        ...
                        >
                          ...
                          <path d="m9 11 3 3L22 4"></path></svg
                        ><span
                          >Language barriers affecting your performance</span
                        >
                      </li>
                      <li class="flex items-start gap-2">
                        <svg
                        ...
                        >
                          <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                          <path d="m9 11 3 3L22 4"></path></svg
                        ><span>Conflicts with colleagues or classmates</span>
                      </li>
                    </ul>
                  </div>
                  <div
                    ...
                    <ul class="space-y-2 text-sm text-muted-foreground">
                      <li class="flex items-start gap-2">
                        ...
                        >
                          <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                          <path d="m9 11 3 3L22 4"></path></svg
                        ><span>Feeling overwhelmed or experiencing stress</span>
                      </li>
                      <li class="flex items-start gap-2">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                        ...
                        >
                          <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                          <path d="m9 11 3 3L22 4"></path></svg
                        ><span>Homesickness or cultural adjustment issues</span>
                      </li>
                      <li class="flex items-start gap-2">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                        ...
                        >
                          <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                          <path d="m9 11 3 3L22 4"></path></svg
                        ><span>Administrative or bureaucratic challenges</span>
                      </li>
                    </ul>
                  </div>
                </div>
          ...
          <section class="py-16">
            <div class="container px-4 md:px-6">
              ...
              <div class="grid md:grid-cols-2 gap-10 items-center">
                  ...
                  <div class="space-y-3">
                    <div class="flex items-start gap-3">
                      ...
                      >
                        ...
                        <path d="m9 11 3 3L22 4"></path></svg
                      ><span
                        >30 working days of paid vacation per year (typical for
                    ...
                    <div class="flex items-start gap-3">
                      ...
                      >
                        ...
                        <path d="m9 11 3 3L22 4"></path></svg
                      ><span
                        >Statutory holidays vary by federal state (9-13 days
                        annually)</span
                      >
                    </div>
                    <div class="flex items-start gap-3">
                      ...
                      >
                        ...
                        <path d="m9 11 3 3L22 4"></path></svg
                      ><span
                        >Vocational school holidays often align with regional
                        school breaks</span
                      >
                    </div>
                    <div class="flex items-start gap-3">
                      ...
                      >
                        ...
                        <path d="m9 11 3 3L22 4"></path></svg
                      ><span
                        >Discounted travel and cultural opportunities with
                ...
                >
                  <img
                    alt="Leisure activities in Germany"
                    loading="lazy"
                    decoding="async"
                    data-nimg="fill"
                    class="object-cover"
                    ...
                    "
                    sizes="100vw"
                    src="{{ asset('assets/_next/leisure-germany89ef.jpeg') }}"
                  />
                  <div
                    class="absolute bottom-0 left-0 right-0 bg-secondary/95 p-4"
                  >
                  ...
                  <ul class="space-y-1 text-sm">
                    <li class="flex items-center gap-2">
                      ...
                      ><span class="text-muted-foreground"
                        >Sports clubs (Vereine) for team and individual
                        sports</span
                      >
                    </li>
                    <li class="flex items-center gap-2">
                      ...
                      >
                        ...
                        <path d="m9 11 3 3L22 4"></path></svg
                      ><span class="text-muted-foreground"
                        >Hiking in numerous nature parks and trails</span
                      >
                    </li>
                    <li class="flex items-center gap-2">
                      <svg
                      ...
                      >
                        ...
                        <path d="m9 11 3 3L22 4"></path></svg
                      ><span class="text-muted-foreground"
                        >Cycling on extensive bike path networks</span
                      >
                    </li>
                    <li class="flex items-center gap-2">
                      <svg
                      ...
                      >
                        ...
                        <path d="m9 11 3 3L22 4"></path></svg
                      ><span class="text-muted-foreground"
                        >Public swimming pools and lakes</span
                      >
                    </li>
                  </ul>
                </div>
                  ...
                  <ul class="space-y-1 text-sm">
                    <li class="flex items-center gap-2">
                      ...
                      >
                        ...
                        <path d="m9 11 3 3L22 4"></path></svg
                      ><span class="text-muted-foreground"
                        >Museums and galleries (often free/reduced on certain
                        days)</span
                      >
                    </li>
                    <li class="flex items-center gap-2">
                      ...
                      >
                        ...
                        <path d="m9 11 3 3L22 4"></path></svg
                      ><span class="text-muted-foreground"
                        >Concerts, theater performances, and opera</span
                      >
                    </li>
                    <li class="flex items-center gap-2">
                      <svg
                      ...
                      >
                        ...
                        <path d="m9 11 3 3L22 4"></path></svg
                      ><span class="text-muted-foreground"
                        >Cinema (with student discounts and original version
                        films)</span
                      >
                    </li>
                    <li class="flex items-center gap-2">
                      ...
                      >
                        ...
                        <path d="m9 11 3 3L22 4"></path></svg
                      ><span class="text-muted-foreground"
                        >Seasonal festivals and cultural events</span
                      >
                    </li>
                  </ul>
                </div>
                  ...
                  <ul class="space-y-1 text-sm">
                    <li class="flex items-center gap-2">
                      ...
                      >
                        ...
                        <path d="m9 11 3 3L22 4"></path></svg
                      ><span class="text-muted-foreground"
                        >Discounted regional and national train tickets for
                        students</span
                      >
                    </li>
                    <li class="flex items-center gap-2">
                      ...
                      >
                        ...
                        <path d="m9 11 3 3L22 4"></path></svg
                      ><span class="text-muted-foreground"
                        >Weekend trips to neighboring cities and countries</span
                      >
                    </li>
                    <li class="flex items-center gap-2">
                      <svg
                      ...
                      >
                        ...
                        <path d="m9 11 3 3L22 4"></path></svg
                      ><span class="text-muted-foreground"
                        >Youth hostels throughout Germany and Europe</span
                      >
                    </li>
                    <li class="flex items-center gap-2">
                      <svg
                      ...
                      >
                        ...
                        <path d="m9 11 3 3L22 4"></path></svg
                      ><span class="text-muted-foreground"
                        >Low-cost airlines for European exploration</span
                      >
                    </li>
                  </ul>
                </div>
              ...
              <div
                class="mt-10 p-6 bg-card border border-primary/10 rounded-xl max-w-3xl mx-auto"
              >
                <h3
                  class="tracking-tight font-semibold sm:text-lg text-secondary text-lg mb-3 flex items-center gap-2"
                >
                  <svg
                    ...
                    stroke-linecap="round"
                    stroke-linejoin="round"
                    class="lucide lucide-lightbulb h-5 w-5 text-primary"
                  >
                    <path
                      d="M15 14c.2-1 .7-1.7 1.5-2.5 1-.9 1.5-2.2 1.5-3.5A6 6 0 0 0 6 8c0 1 .2 2.2 1.5 3.5.7.7 1.3 1.5 1.5 2.5"
                    ></path>
                    <path d="M9 18h6"></path>
                    <path d="M10 22h4"></path></svg
                  ><span>Pro Tips for Affordable Recreation</span>
                </h3>
                <div class="grid sm:grid-cols-2 gap-4">
                  <div
                    class="p-3 bg-background rounded-lg border border-border"
                  >
                    ...
                    >
                      ...
                      >
                        <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                        <path d="m9 11 3 3L22 4"></path></svg
                      ><span>Get Your Trainee ID Card</span>
                    </h4>
                    <p class="text-xs text-muted-foreground">
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                        <path d="m9 11 3 3L22 4"></path></svg
                      ><span>City Cards and Regional Passes</span>
                    </h4>
                    <p class="text-xs text-muted-foreground">
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                        <path d="m9 11 3 3L22 4"></path></svg
                      ><span>Free or Low-Cost Activities</span>
                    </h4>
                    <p class="text-xs text-muted-foreground">
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                        <path d="m9 11 3 3L22 4"></path></svg
                      ><span>Join Clubs and Associations</span>
                    </h4>
                    <p class="text-xs text-muted-foreground">
