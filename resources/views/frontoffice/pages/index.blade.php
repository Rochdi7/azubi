...
@section('meta')
    ...
    <meta name="keywords"
        content="Ausbildung Germany 2026,vocational training Germany,apprenticeship Germany,German dual education,earn while learning" />
    <meta property="og:title" content="Ausbildung Germany 2026: Earn €1,300/Month While Learning | 85% Job Placement" />
    <meta property="og:description"
        content="Start your Ausbildung in Germany 2026! Earn €900-1,300/month while training. Smart application tools help you apply 10x faster." />
                    ...
                    <a href="#">
                        <button
                            ...
                            Your Match<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round"
                                class="lucide lucide-arrow-right ml-2 w-5 h-5 transition-transform duration-200 group-hover:translate-x-1">
                                <path d="M5 12h14"></path>
                                <path d="m12 5 7 7-7 7"></path>
                            </svg></button>
                    </a>
            ...
            <div class="container">
                ...
                <div class="mb-8">
                    <div class="flex gap-6 overflow-x-auto pb-4 scroll-smooth">
                        <div class="flex-shrink-0 w-72 md:w-80" style="opacity: 1; transform: none">
                  ...
                  ">
                    ...
                    <div class="relative z-10 text-center space-y-6 md:space-y-8" data-gsap-depth="foreground">
                      ...
                      "
                        ...
                        <div class="mt-6" style="opacity: 1; transform: none">
                            <div
