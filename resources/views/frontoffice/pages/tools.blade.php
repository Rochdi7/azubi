    ...
    <div class="min-h-screen bg-cream">
        ...
        <section id="tools-section" class="py-16 bg-beige">
            <div class="container max-w-7xl mx-auto px-6">
                <div class="mb-12">
                    <h2 class="tracking-tight font-bold text-2xl sm:text-3xl text-green mb-3">
                        Available Now
                    </h2>
                        ...
                        <div
                            ...
                            <div class="flex flex-col h-full">
                                <div class="flex items-start justify-between mb-4">
                                    ...
                                    <span
                                        class="inline-flex items-center px-3 py-1 rounded-full bg-beige text-green text-xs font-medium">Financial
                                        Planning</span>
                                </div>
                                <h3
                                ...
                                <p class="text-sm text-green/70 leading-relaxed flex-grow line-clamp-3 mb-4">
                        ...
                        <div
                            ...
                            <div class="flex flex-col h-full">
                                <div class="flex items-start justify-between mb-4">
                                    ...
                                    <span
                                        class="inline-flex items-center px-3 py-1 rounded-full bg-beige text-green text-xs font-medium">Application
                                        Support</span>
                                </div>
                                <h3
                                    class="text-lg font-semibold text-green mb-2 line-clamp-2 group-hover:text-orange transition-colors">
                        ...
                        <div
                            ...
                            <div class="flex flex-col h-full">
                                <div class="flex items-start justify-between mb-4">
                                    ...
                                    <span
                                        class="inline-flex items-center px-3 py-1 rounded-full bg-beige text-green text-xs font-medium">Comparison
                                        Tools</span>
                                </div>
                                <h3
                                    class="text-lg font-semibold text-green mb-2 line-clamp-2 group-hover:text-orange transition-colors">
                            ...
                            <div
                                ...
                                <div class="flex flex-col h-full">
                                    <div class="flex items-start justify-between mb-4">
                                        ...
                                        <span
                                            class="inline-flex items-center px-3 py-1 rounded-full bg-beige text-green/60 text-xs font-medium">Coming
                                            Soon</span>
                                    </div>
                                    <h3 class="text-lg font-semibold text-green mb-2 line-clamp-2">
                                        Salary Progression Calculator
                                    </h3>
                                    <p class="text-sm text-green/70 leading-relaxed flex-grow line-clamp-3">
        ...
        <section class="py-8 bg-cream">
            <div class="container max-w-7xl mx-auto px-6 text-center">
                <a class="text-sm text-green/60 hover:text-green underline decoration-green/30 hover:decoration-green/60 transition-colors"
