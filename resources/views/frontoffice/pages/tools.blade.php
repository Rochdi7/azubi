...
@section('title', 'Free Ausbildung Tools: 12 Calculators & Generators (2026) | Azubi')

@section('meta')
    <meta name="description"
        content="Free AI-powered application tools. Generate cover letters in 30 seconds. Eligibility checker, job matching, timeline planner &amp; more." />
    <meta name="keywords"
        content="ausbildung tools,eligibility checker germany,ai cover letter generator,cost calculator germany,ausbildung checklist,free ausbildung resources" />
    <meta property="og:title" content="Free Ausbildung Tools: 12 Calculators &amp; Generators (2026)" />
    <meta property="og:description"
        content="Free AI-powered application tools. Generate cover letters in 30 seconds. Eligibility checker, job matching, timeline planner &amp; more." />
    <meta property="og:image" content="https://images.azubi.ma/og-images/tools.png" />
...
@section('content')
    <div class="min-h-screen azubi-bg-cream">
        <section
            ...
            <img alt="Rothenburg ob der Tauber in autumn - historic German medieval town" loading="eager" decoding="async"
                ...
                <div class="flex flex-col gap-4 sm:gap-5">
                    <div class="animate-fade-in-up animation-delay-100">
                        <div class="inline-flex items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 border-2 border-white/80 text-white backdrop-blur-sm bg-white/10 hover:bg-white/20 px-3 py-1.5 text-sm font-semibold"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                ...
                                stroke-linejoin="round" class="lucide lucide-wrench h-4 w-4 mr-2" aria-hidden="true">
                                <path
                    ...
                    <nav class="flex flex-col sm:flex-row gap-3 sm:gap-4 animate-fade-in-up animation-delay-400 mt-2 w-full max-w-md mx-auto justify-center"
                        ...
                        <a class="inline-flex items-center justify-center gap-2 whitespace-nowrap focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 active:translate-y-0 h-14 bg-[#5D5DE9] hover:bg-[#2C3340] text-white shadow-lg hover:shadow-xl transition-all duration-300 rounded-full px-6 sm:px-7 py-5 text-base font-semibold w-full sm:w-auto hover:-translate-y-1 inline-flex items-center justify-center"
                            aria-label="Explore All Tools" href="#tools-section"><span aria-hidden="true"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round" class="lucide lucide-calculator w-5 h-5 mr-2">
                            ...
                            aria-label="Get Started" href="#"><span aria-hidden="true"><svg
                                ...
                                </svg></span><span>Get Started</span></a>
                    </nav>
                    <div class="animate-fade-in-up animation-delay-500 mt-4">
                        <div class="flex flex-wrap items-center justify-center gap-6 mt-4 text-sm text-white/80">
        ...
        <section id="tools-section" class="py-16 azubi-bg-beige">
            <div class="container max-w-7xl mx-auto px-6">
                <div class="mb-12">
                    <h2 class="tracking-tight font-bold text-2xl sm:text-3xl azubi-text-green mb-3">
                        Available Now
                    </h2>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <a class="block group" href="#">
                        <div
                            class="rounded-xl text-card-foreground shadow bg-white border azubi-border-green/10 p-6 h-full transition-all hover:shadow-lg hover:-translate-y-2">
                            <div class="flex flex-col h-full">
                                <div class="flex items-start justify-between mb-4">
                                    <div
                                        class="w-12 h-12 rounded-xl azubi-bg-orange flex items-center justify-center flex-shrink-0 transition-transform group-hover:scale-110">
                                    ...
                                    <span
                                        class="inline-flex items-center px-3 py-1 rounded-full azubi-bg-beige azubi-text-green text-xs font-medium">Financial
                                        Planning</span>
                                </div>
                                <h3
                                    class="text-lg font-semibold azubi-text-green mb-2 line-clamp-2 group-hover:azubi-text-orange transition-colors">
                                    Blocked Account Calculator
                                </h3>
                                <p class="text-sm azubi-text-green/70 leading-relaxed flex-grow line-clamp-3 mb-4">
                                    Calculate exact blocked account requirements for your
                                    Ausbildung visa application including monthly breakdown
                                    and total costs.
                                </p>
                                <div
                                    class="inline-flex items-center text-sm font-semibold azubi-text-orange group-hover:gap-2 transition-all">
                                    Try Now<svg class="w-4 h-4 ml-1 transition-transform group-hover:translate-x-1"
                        ...
                        <div
                            ...
                            <div class="flex flex-col h-full">
                                <div class="flex items-start justify-between mb-4">
                                    ...
                                    <span
                                        class="inline-flex items-center px-3 py-1 rounded-full azubi-bg-beige azubi-text-green text-xs font-medium">Application
                                        Support</span>
                                </div>
                                <h3
                                    class="text-lg font-semibold azubi-text-green mb-2 line-clamp-2 group-hover:azubi-text-orange transition-colors">
                        ...
                        <div
                            ...
                            <div class="flex flex-col h-full">
                                <div class="flex items-start justify-between mb-4">
                                    ...
                                    <span
                                        class="inline-flex items-center px-3 py-1 rounded-full azubi-bg-beige azubi-text-green text-xs font-medium">Comparison
                                        Tools</span>
                                </div>
                                <h3
                                    class="text-lg font-semibold azubi-text-green mb-2 line-clamp-2 group-hover:azubi-text-orange transition-colors">
        ...
        <section class="py-16 azubi-bg-cream">
            <div class="container max-w-7xl mx-auto px-6">
                <div class="mb-12">
                    <h2 class="tracking-tight font-bold text-2xl sm:text-3xl azubi-text-green mb-3">
                        Coming Soon
                ...
                <div class="mb-12">
                    <h3 class="text-xl font-semibold azubi-text-green mb-6">
                        Financial Planning
                    </h3>
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <div class="block cursor-not-allowed opacity-75">
                            <div
                                class="rounded-xl text-card-foreground shadow bg-white border azubi-border-green/10 p-6 h-full transition-all hover:shadow-md">
                                <div class="flex flex-col h-full">
                                    <div class="flex items-start justify-between mb-4">
                                        <div
                                            class="w-12 h-12 rounded-xl azubi-bg-beige flex items-center justify-center flex-shrink-0">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                                class="lucide lucide-trending-up w-6 h-6 azubi-text-orange">
                                                <polyline points="22 7 13.5 15.5 8.5 10.5 2 17"></polyline>
                                                <polyline points="16 7 22 7 22 13"></polyline>
                                            </svg>
                                        </div>
                                        <span
                                            class="inline-flex items-center px-3 py-1 rounded-full azubi-bg-beige azubi-text-green/60 text-xs font-medium">Coming
                                            Soon</span>
                                    </div>
                                    <h3 class="text-lg font-semibold azubi-text-green mb-2 line-clamp-2">
                                        Salary Progression Calculator
                                    </h3>
                                    <p class="text-sm azubi-text-green/70 leading-relaxed flex-grow line-clamp-3">
                                    ...
                                    <div class="flex items-start justify-between mb-4">
                                        <div
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                                class="lucide lucide-dollar-sign w-6 h-6 azubi-text-orange">
                                    ...
                                    <div class="flex items-start justify-between mb-4">
                                        <div
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                                class="lucide lucide-award w-6 h-6 azubi-text-orange">
                                                <path
                                    ...
                                    <div class="flex items-start justify-between mb-4">
                                        <div
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                                class="lucide lucide-languages w-6 h-6 azubi-text-orange">
                                    ...
                                    <div class="flex items-start justify-between mb-4">
                                        <div
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                                class="lucide lucide-file-text w-6 h-6 azubi-text-orange">
                                                <path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z"></path>
                                                <path d="M14 2v4a2 2 0 0 0 2 2h4"></path>
                                                <path d="M10 9H8"></path>
                                                <path d="M16 13H8"></path>
                                    ...
                                    <div class="flex items-start justify-between mb-4">
                                        <div
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                                class="lucide lucide-map-pin w-6 h-6 azubi-text-orange">
                                                <path
        ...
        <section class="py-8 azubi-bg-cream">
            <div class="container max-w-7xl mx-auto px-6 text-center">
                <a class="text-sm azubi-text-green/60 hover:azubi-text-green underline decoration-green/30 hover:decoration-green/60 transition-colors"
                    href="{{ route('front.consultation') }}">Need expert help with your applications? Learn about Apply
                    For
                    Me →</a>
            </div>
        </section>
        <section class="py-16 azubi-bg-orange">
            <div class="container max-w-4xl mx-auto px-6 text-center">
                <h2 class="tracking-tight font-bold text-2xl sm:text-3xl text-white mb-4">
                ...
                <a class="inline-flex items-center justify-center px-8 py-4 rounded-full azubi-bg-green azubi-text-cream font-semibold transition-all hover:azubi-bg-green/90 hover:shadow-lg hover:-translate-y-1"
