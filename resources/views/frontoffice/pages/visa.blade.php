...
@section('meta')
    ...
    <meta
    property="og:image"
    content="https://images.goausbildung.com/og-images/visa.png"
    />
...
@section('content')
        <div class="flex flex-col">
          ...
          >
            <img
              alt="Bavarian Alps in autumn - majestic German mountain landscape"
              loading="eager"
              decoding="async"
              data-nimg="fill"
                ...
                <div class="animate-fade-in-up animation-delay-100">
                  ...
                  >
                    <svg
                      ...
                      class="lucide lucide-plane h-4 w-4 mr-2"
                      aria-hidden="true"
                    >
                      <path
                  ...
                  ><a
                    ...
                    ><span aria-hidden="true"
                      ><svg
                        ...
                        stroke-linecap="round"
                        stroke-linejoin="round"
                        class="lucide lucide-plane w-5 h-5 mr-2"
                      >
                        <path
                          d="M17.8 19.2 16 11l3.5-3.5C21 6 21.5 4 21 3c-1-.5-3 0-4.5 1.5L13 8 4.8 6.2c-.5-.1-.9.1-1.1.5l-.3.5c-.2.5-.1 1 .3 1.3L9 12l-2 3H4l-1 1 3 2 2 3 1-1v-3l3-2 3.5 5.3c.3.4.8.5 1.3.3l.5-.2c.4-.3.6-.7.5-1.2z"
                        ></path></svg></span
                    ><span>View Process</span></a
                  >
                </nav>
              </div>
            </div>
          ...
          <section id="visa-process" class="py-16">
            <div class="container px-4 md:px-6">
              <h2
                class="tracking-tight font-bold text-2xl sm:text-3xl text-secondary mb-6"
              >
                  ...
                  <div class="p-6">
                    ...
                    <ul class="space-y-2">
                      <li class="flex items-start gap-2">
                        ...
                        ><span>Valid for 90 days initially</span>
                      </li>
                      <li class="flex items-start gap-2">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                        ...
                        >
                          ...
                          <path d="m9 11 3 3L22 4"></path></svg
                        ><span
                          >Requires Ausbildung contract from a German
                          employer</span
                        >
                      </li>
                      <li class="flex items-start gap-2">
                        ...
                        >
                          <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                          <path d="m9 11 3 3L22 4"></path></svg
                        ><span>Must be obtained before entering Germany</span>
                      </li>
                    </ul>
                  </div>
                </div>
                    ...
                    <ul class="space-y-2">
                      <li class="flex items-start gap-2">
                        ...
                        >
                          ...
                          <path d="m9 11 3 3L22 4"></path></svg
                        ><span
                          >Valid for the duration of your Ausbildung (2-3.5
                          years)</span
                        >
                      </li>
                      <li class="flex items-start gap-2">
                      ...
                      <li class="flex items-start gap-2">
                        ...
                        >
                          ...
                          <path d="m9 11 3 3L22 4"></path></svg
                        ><span
                          >Includes work authorization for your training
                          position</span
                        >
                      </li>
                    </ul>
          ...
          <section class="py-16 bg-muted/30">
            <div class="container px-4 md:px-6">
              ...
              <div
                class="bg-card border border-primary/10 rounded-xl p-6 md:p-8"
              >
                <div class="mb-8">
                  ...
                  <div class="flex gap-4">
                    ...
                    <div>
                      ...
                      <p class="text-muted-foreground">
                        ...
                        employer. GoAusbildung helps with finding suitable
          ...
          <section class="py-16">
            <div class="container px-4 md:px-6">
              ...
              <div class="grid md:grid-cols-2 gap-6">
                <div
                  class="rounded-xl text-card-foreground shadow h-full bg-card border border-primary/10"
                >
                  <div class="p-6">
                    <h3
                    ...
                    <ul class="space-y-3">
                      <li class="flex items-start gap-2">
                        ...
                        >
                          ...
                          <path d="m9 11 3 3L22 4"></path></svg
                        ><span
                          >Valid passport (with at least 1 year validity)</span
                        >
                      </li>
                      <li class="flex items-start gap-2">
                        <svg
                      ...
                      <li class="flex items-start gap-2">
                        ...
                        >
                          <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                          <path d="m9 11 3 3L22 4"></path></svg
                        ><span>3 biometric passport photos (35x45mm)</span>
                      </li>
                      <li class="flex items-start gap-2">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                        ...
                        >
                          ...
                          <path d="m9 11 3 3L22 4"></path></svg
                        ><span
                          >Cover letter explaining your purpose and plans</span
                        >
                      </li>
                    </ul>
                  </div>
                    ...
                    <ul class="space-y-3">
                      <li class="flex items-start gap-2">
                        ...
                        >
                          ...
                          <path d="m9 11 3 3L22 4"></path></svg
                        ><span
                          >Signed Ausbildung contract (Ausbildungsvertrag)</span
                        >
                      </li>
                      <li class="flex items-start gap-2">
                        <svg
                        ...
                        >
                          ...
                          <path d="m9 11 3 3L22 4"></path></svg
                        ><span
                          >German language certificate (minimum B1 level)</span
                        >
                      </li>
                      <li class="flex items-start gap-2">
                        <svg
                        ...
                        >
                          <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                          <path d="m9 11 3 3L22 4"></path></svg
                        ><span>Educational certificates with translations</span>
                      </li>
                      <li class="flex items-start gap-2">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                        ...
                        >
                          <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                          <path d="m9 11 3 3L22 4"></path></svg
                        ><span>CV/resume in German format</span>
                      </li>
                    </ul>
                  </div>
                </div>
                    ...
                    <ul class="space-y-3">
                      ...
                      <li class="flex items-start gap-2">
                        ...
                        >
                          ...
                          <path d="m9 11 3 3L22 4"></path></svg
                        ><span
                          >Proof of travel health insurance for initial
                          period</span
                        >
                      </li>
                    </ul>
                    ...
                    <ul class="space-y-3">
                      <li class="flex items-start gap-2">
                        ...
                        >
                          ...
                          <path d="m9 11 3 3L22 4"></path></svg
                        ><span
                          >Proof of accommodation in Germany (if
                          available)</span
                        >
                      </li>
                      <li class="flex items-start gap-2">
                        ...
                        >
                          ...
                          <path d="m9 11 3 3L22 4"></path></svg
                        ><span
                          >Previous visa refusals documentation (if
                          applicable)</span
                        >
                      </li>
                      <li class="flex items-start gap-2">
                        ...
                        >
                          ...
                          <path d="m9 11 3 3L22 4"></path></svg
                        ><span
                          >Declaration of authenticity for submitted
                          documents</span
                        >
                      </li>
                    </ul>
          ...
          <section class="py-16">
            <div class="container px-4 md:px-6">
              ...
              <div
                class="bg-card border border-primary/10 rounded-xl"
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      How long does the visa application process take?<svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                        height="24"
                        viewBox="0 0 24 24"
                ...
                >
                  ...
                  >
                    <button
                      ...
                      data-radix-collection-item=""
                    >
                      Do I need to speak German for the visa interview?<svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                        height="24"
                        viewBox="0 0 24 24"
                ...
                >
                  ...
                  >
                    <button
                      ...
                      data-radix-collection-item=""
                    >
                      Can my visa be rejected and why?<svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                        height="24"
                        viewBox="0 0 24 24"
                ...
                >
                  ...
                  >
                    <button
                      ...
                      data-radix-collection-item=""
                    >
                      Can I bring my family with me on an Ausbildung visa?<svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                        height="24"
                        viewBox="0 0 24 24"
