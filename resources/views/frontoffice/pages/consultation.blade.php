...
@section('title', 'Consultation - Expert Ausbildung Application Service | GoAusbildung')

@section('meta')
    <meta name="description" content="Our expert team applies to 30+ Ausbildung positions for you. Pay advance to start, success fee only when you get an offer.">
    <meta name="keywords" content="ausbildung application service,apply for me ausbildung,ausbildung consultancy india,german apprenticeship application help,ausbildung agent,ausbildung help india,someone apply for ausbildung,ausbildung cover letter service,german apprenticeship consultancy,ausbildung expert help">
    <meta property="og:title" content="Expert Ausbildung Consultation Service | GoAusbildung">
    <meta property="og:description" content="Our expert team applies to 30+ Ausbildung positions for you. Pay advance to start, success fee only when you get an offer.">
@endsection

@section('content')
<main class="min-h-screen bg-[#F9F5F0]">
          <section
            class="relative w-full overflow-hidden bg-[#F9F5F0] pt-4 pb-8 sm:pt-6 sm:pb-12 md:pt-8 md:pb-16"
            aria-label="Apply For Me service hero section"
          >
            <div class="container mx-auto px-4 lg:px-6">
              <div
                class="relative overflow-hidden rounded-2xl sm:rounded-3xl shadow-xl"
              >
                ...
                <div
                  class="relative z-10 px-6 py-12 sm:px-8 sm:py-16 md:px-12 md:py-24 text-center"
                >
                  <div class="flex justify-center mb-4 sm:mb-6">
                    ...
                    >
                      <svg
                        ...
                        class="lucide lucide-building2 w-4 h-4 mr-2"
                      >
                        <path
                  ...
                  >
                    Get Your Ausbildung Offer.<br /><span class="text-[#F4991A]"
                  ...
                  <div
                    class="flex flex-wrap items-center justify-center gap-3 mb-8 text-white"
                  >
                    <div
                    ...
                    >
                      <svg
                        ...
                        stroke-linecap="round"
                        stroke-linejoin="round"
                        class="lucide lucide-shield-check w-4 h-4 text-emerald-300"
                      >
                        <path
                  ...
                  >
                    <div class="flex -space-x-3">
                      ...
                      >
                        <img
                          src="{{ asset('assets/images/hero-avatar-1.webp') }}"
                          alt=""
                          class="w-full h-full object-cover"
                          loading="lazy"
                          width="44"
                      ...
                      >
                        <img
                          src="{{ asset('assets/images/hero-avatar-2.webp') }}"
                          alt=""
                          class="w-full h-full object-cover"
                          loading="lazy"
                          width="44"
                      ...
                      >
                        <img
                          src="{{ asset('assets/images/hero-avatar-3.webp') }}"
                          alt=""
                          class="w-full h-full object-cover"
                          loading="lazy"
                          width="44"
                      ...
                      >
                        <img
                          src="{{ asset('assets/images/hero-avatar-4.webp') }}"
                          alt=""
                          class="w-full h-full object-cover"
                          loading="lazy"
                          width="44"
                    ...
                    <p class="text-sm text-white/70">
                      ...
                      <span class="text-white font-medium"
                        >Siemens, BMW, Bosch, Deutsche Bahn</span
                      >
                      &amp; more
                    </p>
                  </div>
                  <div
                    class="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center max-w-lg mx-auto"
                  >
                    <a href="#pricing" class="inline-block flex-1"
                      ><button
          ...
          <section class="py-16 md:py-24 bg-white overflow-hidden">
            <div class="container mx-auto px-4">
              ...
              >
                <h2
                  class="text-3xl md:text-4xl lg:text-5xl font-bold text-[#344F1F] mb-4"
                >
              ...
              <div class="max-w-6xl mx-auto">
                <div
                  class="grid lg:grid-cols-[1fr,auto,1fr] gap-6 lg:gap-0 items-stretch"
                >
                  <div
                    class="relative"
                  ...
                  >
                    <div
                      class="h-full bg-[#1a1a1a] rounded-2xl lg:rounded-r-none p-6 md:p-8 text-white"
                    >
                      <div class="mb-8">
                        <span
                          class="inline-block px-3 py-1 bg-white/10 rounded-full text-xs font-medium text-white/70 mb-4"
                          >THE OLD WAY</span
                        >
                        <h3
                          class="text-2xl md:text-3xl font-bold mb-2 text-white"
                        >
                          Doing It Alone
                        </h3>
                  ...
                  <div
                    class="hidden lg:flex items-center justify-center z-10"
                  ...
                  <div
                    class="flex lg:hidden items-center justify-center py-2"
                  ...
                  >
                    ...
                    >
                      <div class="mb-8">
                        <span
                          class="inline-flex items-center gap-1.5 px-3 py-1 bg-[#F4991A]/20 rounded-full text-xs font-medium text-[#F4991A] mb-4"
                          ><svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
                            height="24"
                ...
                <div
                  class="mt-8 bg-[#F9F5F0] rounded-2xl p-6 md:p-8"
                  style="opacity: 0; transform: translateY(20px)"
                >
                  <div
                  ...
                  >
                    <div class="flex items-center gap-4">
                      <div
                        class="w-12 h-12 bg-[#F4991A]/10 rounded-full flex items-center justify-center"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="24"
                    ...
                    <div class="flex items-center gap-8">
                      ...
                      <div
                        class="h-8 w-px bg-[#344F1F]/10 hidden md:block"
                      ></div>
                      <div class="text-center">
                        <div class="text-2xl font-bold text-[#F4991A]">
                          $300
          ...
          <section
            id="how-it-works"
            class="py-12 sm:py-16 md:py-24 bg-[#F9F5F0]"
          >
            <div class="container mx-auto px-4">
              <div
                class="text-center mb-8 sm:mb-12 lg:mb-16"
                style="opacity: 0; transform: translateY(20px)"
              >
                <h2
                  class="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-3 sm:mb-4 text-[#344F1F]"
                >
                  How It Works
                </h2>
                <p
                  class="text-base sm:text-lg text-[#344F1F]/70 max-w-2xl mx-auto px-4"
                >
                      ...
                      <div class="relative" style="height: 520px">
                        ...
                        >
                          <div class="text-center mb-6">
                            ...
                            <div
                              class="flex items-baseline justify-center gap-2 mb-4"
                            >
          ...
          <section class="py-16 md:py-24 bg-white">
            <div class="container mx-auto px-4">
              ...
              >
                ...
                <h2
                  class="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 text-[#344F1F]"
                >
              ...
              <div class="max-w-7xl mx-auto">
                <div class="hidden lg:grid lg:grid-cols-3 gap-6">
                  <div
                    class="lg:row-span-2 rounded-2xl border-2 border-orange-300 bg-gradient-to-br from-orange-50 to-amber-50 hover:shadow-xl transition-all duration-500 min-h-[400px] p-8 flex flex-col"
                    style="opacity: 0; transform: translateY(20px)"
                  >
                    <div class="flex-1 space-y-4">
                      <div
                        class="w-12 h-12 bg-[#F4991A] rounded-full flex items-center justify-center"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="24"
                  ...
                  <div
                    class="lg:col-span-2 rounded-2xl border-2 border-green-200 bg-gradient-to-br from-green-50 to-emerald-50 hover:shadow-xl transition-all duration-500 p-6"
                    style="opacity: 0; transform: translateY(20px)"
                  >
                    <div
                      class="flex items-center justify-between gap-6 md:gap-8"
                    >
                      <div class="flex-1 space-y-3">
                        ...
                        <h3
                          class="text-xl md:text-2xl font-bold text-[#344F1F]"
                        >
                          Real-Time Dashboard
                        </h3>
                        <p
                          class="text-sm md:text-base text-[#344F1F]/70 leading-relaxed"
                        >
                  ...
                  <div
                    class="lg:row-span-2 rounded-2xl border-2 border-blue-200 bg-gradient-to-br from-blue-50 to-sky-50 hover:shadow-xl transition-all duration-500 min-h-[400px] p-8 flex flex-col"
                    style="opacity: 0; transform: translateY(20px)"
                  >
                    <div class="flex-1 space-y-4">
                      <div
                    ...
                    <div class="flex justify-center pt-4">
                      <div class="relative w-48 h-48 md:w-64 md:h-64">
                        <img
                          alt="Native German Cover Letters"
                          loading="lazy"
                          width="256"
                          height="256"
                          decoding="async"
                  ...
                  <div
                    class="lg:row-span-2 rounded-2xl border-2 border-purple-200 bg-gradient-to-br from-purple-50 to-violet-50 hover:shadow-xl transition-all duration-500 min-h-[400px] p-8 flex flex-col"
                    style="opacity: 0; transform: translateY(20px)"
                  >
                    <div class="flex-1 space-y-4">
                      <div
                  ...
                  <a href="#pricing"
                    ><div
                      class="group bg-[#1a1a1a] text-white rounded-2xl p-6 flex items-center justify-between hover:bg-[#262626] transition-all duration-300 hover:shadow-xl border-2 border-[#262626] h-[150px]"
                      style="opacity: 0; transform: translateY(20px)"
                    >
                      <div class="flex items-center gap-3">
                        <div class="flex -space-x-3">
                          <div
                            class="w-12 h-12 rounded-full border-[3px] border-white overflow-hidden"
                          >
                            <img
                              alt="Student 1"
                              loading="lazy"
                  ...
                  ></a>
                  <div
                    class="rounded-2xl border-2 border-amber-200 bg-gradient-to-br from-amber-50 to-yellow-50 hover:shadow-xl transition-all duration-500 p-6 flex flex-col"
                    style="opacity: 0; transform: translateY(20px)"
                  >
                    <div class="space-y-3">
                      <div
                  ...
                  <div
                    class="lg:col-span-2 rounded-2xl border-2 border-indigo-200 bg-gradient-to-br from-indigo-50 to-blue-50 hover:shadow-xl transition-all duration-500 p-6"
                    style="opacity: 0; transform: translateY(20px)"
                  >
                    <div
                      class="flex items-center justify-between gap-6 md:gap-8"
                ...
                <div class="hidden md:grid lg:hidden md:grid-cols-2 gap-6">
                  <div
                    class="rounded-2xl border-2 border-orange-300 bg-gradient-to-br from-orange-50 to-amber-50 hover:shadow-xl transition-all duration-500 p-6 flex flex-col"
                    style="opacity: 0; transform: translateY(20px)"
                  >
                    <div class="space-y-3">
                      <div
                  ...
                  <div
                    class="rounded-2xl border-2 border-green-200 bg-gradient-to-br from-green-50 to-emerald-50 hover:shadow-xl transition-all duration-500 p-6 flex flex-col"
                    style="opacity: 0; transform: translateY(20px)"
                  >
                    <div class="space-y-3">
                      <div
                  ...
                  <div
                    class="rounded-2xl border-2 border-blue-200 bg-gradient-to-br from-blue-50 to-sky-50 hover:shadow-xl transition-all duration-500 p-6 flex flex-col"
                    style="opacity: 0; transform: translateY(20px)"
                  >
                    <div class="space-y-3">
                      <div
                  ...
                  <div
                    class="rounded-2xl border-2 border-purple-200 bg-gradient-to-br from-purple-50 to-violet-50 hover:shadow-xl transition-all duration-500 p-6 flex flex-col"
                    style="opacity: 0; transform: translateY(20px)"
                  >
                    <div class="space-y-3">
                      <div
                  ...
                  <div
                    class="rounded-2xl border-2 border-indigo-200 bg-gradient-to-br from-indigo-50 to-blue-50 hover:shadow-xl transition-all duration-500 p-6 flex flex-col"
                    style="opacity: 0; transform: translateY(20px)"
                  >
                    <div class="space-y-3">
                      <div
                  ...
                  <a href="#pricing"
                    ><div
                      class="group bg-[#1a1a1a] text-white rounded-2xl p-6 flex items-center justify-between hover:bg-[#262626] transition-all duration-300 hover:shadow-xl border-2 border-[#262626]"
                      style="opacity: 0; transform: translateY(20px)"
                    >
                      <div class="flex items-center gap-3">
                        <div class="flex -space-x-2">
                          <div
                            class="w-10 h-10 rounded-full border-[3px] border-white overflow-hidden"
                          >
                            <img
                              alt="Student 1"
                              loading="lazy"
                ...
                <div class="grid md:hidden gap-4">
                  <div
                    class="rounded-2xl border-2 border-orange-300 bg-gradient-to-br from-orange-50 to-amber-50 p-6 flex flex-col"
                    style="opacity: 0; transform: translateY(20px)"
                  >
                    <div class="space-y-3">
                      <div
                  ...
                  <div
                    class="rounded-2xl border-2 border-green-200 bg-gradient-to-br from-green-50 to-emerald-50 p-6 flex flex-col"
                    style="opacity: 0; transform: translateY(20px)"
                  >
                    <div class="space-y-3">
                      <div
                  ...
                  <div
                    class="rounded-2xl border-2 border-blue-200 bg-gradient-to-br from-blue-50 to-sky-50 p-6 flex flex-col"
                    style="opacity: 0; transform: translateY(20px)"
                  >
                    <div class="space-y-3">
                      <div
                  ...
                  <div
                    class="rounded-2xl border-2 border-purple-200 bg-gradient-to-br from-purple-50 to-violet-50 p-6 flex flex-col"
                    style="opacity: 0; transform: translateY(20px)"
                  >
                    <div class="space-y-3">
                      <div
                  ...
                  <div
                    class="rounded-2xl border-2 border-amber-200 bg-gradient-to-br from-amber-50 to-yellow-50 p-6 flex flex-col"
                    style="opacity: 0; transform: translateY(20px)"
                  >
                    <div class="space-y-3">
                      <div
                  ...
                  <div
                    class="rounded-2xl border-2 border-indigo-200 bg-gradient-to-br from-indigo-50 to-blue-50 p-6 flex flex-col"
                    style="opacity: 0; transform: translateY(20px)"
                  >
                    <div class="space-y-3">
                      <div
                  ...
                  <a href="#pricing"
                    ><div
                      class="group bg-[#1a1a1a] text-white rounded-2xl p-6 flex items-center justify-between hover:bg-[#262626] transition-all duration-300 border-2 border-[#262626]"
                      style="opacity: 0; transform: translateY(20px)"
                    >
                      <div class="flex items-center gap-3">
                        <div class="flex -space-x-2">
          ...
          <section class="py-12 sm:py-16 md:py-24 bg-white overflow-hidden" data-dash-section>
            <div class="container mx-auto px-4">
              ...
              >
                ...
                >
                  <svg
                    ...
                    stroke-linecap="round"
                    stroke-linejoin="round"
                    class="lucide lucide-briefcase w-4 h-4 text-[#344F1F]"
                  >
                    <path d="M16 20V4a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"></path>
                    <rect width="20" height="14" x="2" y="6" rx="2"></rect></svg
                  ><span class="text-sm font-medium text-[#344F1F]"
                    >Exclusive Member Dashboard</span
                  >
                </div>
                <h2
                  class="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-3 sm:mb-4 text-[#344F1F]"
              ...
              <div
                class="max-w-7xl mx-auto grid lg:grid-cols-[1fr,1.3fr] gap-8 lg:gap-12 items-center"
              >
                <div class="space-y-3 sm:space-y-4 order-2 lg:order-1">
                  ...
                  >
                    <div
                      class="flex items-center gap-2 text-sm text-[#344F1F]/60"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                ...
                >
                  ...
                  >
                    ...
                    >
                      <div
                        class="bg-gradient-to-r from-[#344F1F] to-[#2d4219] px-4 lg:px-6 py-4 lg:py-5"
                      >
                      ...
                      >
                        <div
                          class="bg-white rounded-xl p-2 lg:p-3 text-center shadow-sm"
                        >
                          <p
                            class="text-xl lg:text-2xl font-bold text-[#344F1F]"
                          >
                            12
                          </p>
                        ...
                        >
                          <p
                            class="text-xl lg:text-2xl font-bold text-emerald-600"
                          >
                            3
                          </p>
                          <p class="text-[10px] lg:text-xs text-[#344F1F]/60">
                        ...
                        >
                          <p
                            class="text-xl lg:text-2xl font-bold text-[#F4991A]"
                          >
                            1
                          </p>
                          <p class="text-[10px] lg:text-xs text-[#344F1F]/60">
                      ...
                      <div class="p-3 lg:p-4 space-y-3 lg:space-y-4">
                        <div
                          class="bg-emerald-50 border border-emerald-200 rounded-xl p-3 lg:p-4"
                        >
                          <div class="flex items-center gap-2 mb-2">
                            ...
                            ><span
                              ...
                              >UPCOMING INTERVIEW</span
                            >
                          </div>
                          <div class="flex items-center justify-between">
                            <div>
                              <p
                                class="font-semibold text-[#344F1F] text-sm lg:text-base"
                              >
                                Siemens AG
                              </p>
                        ...
                        <div>
                          <div class="flex items-center justify-between mb-2">
                            <span
                              class="text-xs font-semibold text-[#344F1F]/70"
                              >RECENT APPLICATIONS</span
                            ><button
                          ...
                          <div class="space-y-2">
                            ...
                            >
                              <div class="flex items-center gap-2 lg:gap-3">
                                ...
                                <div>
                                  <p
                                    class="font-medium text-[#344F1F] text-xs lg:text-sm"
                                  >
                                    BMW Group
                                  </p>
                                  <p
                                    class="text-[10px] lg:text-xs text-[#344F1F]/60"
                                  >
                                    Mechatronics
                                  </p>
                                </div>
                              ...
                              <span
                                class="bg-emerald-100 text-emerald-700 text-[10px] lg:text-xs px-2 py-1 rounded-full font-medium"
                                >Interview</span
                              >
                            </div>
                            <div
                            ...
                            >
                              ...
                              <span
                                class="bg-[#344F1F]/10 text-[#344F1F] text-[10px] lg:text-xs px-2 py-1 rounded-full font-medium"
                                >Sent</span
                              >
                            </div>
                          </div>
                        ...
                        <div
                          class="bg-[#F4991A]/10 border border-[#F4991A]/20 rounded-xl p-3"
                        >
                          <div class="flex items-start gap-3">
                            ...
                            <div>
                              <p
                                class="font-semibold text-[#344F1F] text-xs lg:text-sm"
                              >
                                Anna Schmidt
                              </p>
                              <p
                                class="text-[10px] lg:text-xs text-[#344F1F]/70 mt-0.5"
                              >
              ...
              <div class="container mx-auto px-4">
                ...
                >
                  ...
                  <div class="mt-4 flex items-center justify-center gap-2">
                    <span class="text-sm text-[#344F1F]/60">Prices in:</span
                    ><button
                      type="button"
                      role="combobox"
                      aria-controls="radix-«R2ibcuslb»"
                      aria-expanded="false"
                    ...
                    >
                      <span style="pointer-events: none"
                        ><span class="flex items-center gap-1.5"
                          ...
                          ><span class="font-medium">USD</span></span
                        ></span
                      ><svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                ...
                <div class="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto">
                  <div
                    class="rounded-[32px] p-3 bg-white border border-black/10 flex flex-col"
                    style="opacity: 0; transform: translateY(20px)"
                  >
                    <div
                      class="rounded-[20px] p-6 md:p-8 bg-[#F5F5F5] flex-1 flex flex-col"
                    >
                      <div class="mb-6">
                        <div
                        ...
                        <div class="flex items-baseline gap-2">
                          <span class="text-4xl font-bold text-[#344F1F]"
                            >$<!-- -->0</span
                          ><span class="text-[#344F1F]/60">/forever</span>
                        </div>
                      ...
                      <div class="space-y-3 mb-6 flex-grow">
                        <div class="flex items-start gap-3">
                          ...
                          <span class="text-sm text-[#344F1F]/80"
                            >Unlimited access to 67,000+ jobs</span
                          >
                        </div>
                        <div class="flex items-start gap-3">
                          <div
                          ...
                          <span class="text-sm text-[#344F1F]/80"
                            >Unlimited AI application kits</span
                          >
                        </div>
                        <div class="flex items-start gap-3">
                          <div
                        ...
                        <div class="flex items-start gap-3">
                          ...
                          <span class="text-sm text-[#344F1F]/80"
                            >Full German learning tools</span
                          >
                        </div>
                        <div class="flex items-start gap-3">
                          <div
                          ...
                          <span class="text-sm text-[#344F1F]/80"
                            >AI job match recommendations</span
                          >
                        </div>
                        <div class="flex items-start gap-3">
                          <div
                          ...
                          <span class="text-sm text-[#344F1F]/80"
                            >Interview prep question bank</span
                          >
                        </div>
                      </div>
                      <button
                  ...
                  <div
                    class="rounded-[32px] p-3 bg-black relative flex flex-col"
                    style="opacity: 0; transform: translateY(20px)"
                  >
                    <div
                    ...
                    <div
                      class="rounded-[20px] p-6 md:p-8 bg-[#1a1a1a] flex-1 flex flex-col"
                    >
                      <div class="mb-6">
                        <div class="flex items-end justify-between gap-4 mb-2">
                          <h3 class="text-2xl font-bold text-white">
                            GoAusbildung Consultation
                          </h3>
                        </div>
                        ...
                        <div style="opacity: 0; transform: translateY(20px)">
                          <div class="flex items-baseline gap-2">
                            <span class="text-4xl font-bold text-white"
                              >$<!-- -->300</span
                            ><span class="text-white/60">to get started</span>
                          </div>
                        </div>
                        <div
                          class="mt-4 p-4 rounded-xl bg-emerald-500/20 border border-emerald-500/30"
                        >
                          <div
                          ...
                          >
                            ...
                            ><span class="text-sm text-white/60"
                              >only when you receive an offer</span
                            >
                          </div>
                        </div>
                      </div>
                      <div class="space-y-3 mb-6 flex-grow">
                        <div class="flex items-start gap-3">
                          ...
                          <span class="text-sm text-white/80"
                            >30+ expert applications submitted for you</span
                          >
                        </div>
                        <div class="flex items-start gap-3">
                          <div
                          ...
                          <span class="text-sm text-white/80"
                            >Native-level German cover letters</span
                          >
                        </div>
                        <div class="flex items-start gap-3">
                          <div
                          ...
                          <span class="text-sm text-white/80"
                            >Real-time application tracking</span
                          >
                        </div>
                        <div class="flex items-start gap-3">
                          <div
                          ...
                          <span class="text-sm text-white/80"
                            >Dedicated personal counselor</span
                          >
                        </div>
                        <div class="flex items-start gap-3">
                          <div
                          ...
                          <span class="text-sm text-white/80"
                            >Mock interview preparation</span
                          >
                        </div>
                        <div class="flex items-start gap-3">
                          <div
                          ...
                          <span class="text-sm text-white/80"
                            >Full visa guidance &amp; support</span
                          >
                        </div>
                        <div class="flex items-start gap-3">
                          <div
                          ...
                          <span class="text-sm text-white/80"
                            >12-month validity (2 intakes)</span
                          >
                        </div>
                      </div>
                    </div>
                ...
                <div class="mt-12 text-center" style="opacity: 0">
                  <div
                    class="flex flex-wrap items-center justify-center gap-6 text-sm text-[#344F1F]/60"
                  >
                    <div class="flex items-center gap-2">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                      ...
                      ><span>Pay success fee only on confirmed offer</span>
                    </div>
                    <div class="flex items-center gap-2">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                      ...
                      >
                        <path d="M20 6 9 17l-5-5"></path></svg
                      ><span
                        >Non-refundable advance covers your application
                        work</span
                      >
                    </div>
                    <div class="flex items-center gap-2">
                  ...
                  <p class="mt-4 text-xs text-[#344F1F]/50 italic">
                    Prices shown in
                    <!-- -->US Dollar<!-- -->
                    (<!-- -->USD<!-- -->). Change currency above.
                  </p>
                  <div
                    class="mt-6 flex items-center justify-center gap-4 opacity-40"
                  >
                    <span class="text-xs text-[#344F1F]/60 font-medium"
                      >Powered by</span
                    ><span class="text-lg font-bold text-[#344F1F]/80"
                      >Stripe</span
                    >
                  </div>
                </div>
                ...
                <div class="bg-gray-100 rounded-[32px] p-[5px]">
                  <div class="bg-white rounded-[27px] overflow-hidden">
                    <div class="grid grid-cols-[280px_1fr_1fr]">
                      ...
                      >
                        <div
                          class="bg-gray-100 p-6 text-sm text-[#344F1F] border-b border-white"
                        >
                          Job Discovery
                        </div>
                        <div class="p-6 border-b border-gray-100">
                          <span
                            class="text-sm text-[#344F1F]/80 font-medium text-center block"
                            >67K+ jobs (you search)</span
                          >
                        </div>
                        <div
                          class="p-6 bg-[#F4991A]/5 border-b border-[#F4991A]/10"
                        >
                          <span
                            class="text-sm text-[#344F1F]/80 font-medium text-center block"
                            >Curated matches for you</span
                          >
                        </div>
                      </div>
                      <div
                      ...
                      >
                        ...
                        >
                          <span
                            class="text-sm text-[#344F1F]/80 font-medium text-center block"
                            >Expert-written (native German)</span
                          >
                        </div>
                      </div>
                      <div
                ...
                <div class="bg-gray-100 rounded-[32px] p-[5px]">
                  <div class="bg-white rounded-[27px] overflow-hidden">
                    <div class="grid grid-cols-[140px_1fr_1fr]">
                      <div
                        class="bg-gray-100 p-4 font-bold text-[#344F1F] text-sm"
                      >
                        Features
                      </div>
                      ...
                      <div class="contents">
                        <div
                          class="bg-gray-100 p-4 text-xs text-[#344F1F] border-b border-white"
                        >
                          Job Discovery
                        </div>
                        ...
                        <div
                          class="p-4 bg-[#F4991A]/5 border-b border-[#F4991A]/10"
                        >
                          <span
                            class="text-sm text-[#344F1F]/80 font-medium text-center block"
                            >Curated matches for you</span
          ...
          <section class="py-16 md:py-24 bg-[#F9F5F0]" id="testimonials-section">
            <div class="container mx-auto px-4">
              ...
              >
                ...
                >
                  <svg
                    ...
                    stroke-linecap="round"
                    stroke-linejoin="round"
                    class="lucide lucide-star w-3 h-3 mr-1"
                  >
                    <path
              ...
              <div class="max-w-6xl mx-auto overflow-hidden" id="testimonials-carousel">
                ...
                >
                  ...
                  >
                    ...
                    <p
                      class="text-[#344F1F]/80 text-sm leading-relaxed mb-6 flex-grow"
                    >
                      &quot;<!-- -->I was applying for 6 months with zero
                      responses. GoAusbildung team got me 3 interview calls in
                    ...
                    <div class="bg-emerald-50 rounded-lg p-3 mb-4">
                      <div
                        class="flex items-center gap-2 text-emerald-700 text-xs font-medium"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="24"
                        ...
                        >
                          ...
                          ></rect>
                          <path d="M3 10h18"></path></svg
                        ><span>Applied: Oct 2025 → Offer: Dec 2025</span>
                      </div>
                    ...
                    <div
                      class="flex items-center gap-3 pt-4 border-t border-[#F2EAD3]"
                    >
                      <div
                      ...
                      <div class="flex-1">
                        ...
                        <div
                          class="flex items-center gap-1 text-xs text-[#344F1F]/60"
                        >
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
                    ...
                    <div class="mt-3 bg-[#F9F5F0] rounded-lg p-3">
                      <div class="flex items-center gap-2">
                        ...
                        <div>
                          <span class="text-sm font-semibold text-[#344F1F]"
                            >Siemens AG</span
                          ><span class="text-xs text-[#344F1F]/60">
                            •
                            <!-- -->Munich</span
                          >
                        </div>
                  ...
                  >
                    ...
                    <div class="bg-emerald-50 rounded-lg p-3 mb-4">
                      ...
                      >
                        ...
                        >
                          ...
                          ></rect>
                          <path d="M3 10h18"></path></svg
                        ><span>Applied: Nov 2025 → Offer: Jan 2026</span>
                      </div>
                      <p class="text-emerald-600 text-sm font-semibold mt-1">
                        Offer in
                        <!-- -->2 months
                    ...
                    >
                      ...
                      <div class="flex-1">
                        <h4 class="font-semibold text-[#344F1F]">Ahmed Khan</h4>
                        <div
                          class="flex items-center gap-1 text-xs text-[#344F1F]/60"
                        >
                          <svg
                    ...
                    <div class="bg-emerald-50 rounded-lg p-3 mb-4">
                      ...
                      >
                        ...
                        >
                          ...
                          ></rect>
                          <path d="M3 10h18"></path></svg
                        ><span>Applied: Sep 2025 → Offer: Dec 2025</span>
                      </div>
                      <p class="text-emerald-600 text-sm font-semibold mt-1">
                        Offer in
                        <!-- -->3 months
              ...
              >
                <div
                  class="bg-gradient-to-r from-[#344F1F] to-[#2d4219] rounded-2xl p-6 md:p-8"
                >
                  <div
          ...
          <section class="py-16 md:py-24 bg-white" id="consultation-faq">
            <div class="container mx-auto px-4">
              ...
              >
                ...
                >
                  <svg
                    ...
                    stroke-linecap="round"
                    stroke-linejoin="round"
                    class="lucide lucide-circle-help w-4 h-4 text-[#F4991A]"
                  >
                    <circle cx="12" cy="12" r="10"></circle>
              ...
              >
                <div
                  class="inline-flex flex-col sm:flex-row items-center gap-3 bg-[#F9F5F0] rounded-xl p-6"
                >
                  <p class="text-[#344F1F] font-medium">
                    Still have questions?
                  </p>
                  <a
                    href="cdn-cgi/l/email-protection.html#87f4f2f7f7e8f5f3c7e0e8e6f2f4e5eeebe3f2e9e0a9e4e8ea"
                    class="px-6 py-2 bg-[#344F1F] text-white rounded-full font-medium hover:bg-[#2d4219] transition-colors"
                    >Contact Us</a
                  >
                </div>
              </div>
          ...
          <section
            class="py-16 md:py-24 bg-gradient-to-br from-[#344F1F] to-[#2d4219] relative overflow-hidden"
          >
            ...
            <div class="container mx-auto px-4 relative z-10">
              <div class="max-w-4xl mx-auto text-center">
                <div style="opacity: 0; transform: translateY(20px)">
                  ...
                  <h2
                    class="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-6 leading-tight"
                  >
                    Your Ausbildung Is Waiting.<br /><span
                      class="text-[#F4991A]"
                      >Let&#x27;s Get You There.</span
                    >
                  </h2>
                ...
                <div
                  class="grid grid-cols-3 gap-4 md:gap-6 mb-10 max-w-xl mx-auto"
                  style="opacity: 0; transform: translateY(20px)"
                >
                  <div
                ...
                >
                  <div class="flex -space-x-3">
                    <div
                      class="w-10 h-10 rounded-full border-2 border-[#344F1F] overflow-hidden"
                    >
                      <img
                        src="{{ asset('assets/images/hero-avatar-1.webp') }}"
                        alt=""
                ...
                >
                  <a
                    class="inline-flex items-center justify-center gap-2 whitespace-nowrap duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 shadow-md active:translate-y-0 h-14 bg-[#F4991A] hover:bg-[#e08a15] text-white rounded-full px-8 py-6 text-lg font-semibold transition-all hover:shadow-xl hover:-translate-y-1"
                    href="#pricing"
                    >View Packages<svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                ...
                <div
                  class="flex flex-wrap items-center justify-center gap-4 text-sm text-white/60"
                  style="opacity: 0"
                >
                  <div class="flex items-center gap-2">
                    <svg
                    ...
                    >
                      <path
                        d="M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z"
                      ></path></svg
                    ><span>Success fee only when you receive an offer</span>
                  </div>
                </div>
                <div
                  class="mt-12 bg-white/10 backdrop-blur-sm rounded-2xl p-6 md:p-8 border border-white/10"
                  style="opacity: 0; transform: translateY(20px)"
                >
