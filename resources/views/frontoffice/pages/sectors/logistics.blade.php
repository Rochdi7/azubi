...
@section('title', 'Logistics & Transportation Ausbildung Jobs Germany | Azubi | Azubi')

@section('meta')
    <meta name="description"
        content="Find Logistics &amp; Transportation apprenticeship positions in Germany. Explore training programs, salaries, requirements &amp; career prospects. Apply today!" />
    <meta name="keywords"
        content="logistics &amp; transportation ausbildung,logistics &amp; transportation apprenticeship germany,logistics &amp; transportation training germany,logistics &amp; transportation jobs germany" />
    <meta property="og:title" content="Logistics &amp; Transportation Ausbildung Jobs Germany | Azubi" />
    <meta property="og:description"
        content="Find Logistics &amp; Transportation apprenticeship positions in Germany. Explore training programs, salaries, requirements &amp; career prospects. Apply today!" />
    <meta property="og:image" content="https://azubi.ma/images/sectors/logistics-hero.webp" />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:title" content="Logistics &amp; Transportation Ausbildung Jobs Germany | Azubi" />
    <meta name="twitter:description"
        content="Find Logistics &amp; Transportation apprenticeship positions in Germany. Explore training programs, salaries, requirements &amp; career prospects. Apply today!" />
    <meta name="twitter:image" content="https://azubi.ma/images/sectors/logistics-hero.webp" />
            ...
            [
              {
                ...
                "itemListElement": [
                  ...
                  },
                  {
                    ...
                    "item": "https://azubi.ma/sectors/logistics"
                  }
                ]
              },
              {
                ...
                "url": "https://azubi.ma/sectors/logistics"
              },
              {
                "@context": "https://schema.org",
                "@type": "FAQPage",
                    ...
                    <div class="grid lg:grid-cols-[1.2fr_0.8fr] gap-8 items-center">
                        ...
                        <div class="flex flex-col gap-4 items-center lg:items-end">
                            <div class="relative w-full max-w-xs lg:max-w-sm">
                                ...
                                <img src="{{ asset('assets/images/mascots/logistics.jpeg') }}"
                                    ...
                                    <div class="flex items-start justify-between gap-3">
                                        ...
                                        <div class="flex items-center gap-2 flex-shrink-0">
                                            <span class="text-xs text-[#2C3340]/50 flex items-center gap-1"><svg
                                                    ...
                                                    <circle cx="12" cy="10" r="3"></circle>
                                                </svg>Bielefeld</span><svg xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <div class="flex items-start justify-between gap-3">
                                        ...
                                        <div class="flex items-center gap-2 flex-shrink-0">
                                            <span class="text-xs text-[#2C3340]/50 flex items-center gap-1"><svg
                                                    ...
                                                    <circle cx="12" cy="10" r="3"></circle>
                                                </svg>Nürtingen</span><svg xmlns="http://www.w3.org/2000/svg"
                                                width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                                stroke-linejoin="round"
                                                class="lucide lucide-chevron-right w-4 h-4 text-[#2C3340]/30 group-hover:text-[#5D5DE9] transition-colors">
