        ...
        <section class="py-16">
            <div class="mx-auto w-full px-4 sm:px-6 lg:px-8 max-w-7xl">
                <div class="text-center max-w-3xl mx-auto space-y-5 mb-12">
                    ...
                    <p class="text-xl leading-relaxed" style="color: rgba(44, 51, 64, 0.7)">
                ...
                <div class="grid md:grid-cols-3 gap-6">
                    ...
                    box-shadow: 0 8px 16px rgba(44, 51, 64, 0.06);
                  ...
                  ">
                        <div class="w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" class="lucide lucide-heart w-8 h-8" style="color: #5D5DE9">
                                <path
                        ...
                        <p class="leading-relaxed text-sm" style="color: rgba(44, 51, 64, 0.7)">
                  ...
                  ">
                        <div class="w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" class="lucide lucide-target w-8 h-8" style="color: #5D5DE9">
                  ...
                  ">
                        <div class="w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" class="lucide lucide-zap w-8 h-8" style="color: #5D5DE9">
                                <path
                ...
                <div class="grid lg:grid-cols-2 gap-12 items-center">
                    <div class="space-y-6">
                        <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full"
                            style="
                      background-color: rgba(44, 51, 64, 0.1);
                      border: 1px solid rgba(44, 51, 64, 0.2);
                    ">
                            <span class="text-sm font-medium" style="color: #2C3340">The Challenge</span>
                        </div>
                        <h2 class="text-3xl sm:text-4xl font-bold text-secondary tracking-tight">
                            From Confusion to Clarity
                        </h2>
                        <p class="text-lg leading-relaxed" style="color: rgba(44, 51, 64, 0.7)">
                        ...
                        <div class="space-y-3 pt-4">
                            <div class="flex items-start gap-3">
                                <div class="w-6 h-6 rounded-full flex items-center justify-center shrink-0 mt-0.5"
                                    style="background-color: rgba(93, 93, 233, 0.15)">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                        stroke-linecap="round" stroke-linejoin="round"
                                        class="lucide lucide-check w-4 h-4" style="color: #5D5DE9">
                                        <path d="M20 6 9 17l-5-5"></path>
                                    </svg>
                                </div>
                                <span style="color: rgba(44, 51, 64, 0.8)">Clear, consolidated program information</span>
                            </div>
                            <div class="flex items-start gap-3">
                                <div class="w-6 h-6 rounded-full flex items-center justify-center shrink-0 mt-0.5"
                                    style="background-color: rgba(93, 93, 233, 0.15)">
                                ...
                                <span style="color: rgba(44, 51, 64, 0.8)">Smart eligibility and matching tools</span>
                            </div>
                            <div class="flex items-start gap-3">
                                <div class="w-6 h-6 rounded-full flex items-center justify-center shrink-0 mt-0.5"
                                    style="background-color: rgba(93, 93, 233, 0.15)">
                                ...
                                <span style="color: rgba(44, 51, 64, 0.8)">Step-by-step application guidance</span>
                            </div>
                            <div class="flex items-start gap-3">
                                <div class="w-6 h-6 rounded-full flex items-center justify-center shrink-0 mt-0.5"
                                    style="background-color: rgba(93, 93, 233, 0.15)">
                                ...
                                <span style="color: rgba(44, 51, 64, 0.8)">Comprehensive language and cultural
                                    preparation</span>
                            </div>
                        </div>
                    </div>
        ...
        <section class="py-16">
            <div class="mx-auto w-full px-4 sm:px-6 lg:px-8 max-w-7xl">
                <div class="bg-card text-card-foreground shadow p-10 md:p-14 text-center rounded-3xl border-0"
                    style="
                  background-color: white;
                  box-shadow: 0 20px 40px rgba(44, 51, 64, 0.08);
                ">
                    <div class="max-w-3xl mx-auto space-y-8">
                        <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full mx-auto"
                            style="
                      background-color: rgba(93, 93, 233, 0.1);
                      border: 1px solid rgba(93, 93, 233, 0.2);
                    ">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" class="lucide lucide-globe w-4 h-4" style="color: #5D5DE9">
                                <circle cx="12" cy="12" r="10"></circle>
                                <path d="M12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 0-20"></path>
                                <path d="M2 12h20"></path>
                            </svg><span class="text-sm font-medium" style="color: #2C3340">Powered by Innovation</span>
                        </div>
                        <h2 class="text-3xl sm:text-4xl font-bold text-secondary tracking-tight">
                            About Azubi
                        </h2>
                        ...
                        <div class="grid md:grid-cols-2 gap-8 pt-8">
                            <div class="p-8 rounded-2xl text-left" style="background-color: #EEF0F4">
                                <div class="flex items-start gap-3 mb-4">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                        stroke-linecap="round" stroke-linejoin="round"
                                        class="lucide lucide-map-pin w-5 h-5 shrink-0 mt-1" style="color: #5D5DE9">
                                        <path
                                ...
                                <p style="color: rgba(44, 51, 64, 0.7)">
        ...
        <section class="py-16" style="background-color: white">
            <div class="mx-auto w-full px-4 sm:px-6 lg:px-8 max-w-7xl">
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    transition: all 200ms ease-in-out;
                  ">
                        <div class="text-4xl font-bold mb-4" style="color: #5D5DE9">
                            01
                        </div>
                        <h3 class="text-lg font-semibold text-secondary mb-3">
                            Discover
                  ...
                  ">
                        <div class="flex items-start gap-4">
                            <div class="w-10 h-10 rounded-full flex items-center justify-center shrink-0"
                                style="background-color: rgba(93, 93, 233, 0.2)">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                            ...
                            <div>
                                ...
                                <p class="text-sm leading-relaxed" style="color: rgba(44, 51, 64, 0.7)">
