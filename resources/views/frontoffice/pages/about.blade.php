...
@section('title', 'About Us | GoAusbildung | GoAusbildung')

@section('meta')
    <meta name="description" content="Learn about GoAusbildung&#039;s mission to connect international students with German Ausbildung opportunities." />
    <meta name="keywords" content="about GoAusbildung,Qogent Global,company mission,our story" />
    <meta property="og:title" content="About Us | GoAusbildung" />
    <meta property="og:description" content="Learn about GoAusbildung&#039;s mission to connect international students with German Ausbildung opportunities." />
    <meta property="og:image" content="https://images.goausbildung.com/og-images/default-og.png" />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:title" content="About Us | GoAusbildung" />
    <meta name="twitter:description" content="Learn about GoAusbildung&#039;s mission to connect international students with German Ausbildung opportunities." />
...
<div style="background-color: #f9f5f0">
          ...
          >
            ...
            >
              <div class="flex flex-col gap-4 sm:gap-5 max-w-2xl">
                ...
                <nav
                  class="flex flex-col sm:flex-row gap-3 sm:gap-4 animate-fade-in-up animation-delay-400 mt-2 justify-start"
          ...
          <section class="py-16">
            <div class="mx-auto w-full px-4 sm:px-6 lg:px-8 max-w-7xl">
              <div class="text-center max-w-3xl mx-auto space-y-5 mb-12">
                <h2
                  class="text-3xl sm:text-4xl font-bold text-secondary tracking-tight"
                >
                  Our Mission
                </h2>
                <p
                ...
                >
                  ...
                  >
                    <svg
                      ...
                      stroke-linecap="round"
                      stroke-linejoin="round"
                      class="lucide lucide-target w-8 h-8"
                      style="color: #f4991a"
                    >
              ...
              <div class="grid lg:grid-cols-2 gap-12 items-center">
                <div class="space-y-6">
                  <div
                    ...
                    "
                  >
                    <span class="text-sm font-medium" style="color: #344f1f"
                      >The Challenge</span
                    >
                  </div>
                  <h2
                  ...
                  >
                    ...
                    why GoAusbildung was born—to transform this complexity into
                  ...
                  <div class="space-y-3 pt-4">
                    <div class="flex items-start gap-3">
                      ...
                      <span style="color: rgba(52, 79, 31, 0.8)"
                        >Clear, consolidated program information</span
                      >
                    </div>
                    <div class="flex items-start gap-3">
                      <div
                      ...
                      <span style="color: rgba(52, 79, 31, 0.8)"
                        >Smart eligibility and matching tools</span
                      >
                    </div>
                    <div class="flex items-start gap-3">
                      <div
                      ...
                      <span style="color: rgba(52, 79, 31, 0.8)"
                        >Step-by-step application guidance</span
                      >
                    </div>
                    <div class="flex items-start gap-3">
                      <div
                      ...
                      <span style="color: rgba(52, 79, 31, 0.8)"
                        >Comprehensive language and cultural preparation</span
                      >
                    </div>
                  </div>
                </div>
                <div class="relative flex justify-center items-center">
                  <img
                    alt="Student navigating Ausbildung complexities"
                    loading="lazy"
                    width="500"
                    height="500"
                    decoding="async"
          ...
          <section class="py-16">
            <div class="mx-auto w-full px-4 sm:px-6 lg:px-8 max-w-7xl">
              <div
                class="bg-card text-card-foreground shadow p-10 md:p-14 text-center rounded-3xl border-0"
                style="
                  background-color: white;
              ...
              >
                <div class="max-w-3xl mx-auto space-y-8">
                  <div
                    class="inline-flex items-center gap-2 px-4 py-2 rounded-full mx-auto"
                    style="
                  ...
                  <h2
                    class="text-3xl sm:text-4xl font-bold text-secondary tracking-tight"
                  >
                    An Initiative of Qogent Global
                  </h2>
                  <p
                    class="text-lg leading-relaxed"
                    style="color: rgba(52, 79, 31, 0.7)"
                  >
                    GoAusbildung is proudly powered by<!-- -->
                    <a
                      target="_blank"
                      rel="noopener noreferrer"
                      class="font-semibold underline decoration-2"
                      style="color: #f4991a; text-decoration-color: #f4991a"
                      href="https://qogentglobal.com/"
                      >Qogent Global</a
                    >, a leader in democratizing international education through
                    technology. Our mission aligns perfectly: making world-class
                    opportunities accessible to ambitious minds everywhere.
                  </p>
                  <div class="grid md:grid-cols-2 gap-8 pt-8">
                    <div
                      class="p-8 rounded-2xl text-left"
                    ...
                    >
                      <div class="flex items-start gap-3 mb-4">
                        <svg
                          ...
                          stroke-linecap="round"
                          stroke-linejoin="round"
                          class="lucide lucide-map-pin w-5 h-5 shrink-0 mt-1"
                          style="color: #f4991a"
                        >
                          <path
                      ...
                      <p style="color: rgba(52, 79, 31, 0.7)">
                        Onyx Building, Unit 101-228<br />Al Khabeesi, Dubai
                        239532<br />United Arab Emirates
                      </p>
                    </div>
                    <div
                      class="p-8 rounded-2xl text-left"
                    ...
                    >
                      ...
                      <p style="color: rgba(52, 79, 31, 0.7)">
                        No. 113, Kanaka Towers<br />16th Cross, JP Nagar 4th
                        Phase<br />Bangalore 560078, Karnataka, India
                      </p>
                    </div>
                  </div>
                  <div class="pt-4">
                ...
                <div class="max-w-3xl mx-auto space-y-6">
                  <div class="flex justify-center items-center gap-3 mb-4">
                    <img
                      ...
                      class="flex-shrink-0"
                      style="color: transparent"
                      src="{{ asset('assets/_next/pikasso-logo-light-1024x1024a712.svg') }}"
                    />
                    <h3
                      class="text-2xl font-semibold text-secondary tracking-tight"
                    >
                      Pikasso<span style="color: #ff6500">.</span>
                    </h3>
                  </div>
                  <p
                    class="text-lg leading-relaxed"
                  ...
                  >
                    ...
                    <a
                      ...
                      >Pikasso Studio</a
                    >, a creative technology studio crafting beautiful,
