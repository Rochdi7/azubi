            ...
            <div class="clearfix">
                <div class="card card-bx author-profile m-b30">
                    <div class="card-body">
                        ...
                        <div class="info-list">
                            <ul>
                                <li><a href="{{ url('backoffice/app-profile') }}">Models</a><span>36</span></li>
                                <li><a href="{{ url('backoffice/app-profile') }}">Gallery</a><span>3</span></li>
                                <li><a href="{{ url('backoffice/app-profile') }}">Lessons</a><span>1</span></li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="card  card-bx m-b30">
                ...
                <form class="profile-form">
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ url('backoffice/page-register') }}" class="text-primary btn-link">Forgot your password?</a>
                    </div>
                </form>
            </div>
        </div>
