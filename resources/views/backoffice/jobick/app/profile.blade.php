                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="profile-blog">
                                ...
                                <h4><a href="{{ url('backoffice/post-details') }}" class="text-dark">Darwin Creative Agency Theme</a>
                                </h4>
                            ...
                            <div class="profile-news">
                                ...
                                <div class="media pt-3 pb-3">
                                    ...
                                    <div class="media-body">
                                        <h5 class="m-b-5"><a href="{{ url('backoffice/post-details') }}" class="text-dark">Innovations
                                ...
                                <div class="media pt-3 pb-3">
                                    <img src="{{ asset('images/profile/6.jpg') }}" alt="image" class="me-3 rounded"
                                        width="75">
                                    <div class="media-body">
                                        <h5 class="m-b-5"><a href="{{ url('backoffice/post-details') }}" class="text-dark">Getting More
                                                for Your Money</a></h5>
                                        <p class="mb-0">I shared this on my fb wall a few months back, and I thought.
                                        </p>
                                    </div>
                                ...
                                <div class="media pt-3 pb-3">
                                    <img src="{{ asset('images/profile/7.jpg') }}" alt="image" class="me-3 rounded"
                                        width="75">
                                    <div class="media-body">
                                        <h5 class="m-b-5"><a href="{{ url('backoffice/post-details') }}" class="text-dark">Your
                                        ...
                                        <div id="my-posts" class="tab-pane fade active show">
                                            <div class="my-post-content pt-3">
                                                ...
                                                <div class="profile-uoloaded-post border-bottom-1 pb-5">
                                                    ...
                                                    <a class="post-title" href="{{ url('backoffice/post-details') }}">
