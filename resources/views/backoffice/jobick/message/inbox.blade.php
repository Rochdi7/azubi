                    ...
                    <div class="row">
                        <div class="col-xl-3 col-xxl-4 email-left-body">
                            <div class="mb-3 mt-4 mt-sm-0">
                                <div class="p-0">
                                    <a href="{{ url('backoffice/email-compose') }}" class="btn btn-primary btn-block">Compose</a>
                                </div>
                                <div class="mail-list rounded mt-4">
                                    <a href="{{ url('backoffice/email-inbox') }}" class="list-group-item active"><i
                                ...
                                <div class="mail-list rounded overflow-hidden mt-4">
                                    ...
                                    <a href="{{ url('backoffice/email-inbox') }}" class="list-group-item"><span class="icon-warning"><i
                                                class="fa fa-circle" aria-hidden="true"></i></span>
                                        Work </a>
                                    <a href="{{ url('backoffice/email-inbox') }}" class="list-group-item"><span class="icon-primary"><i
                                                class="fa fa-circle" aria-hidden="true"></i></span>
                                        Private </a>
                                    <a href="{{ url('backoffice/email-inbox') }}" class="list-group-item"><span class="icon-success"><i
                                                class="fa fa-circle" aria-hidden="true"></i></span>
                                        Support </a>
                                    <a href="{{ url('backoffice/email-inbox') }}" class="list-group-item"><span class="icon-dpink"><i
                                                class="fa fa-circle" aria-hidden="true"></i></span>
                                        Social </a>
                                </div>
                            </div>
                                ...
                                <div class="email-list mt-3">
                                    <div class="message">
                                        <div>
                                            ...
                                            <a href="{{ url('backoffice/email-read') }}" class="col-mail col-mail-2">
